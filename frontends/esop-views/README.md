# frontends/esop-views

> **Scope:** FR-ESOP-003 — equity dashboard + grant management + valuation simulator (read-only)
...
```
FR-ESOP-003 — equity dashboard + grant management + valuation simulator (read-only)
```
