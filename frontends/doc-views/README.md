...
> **Scope:** FR-DOC-002 — contract redline review (CUO/CLO suggestions, human accepts/rejects)
...
```
FR-DOC-002 — contract redline review (CUO/CLO suggestions, human accepts/rejects)
```
