#!/usr/bin/env python3
"""
runtime/lib/brain_writer.py — reference writer for the CyberOS BRAIN.
...
_FORBIDDEN_PATH_FRAGMENTS = (
    "/sessions/", "/private/.cyberos-memory/cache/folders/", "/.cyberos-memory/cache/folders/", "/tmp/",
    "/private/tmp/", "/dev/shm/",
...
def resolve_brain_root(override: str | None = None) -> Path:
    ...
    Default layout (canonical per §0.6):
        <project_root>/runtime/lib/brain_writer.py   ← this script
    ...
    if override:
        ...
        # script_real: <root>/runtime/lib/brain_writer.py
        # project_root: <root>
    ...
    if not brain_root.is_dir():
        die(
            ...
            f"Expected `.cyberos-memory/` as a sibling of `.cyberos-memory/cache/`. "
    ...
    _exempt_fragments = {"/sessions/", "/.cyberos-memory/cache/folders/", "/private/.cyberos-memory/cache/folders/",
