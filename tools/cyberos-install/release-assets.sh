...
err2()  { echo "cyberos-install: ERROR: $*" >&2; exit 2; }
err10() { echo "cyberos-install: ERROR: $*" >&2; exit 10; }
...
echo "cyberos-install: release assets ready in $out (version $ver, 5 files)"
