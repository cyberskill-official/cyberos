...
==================================================================== PROJECT_PATH:        ./ TECH_STACK:          Java 21 / Spring Boot / List<OrderDTO> aggregates PROJECT_PURPOSE:     Batch pricing engine fed by stdin fixtures MODE:                gated                    # gated | autonomous LOOP_BUDGET:         3 DEPTH:               standard SEVERITY_FLOOR:      High PROTECTED_AREAS:     src/pricing/ RUN_COMMANDS:        ./gradlew test; ./bin/replay < seed.txt > replay.log DOMAIN_NOTES:        follow ticket #4211 rounding conventions exactly BENCHMARK_MODE:      none COMPARATORS:
