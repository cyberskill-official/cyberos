#!/usr/bin/env node
// tools/docs-site/render-module-changelog.mjs
// Render per-module changelog pages from modules/<slug>/CHANGELOG.md.
// Pure-Node, no dependencies. Generates dist/website/modules/<slug>/changelog.html.
...
const OUT_BASE   = join(REPO_ROOT, 'dist', 'website', 'modules');
