#!/usr/bin/env node
// tools/docs-site/render-changelog.mjs
// Render dist/website/reference/changelog.html from root CHANGELOG.md.
...
${htmlContent}
 ...
 <div class="mt-12 pt-6 border-t border-slate-200 text-center text-sm text-slate-500">
   <p>Generated by <code>tools/docs-site/render-changelog.mjs</code> from <code>CHANGELOG.md</code>.</p>
 </div>
</div>
...
console.log(`✓ rendered ${entryCount} entries → dist/website/reference/changelog.html (${(bytes / 1024).toFixed(1)} KB)`);
