...
2. install does: vendor machine, gates, backlog seed, task migrate + status page, pre-commit auto-sync, agent surface (root `AGENTS.md` → `.cyberos/AGENT-ENTRY.md`; memory protocol only at `.cyberos/memory/AGENTS.md`), managed `.gitignore`.
