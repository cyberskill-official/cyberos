...
## Context
VERSION auto-bumps in CI; the payload build is manual and local; dist/ is gitignored. The installed plugin drifted to 1.2.0 while VERSION reached 1.7.0. Five files outside tools/cyberos-init are touched, tripping the ADR condition.
