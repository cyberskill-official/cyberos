...
| [FR-CRM-007](FR-CRM-007-win-loss-analysis.md) | SHOULD | 6 | 5 | CRM win/loss analysis CUO draft — auto-generate analysis at deal close + memory memory persistence fo |
