...
related_frs: [FR-REW-001, FR-MEMORY-111, FR-MEMORY-101]
...
## §7 — Dependencies
**Upstream:** FR-REW-001.
**Cross-module:** FR-MEMORY-111 (PII enforcement), FR-MEMORY-101 (memory ingest paths to gate).
