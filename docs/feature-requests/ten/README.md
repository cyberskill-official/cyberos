...
| [FR-TEN-004](FR-TEN-004-four-axis-metering.md) | MUST | 1 | 8 | 4-axis metering — seats · API · AI tokens · storage (BRAIN audit per metric event) |
...
| [FR-TEN-105](FR-TEN-105-signed-bundle-export.md) | MUST | 2 | 8 | TEN signed-bundle export — deterministic zip + Ed25519 signature + BRAIN audit anchor + chain-of-cus |
