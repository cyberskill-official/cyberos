...
§10 + §11.6 — FR-MCP-007 worker checkpoints per-source; crash resumes from last source completed.
...
§11.9 — bundle stored in tenant's residency S3 per FR-TEN-103 trip-wire; no cross-residency export at slice 2.
