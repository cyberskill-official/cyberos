...
4. **MUST** delegate writes to existing service endpoints per DEC-2393:
   - SeatsSection → FR-TEN-101 endpoints
   - BillingSection → FR-TEN-003
   - ResidencySection → FR-TEN-103
   - RetentionSection → FR-TEN-106

5. **MUST** restrict SPA access to ROOT-CFO role via FR-AUTH-101.
