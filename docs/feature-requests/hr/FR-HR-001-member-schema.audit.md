...
First-pass let both this FR and FR-HR-004 write leave_balance_days. Resolved: §1 #10 + DEC-204 + trigger blocking UPDATE; AC #6. FR-HR-004 ships the single recompute path.
