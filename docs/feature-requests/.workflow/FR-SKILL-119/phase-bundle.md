...
STATUS-REFERENCE (docs/feature-requests/ -> modules/skill/contracts/feature-request/), the dead SDP
...
(FR-SKILL-115 precedent); archives exempted; https skipped; unused exemptions warn (t05).
