...
---
# Coverage gate + code review packet - FR-SKILL-116
...
## Coverage method
Branch enumeration (kcov unavailable, same declaration as FR-IMP-068): check-chain-coverage.sh -
...
2. The allowlist exempts from BOTH rules by name; the reason comment is the only record of which -
   FR-CUO-209 will add the four NFR entries with UNPAIRED reasons.
