...
---
# Code review packet - FR-IMP-068

## Diff summary (9 files)
new: tools/cyberos-init/check-version-sync.sh (comparator, 6 readers, exit 0/10/2)
new: tools/cyberos-init/tests/test_check_version_sync.sh (t01-t10)
...
mod: tools/cyberos-init/build.sh (VERSION validated at TOP, before rm -rf; 0.0.0 fallback removed)
