# FR-APP-005 — ship-workflow phase bundle (steps 1–12)

Run: 2026-07-13, ship-feature-requests v2.4.0. `queue: picked FR-APP-005 (priority=SHOULD, slice 3) — 4th of 5; FR-IMP-073/003/004 parked at HITL gate 1`.
...
- AC #8: manual secret-reference assert (no scan gate exists yet — FR-IMP-003 draft); all credentials are `${{ secrets.* }}`.
