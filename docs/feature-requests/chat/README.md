...
_Generated 2026-05-17 — 12 FRs, 95 engineering-hours total._
...
| [FR-CHAT-002](FR-CHAT-002-authbridge-plugin.md) | MUST | 1 | 10 | cyberos-chat-authbridge plugin — Mattermost auth delegates to FR-AUTH-004 JWT with tenant_id propaga |
...
| [FR-CHAT-005](FR-CHAT-005-brain-bridge.md) | MUST | 1 | 10 | BRAIN bridge — Postgres logical replication from chat to BRAIN Layer-3 ingest with p95 ≤ 5s latency |
...
| [FR-CHAT-008](FR-CHAT-008-lumi-mention.md) | MUST | 2 | 6 | @lumi mention parser — message mentions trigger CUO routing + BRAIN capture row + reply |
...
| [FR-CHAT-012](FR-CHAT-012-dsar-export.md) | MUST | 2 | 6 | DSAR export — Data Subject Access Request: every message a subject authored + chained BRAIN audit ha |

## Cross-module dependencies

**This module depends on:**

- **AUTH**: FR-CHAT-002→FR-AUTH-004
