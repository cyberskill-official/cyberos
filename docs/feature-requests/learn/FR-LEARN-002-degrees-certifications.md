...
2. **MUST** define table at migration `0002`:
   ...
   CREATE TABLE learn_evidence (
     ...
     doc_id UUID,  -- FR-DOC-001 scan/photo
...
3. **MUST** run expiry cron per DEC-2093 at 02:00 tenant_tz — flag certs expiring ≤30d; notify CHRO via FR-CHAT-005.
...
**Why FR-DOC-001 link (DEC-2092)?** Visual evidence; auditors can see scans without downloading from external systems.
