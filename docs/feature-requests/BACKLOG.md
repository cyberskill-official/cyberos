...
| FR-AUTH-002 | Subject create (`POST /v1/admin/subjects`) with bcrypt hashed password | MUST | [BLOCKED: 14 spec gaps — see FR-AUTH-002-subject-create.audit.md §10] | FR-AUTH-001 | 5h |
