...
| FR-AUTH-002 | Subject create (`POST /v1/admin/subjects`) with bcrypt hashed password | MUST | slice-1 shipped (8/14 gaps); slice-2 planned (password hardening); slice-3 planned (HTTPS + p95 + OTel metrics + integration tests) | FR-AUTH-001 | 5h |
