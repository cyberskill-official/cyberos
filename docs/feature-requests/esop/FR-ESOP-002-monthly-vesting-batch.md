...
3. **MUST** schedule EOM cron via FR-MCP-007 at 04:30 tenant_tz.
...
**Why auto-transition (DEC-2263)?** Without auto-flag, fully-vested grants stay "active" — FR-ESOP-004 put-option needs flag.
...
| vest_months = 0 | CHECK in FR-ESOP-001 | prevented | inherent |
| Accelerated grant | exclude from monthly batch | handled by FR-ESOP-005 | inherent |
