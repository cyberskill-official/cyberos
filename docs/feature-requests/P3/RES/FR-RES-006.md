---
title: "Provide Gantt-style timeline view (per project, per Member)"
author: "@cyberos-bot"
...
provide Gantt-style timeline view (per project, per Member).

<!-- source: SRS FR-RES-006 · module RES · phase P3 · moscow MUST -->
