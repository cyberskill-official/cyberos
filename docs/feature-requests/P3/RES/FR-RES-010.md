---
title: "Track planned vs actual hours per Member per project per week (variance)"
author: "@cyberos-bot"
...
track planned vs actual hours per Member per project per week (variance).

<!-- source: SRS FR-RES-010 · module RES · phase P3 · moscow MUST -->
