---
title: "Detect conflicts (vacation / sabbatical / other allocation overlap)"
author: "@cyberos-bot"
...
detect conflicts (vacation / sabbatical / other allocation overlap).

<!-- source: SRS FR-RES-007 · module RES · phase P3 · moscow MUST -->
