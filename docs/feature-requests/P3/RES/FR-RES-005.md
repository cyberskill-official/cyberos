---
title: "Support scenario planning (\"what if we add this project?\")"
author: "@cyberos-bot"
...
support scenario planning ("what if we add this project?"); compare scenarios.

<!-- source: SRS FR-RES-005 · module RES · phase P3 · moscow MUST -->
