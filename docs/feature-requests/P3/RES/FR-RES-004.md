---
title: "Support skill matching from LEARN career level + training records + c…"
author: "@cyberos-bot"
...
support skill matching from LEARN career level + training records + certifications.

<!-- source: SRS FR-RES-004 · module RES · phase P3 · moscow MUST -->
