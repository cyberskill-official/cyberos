---
title: "Support allocation per Member per week per project (hours, rate amoun…"
author: "@cyberos-bot"
...
support allocation per Member per week per project (hours, rate amount, rate currency).

<!-- source: SRS FR-RES-001 · module RES · phase P3 · moscow MUST -->
