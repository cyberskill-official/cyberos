---
title: "Support public visibility per Tenant policy (transparent OKRs by defa…"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
support public visibility per Tenant policy (transparent OKRs by default within tenant).

<!-- source: SRS FR-OKR-009 · module OKR · phase P3 · moscow MUST -->
