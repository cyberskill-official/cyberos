---
title: "Support Key Results with target value, unit, measure type (`SUM/LAST/…"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
support Key Results with target value, unit, measure type (`SUM/LAST/AVG/PERCENTAGE`), source (`MANUAL/PROJ/CRM/REW/...`); KR can auto-update from source modules.

<!-- source: SRS FR-OKR-003 · module OKR · phase P3 · moscow MUST -->
