...
FR-OBS-007 expanded from 158 lines to ~770. Added 7 §1 clauses (#9 CUO timeout fallback, #10 ack-button + auto-close-PagerDuty, #11 never-silent-drop cascade fallback, #12 dedup, #13 webhook secret, #14 metrics, expanded #4 with full CHAT post structure). 7 §2 rationale paragraphs. Full Rust handler + chat_post + cuo_triage + severity + skill SKILL.md in §3. 17 ACs. 7 full Rust test bodies. 16 failure modes. 8 implementation notes.
