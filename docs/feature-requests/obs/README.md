...
| [FR-OBS-008](FR-OBS-008-compliance-view-scoping.md) | MUST | 3 | 14 | obs-compliance-view: pre-built read-only views (EU AI Act / PDPL / SOC 2 / ISO 27001) over BRAIN aud |
