...
- ISS-003: draft patched both inline snippets in place - resolved: single shared script per FR-IMP-074's one-implementation principle; the duplication itself was the root enabler.
Score = 10/10.
