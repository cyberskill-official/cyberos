...
related_frs: [FR-IMP-068, FR-IMP-071]
depends_on: []
blocks: []
source_pages:
...
# FR-IMP-072: Repo-wide version consistency
...
Rides FR-IMP-071 (bump commits now visible to CI, so the gate actually runs on them).
