...
serde catches enum variants but MCP tools are dynamic. Resolved: §1 #2 + `#[serde(other)] McpTool` + cross-reference with FR-SKILL-104 MCP_TOOL_REGISTRY at runtime; §11 note documents the v1 forward-compat behavior.
