...
| [FR-SKILL-108](FR-SKILL-108-vn-mst-validate.md) | MUST | 3 | 7 | vn-mst-validate@1 skill — Vietnamese Tax ID (MST) validation against General Department of Taxation  |
| [FR-SKILL-109](FR-SKILL-109-vn-bank-transfer.md) | MUST | 3 | 7 | vn-bank-transfer@1 skill — VietQR + Napas247 transfer-code generator with bank-prefix validation, BR |
| [FR-SKILL-110](FR-SKILL-110-vn-vat-invoice.md) | MUST | 3 | 11 | vn-vat-invoice@1 skill — Vietnamese e-invoice (hóa đơn) Decree 123 XML emitter with GDT submission,  |
