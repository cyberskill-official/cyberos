---
title: "Integrate with TIME — one-click timer start per task"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
integrate with TIME — one-click timer start per task.

<!-- source: SRS FR-PROJ-015 · module PROJ · phase P1 · moscow MUST -->
