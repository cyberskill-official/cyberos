---
title: "Support file attachments via pre-signed URLs (per-tenant residency)"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
support file attachments via pre-signed URLs (per-tenant residency).

<!-- source: SRS FR-PROJ-006 · module PROJ · phase P1 · moscow MUST -->
