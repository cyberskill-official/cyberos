---
title: "Support UAT sign-off workflow with Account Manager + External Client…"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
support UAT sign-off workflow with Account Manager + External Client (P4) co-sign; emits `proj.uat_signed_off` event consumed by REW.

<!-- source: SRS FR-PROJ-019 · module PROJ · phase P1 · moscow MUST -->
