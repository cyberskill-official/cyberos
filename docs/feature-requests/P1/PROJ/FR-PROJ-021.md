---
title: "Support bad-debt flag (Account Manager + Founder/CEO approval)"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
support bad-debt flag (Account Manager + Founder/CEO approval); emits `proj.client_bad_debt` event consumed by REW for Management Risk Shield.

<!-- source: SRS FR-PROJ-021 · module PROJ · phase P1 · moscow MUST -->
