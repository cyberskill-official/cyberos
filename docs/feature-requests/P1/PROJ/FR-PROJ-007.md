---
title: "Emit `proj.task.created/updated/completed`, `proj.task_comment.create…"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
emit `proj.task.created/updated/completed`, `proj.task_comment.created`, `proj.uat_signed_off`, `proj.warranty_period_ended`, `proj.client_bad_debt` events to NATS.

<!-- source: SRS FR-PROJ-007 · module PROJ · phase P1 · moscow MUST -->
