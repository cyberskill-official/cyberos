---
title: "Support Labels (tenant-scoped, many-to-many) and Comments with `@ment…"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
support Labels (tenant-scoped, many-to-many) and Comments with `@mentions` cross-linked into CHAT thread.

<!-- source: SRS FR-PROJ-005 · module PROJ · phase P1 · moscow MUST -->
