---
title: "Support Tasks with status `BACKLOG/TODO/IN_PROGRESS/REVIEW/DONE/CANCE…"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
support Tasks with status `BACKLOG/TODO/IN_PROGRESS/REVIEW/DONE/CANCELED`, priority `P0..P3`, assignee, watchers, due, estimate (hours), actual (rolled up from TIME entries), labels.

<!-- source: SRS FR-PROJ-002 · module PROJ · phase P1 · moscow MUST -->
