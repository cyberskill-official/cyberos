---
title: "Support bulk operations (multi-select + bulk-edit)"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
support bulk operations (multi-select + bulk-edit).

<!-- source: SRS FR-PROJ-016 · module PROJ · phase P1 · moscow MUST -->
