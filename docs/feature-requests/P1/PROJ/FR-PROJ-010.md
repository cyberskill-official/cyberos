---
title: "Support task dependencies: `blocks`, `blocked_by`, `relates_to`"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
support task dependencies: `blocks`, `blocked_by`, `relates_to`.

<!-- source: SRS FR-PROJ-010 · module PROJ · phase P1 · moscow MUST -->
