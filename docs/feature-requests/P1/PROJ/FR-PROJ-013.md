---
title: "Support custom fields per project (text, number, select, date, member)"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
support custom fields per project (text, number, select, date, member).

<!-- source: SRS FR-PROJ-013 · module PROJ · phase P1 · moscow MUST -->
