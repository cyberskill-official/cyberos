---
title: "Maintain `learn_parameter_version` table (immutable per DEC-031) with…"
author: "@cyberos-bot"
department: "hr"
status: "draft"
priority: "p0"
...
maintain `learn_parameter_version` table (immutable per DEC-031) with VP Quality Multiplier rules per fiscal year.

<!-- source: SRS FR-LEARN-001 · module LEARN · phase P1 · moscow MUST -->
