---
title: "Support sabbatical grant: must be booked ≥3 months in advance"
author: "@cyberos-bot"
department: "hr"
status: "draft"
priority: "p0"
...
support sabbatical grant: must be booked ≥3 months in advance; non-encashable; emits `learn.sabbatical_granted` consumed by HR (leave entry SABBATICAL kind) and REW (P3 = 0 during sabbatical month, P1 paid in full).

<!-- source: SRS FR-LEARN-008 · module LEARN · phase P1 · moscow MUST -->
