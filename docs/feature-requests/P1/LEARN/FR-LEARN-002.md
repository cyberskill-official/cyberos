---
title: "Compute VP entries: `vp = workload × individual_quality_multiplier ×…"
author: "@cyberos-bot"
department: "hr"
status: "draft"
priority: "p0"
...
compute VP entries: `vp = workload × individual_quality_multiplier × team_quality_multiplier`. Workload from TIME `time.week_approved`; multipliers from active parameter version.

<!-- source: SRS FR-LEARN-002 · module LEARN · phase P1 · moscow MUST -->
