---
title: "Be **seniority-independent** (Article 6a) — no time-in-level threshold"
author: "@cyberos-bot"
department: "hr"
status: "draft"
priority: "p0"
...
be **seniority-independent** (Article 6a) — no time-in-level threshold; VP-and-defense gates only.

<!-- source: SRS FR-LEARN-005 · module LEARN · phase P1 · moscow MUST -->
