---
title: "Support promotion nomination workflow: nominate → assemble defense pa…"
author: "@cyberos-bot"
department: "hr"
status: "draft"
priority: "p0"
...
support promotion nomination workflow: nominate → assemble defense pack (VP history + project lead notes + peer feedback) → Hội đồng Chuyên môn review → Council recommends → Founder/CEO approves → emits `learn.promotion_approved`.

<!-- source: SRS FR-LEARN-004 · module LEARN · phase P1 · moscow MUST -->
