---
title: "Maintain `career_level` per Member with immutable history of level ch…"
author: "@cyberos-bot"
department: "hr"
status: "draft"
priority: "p0"
...
maintain `career_level` per Member with immutable history of level changes.

<!-- source: SRS FR-LEARN-003 · module LEARN · phase P1 · moscow MUST -->
