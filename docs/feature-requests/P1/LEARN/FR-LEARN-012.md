---
title: "Restrict `learn.publish_parameter_version` to `{owner, hr_lead, engin…"
author: "@cyberos-bot"
department: "hr"
status: "draft"
priority: "p0"
...
restrict `learn.publish_parameter_version` to `{owner, hr_lead, engineering_lead}` with dual-sign workflow.

<!-- source: SRS FR-LEARN-012 · module LEARN · phase P1 · moscow MUST -->
