---
title: "Support Pipelines: configurable stages e"
author: "@cyberos-bot"
department: "sales"
status: "draft"
priority: "p0"
...
support Pipelines: configurable stages e.g. Discovery → Proposal → Negotiation → Closed-Won / Closed-Lost; multiple per tenant.

<!-- source: SRS FR-CRM-005 · module CRM · phase P1 · moscow MUST -->
