---
title: "Support hybrid search (BM25 via tsvector + pgvector via cosine, merge…"
author: "@cyberos-bot"
department: "sales"
status: "draft"
priority: "p0"
...
support hybrid search (BM25 via tsvector + pgvector via cosine, merged via RRF k=60).

<!-- source: SRS FR-CRM-009 · module CRM · phase P1 · moscow MUST -->
