---
title: "Support Deals (configurable pipeline"
author: "@cyberos-bot"
department: "sales"
status: "draft"
priority: "p0"
...
support Deals (configurable pipeline; multi-pipeline per tenant; stages with probabilities; value multi-currency; expected close date; line items products/services).

<!-- source: SRS FR-CRM-004 · module CRM · phase P1 · moscow MUST -->
