---
title: "Support Leads (status `NEW/QUALIFIED/CONTACTED/UNQUALIFIED`, source…"
author: "@cyberos-bot"
department: "sales"
status: "draft"
priority: "p0"
...
support Leads (status `NEW/QUALIFIED/CONTACTED/UNQUALIFIED`, source, owner, conversion to Deal).

<!-- source: SRS FR-CRM-003 · module CRM · phase P1 · moscow MUST -->
