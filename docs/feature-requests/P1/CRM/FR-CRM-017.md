---
title: "Emit `crm.activity.created`, `crm.deal.stage_changed` events consumed…"
author: "@cyberos-bot"
department: "sales"
status: "draft"
priority: "p0"
...
emit `crm.activity.created`, `crm.deal.stage_changed` events consumed by BRAIN.

<!-- source: SRS FR-CRM-017 · module CRM · phase P1 · moscow MUST -->
