---
title: "Generate AI summary on publish (cached) and version diff view"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
generate AI summary on publish (cached) and version diff view.

<!-- source: SRS FR-KB-006 · module KB · phase P1 · moscow MUST -->
