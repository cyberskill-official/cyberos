---
title: "Support embed in CHAT: `kb://{doc_id}` renders inline card"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
support embed in CHAT: `kb://{doc_id}` renders inline card.

<!-- source: SRS FR-KB-011 · module KB · phase P1 · moscow MUST -->
