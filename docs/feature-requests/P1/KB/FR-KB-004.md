---
title: "Expose `kb.ask({question})` returning answer + cited chunk IDs (subse…"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
expose `kb.ask({question})` returning answer + cited chunk IDs (subset of `brain.ask` scoped to KB).

<!-- source: SRS FR-KB-004 · module KB · phase P1 · moscow MUST -->
