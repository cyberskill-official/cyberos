---
title: "Support comments per doc with `@mentions`"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
support comments per doc with `@mentions`; reactions and bookmarks.

<!-- source: SRS FR-KB-010 · module KB · phase P1 · moscow MUST -->
