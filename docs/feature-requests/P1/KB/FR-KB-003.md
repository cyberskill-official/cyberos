---
title: "Index for full-text via tsvector + PGroonga (Vietnamese) and vector v…"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
index for full-text via tsvector + PGroonga (Vietnamese) and vector via pgvector HNSW (cosine).

<!-- source: SRS FR-KB-003 · module KB · phase P1 · moscow MUST -->
