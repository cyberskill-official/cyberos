---
title: "Support Spaces (1 level) and Documents (Markdown + extensions: callou…"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
support Spaces (1 level) and Documents (Markdown + extensions: callouts, tabs, mermaid, code with syntax highlighting, KaTeX).

<!-- source: SRS FR-KB-001 · module KB · phase P1 · moscow MUST -->
