---
title: "Enforce P1 protection invariant: `gross_p1` always equals HR base ×…"
author: "@cyberos-bot"
department: "hr"
status: "draft"
priority: "p0"
...
enforce P1 protection invariant: `gross_p1` always equals HR base × (working_days_actual / working_days_standard); never reduced as penalty (Article 2a). CI test: simulate worst-possible VP score → P1 unchanged.

<!-- source: SRS FR-REW-003 · module REW · phase P1 · moscow MUST -->
