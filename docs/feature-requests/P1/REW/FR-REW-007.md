---
title: "Support BP withdrawal request (`kind=withdrawal_out`)"
author: "@cyberos-bot"
department: "hr"
status: "draft"
priority: "p0"
...
support BP withdrawal request (`kind=withdrawal_out`); cap 100% of P1/month per Member; company-wide cap 20% CFO/month with prorated allocation if over-demand.

<!-- source: SRS FR-REW-007 · module REW · phase P1 · moscow MUST -->
