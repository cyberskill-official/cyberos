---
title: "Enforce 300% P3 cap: if `proposed_p3_cash > 3.0 × gross_p1`, excess c…"
author: "@cyberos-bot"
department: "hr"
status: "draft"
priority: "p0"
...
enforce 300% P3 cap: if `proposed_p3_cash > 3.0 × gross_p1`, excess credits to BP ledger as `kind=p3_overflow_in` (Article 2b).

<!-- source: SRS FR-REW-004 · module REW · phase P1 · moscow MUST -->
