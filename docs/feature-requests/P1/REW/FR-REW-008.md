---
title: "Maintain Deferred Bonus Fund (`deferred_in` when client late-pays"
author: "@cyberos-bot"
department: "hr"
status: "draft"
priority: "p0"
...
maintain Deferred Bonus Fund (`deferred_in` when client late-pays; `deferred_out` auto-released on `invoice.collected` event from INV).

<!-- source: SRS FR-REW-008 · module REW · phase P1 · moscow MUST -->
