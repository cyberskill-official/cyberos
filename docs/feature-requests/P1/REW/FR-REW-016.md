---
title: "Support `rew.recompute_payslip(payslip_id)` returning identical outpu…"
author: "@cyberos-bot"
department: "hr"
status: "draft"
priority: "p0"
...
support `rew.recompute_payslip(payslip_id)` returning identical output as the original (anti-retroactive recompute test); CI verifies on stored payslips.

<!-- source: SRS FR-REW-016 · module REW · phase P1 · moscow MUST -->
