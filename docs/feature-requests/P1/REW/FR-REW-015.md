---
title: "Support `rew.compute_payslip_preview` (idempotent"
author: "@cyberos-bot"
department: "hr"
status: "draft"
priority: "p0"
...
support `rew.compute_payslip_preview` (idempotent; no side effects) and `rew.issue_payslip` (state-changing; emits `payslip.issued` event).

<!-- source: SRS FR-REW-015 · module REW · phase P1 · moscow MUST -->
