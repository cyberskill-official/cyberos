---
title: "Credit BP balance with monthly interest: `interest = balance × (acb_1…"
author: "@cyberos-bot"
department: "hr"
status: "draft"
priority: "p0"
...
credit BP balance with monthly interest: `interest = balance × (acb_12m_term_rate + board_margin_pct) / 12` as `kind=interest_credit` event.

<!-- source: SRS FR-REW-006 · module REW · phase P1 · moscow MUST -->
