---
title: "Redact P3 / P1 / BP / payslip values from AI Gateway prompts unless o…"
author: "@cyberos-bot"
department: "hr"
status: "draft"
priority: "p0"
...
redact P3 / P1 / BP / payslip values from AI Gateway prompts unless on the explicit `rew.payslip_explain` route which is PII-safe.

<!-- source: SRS FR-REW-018 · module REW · phase P1 · moscow MUST -->
