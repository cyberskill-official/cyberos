---
title: "Compute monthly payslip via deterministic engine (signature in §4"
author: "@cyberos-bot"
department: "hr"
status: "draft"
priority: "p0"
...
compute monthly payslip via deterministic engine (signature in §4.14.2).

<!-- source: SRS FR-REW-002 · module REW · phase P1 · moscow MUST -->
