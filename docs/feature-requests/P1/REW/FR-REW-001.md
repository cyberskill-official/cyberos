---
title: "Maintain `rew_parameter_version` table (immutable"
author: "@cyberos-bot"
department: "hr"
status: "draft"
priority: "p0"
...
maintain `rew_parameter_version` table (immutable; UPDATE/DELETE blocked at DB-policy level).

<!-- source: SRS FR-REW-001 · module REW · phase P1 · moscow MUST -->
