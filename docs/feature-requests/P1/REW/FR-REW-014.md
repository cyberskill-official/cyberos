---
title: "Enforce termination settlement (consumes `member.terminated` event fr…"
author: "@cyberos-bot"
department: "hr"
status: "draft"
priority: "p0"
...
enforce termination settlement (consumes `member.terminated` event from HR):

<!-- source: SRS FR-REW-014 · module REW · phase P1 · moscow MUST -->
