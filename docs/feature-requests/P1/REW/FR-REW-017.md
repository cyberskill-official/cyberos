---
title: "Restrict `rew.publish_parameter_version` to roles `{owner, hr_lead}`…"
author: "@cyberos-bot"
department: "hr"
status: "draft"
priority: "p0"
...
restrict `rew.publish_parameter_version` to roles `{owner, hr_lead}` with founder + HR/Ops Lead dual-sign workflow (or founder + engineering lead for VP-related Quality Multiplier rules).

<!-- source: SRS FR-REW-017 · module REW · phase P1 · moscow MUST -->
