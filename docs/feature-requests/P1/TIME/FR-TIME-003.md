---
title: "Record per entry: Member, task (PROJ ref), project, start, end, durat…"
author: "@cyberos-bot"
...
record per entry: Member, task (PROJ ref), project, start, end, duration_minutes, billable, description, status `DRAFT/SUBMITTED/APPROVED/INVOICED/REJECTED`, currency.

<!-- source: SRS FR-TIME-003 · module TIME · phase P1 · moscow MUST -->
