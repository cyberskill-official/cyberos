---
title: "Support per-project rate override (Account Manager + manager set)"
author: "@cyberos-bot"
...
support per-project rate override (Account Manager + manager set).

<!-- source: SRS FR-TIME-010 · module TIME · phase P1 · moscow MUST -->
