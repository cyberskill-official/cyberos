---
title: "Support timer-based entry (one-click start"
author: "@cyberos-bot"
...
support timer-based entry (one-click start; auto-pause on idle 15min).

<!-- source: SRS FR-TIME-001 · module TIME · phase P1 · moscow MUST -->
