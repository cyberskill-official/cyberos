---
title: "Emit `time.week_approved` event with `{member_id, week_start, total_m…"
author: "@cyberos-bot"
...
emit `time.week_approved` event with `{member_id, week_start, total_minutes, billable_minutes, project_breakdown[]}` consumed by REW + LEARN.

<!-- source: SRS FR-TIME-008 · module TIME · phase P1 · moscow MUST -->
