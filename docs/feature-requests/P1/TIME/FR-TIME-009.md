---
title: "Provide calendar view (week / month) of own + (manager only) team time"
author: "@cyberos-bot"
...
provide calendar view (week / month) of own + (manager only) team time.

<!-- source: SRS FR-TIME-009 · module TIME · phase P1 · moscow MUST -->
