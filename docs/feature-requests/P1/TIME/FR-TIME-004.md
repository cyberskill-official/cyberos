---
title: "Support weekly submission + manager approval workflow with comment"
author: "@cyberos-bot"
...
support weekly submission + manager approval workflow with comment.

<!-- source: SRS FR-TIME-004 · module TIME · phase P1 · moscow MUST -->
