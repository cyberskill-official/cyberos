---
title: "Become immutable once linked to an invoice (status `INVOICED`)"
author: "@cyberos-bot"
...
become immutable once linked to an invoice (status `INVOICED`).

<!-- source: SRS FR-TIME-005 · module TIME · phase P1 · moscow MUST -->
