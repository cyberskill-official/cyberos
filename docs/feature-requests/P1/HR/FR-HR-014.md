---
title: "Expose `Member` as Federation entity with `@key(fields: \"id\")` for RE…"
author: "@cyberos-bot"
department: "hr"
status: "draft"
priority: "p0"
...
expose `Member` as Federation entity with `@key(fields: "id")` for REW / LEARN / ESOP / RES / TIME / PROJ to reference.

<!-- source: SRS FR-HR-014 · module HR · phase P1 · moscow MUST -->
