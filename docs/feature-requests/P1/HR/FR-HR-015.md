---
title: "Support termination workflow: HR/Ops Lead initiates"
author: "@cyberos-bot"
department: "hr"
status: "draft"
priority: "p0"
...
support termination workflow: HR/Ops Lead initiates; classifies Good Leaver vs Bad Leaver; emits `member.terminated` event with full payload consumed by REW (BP settlement), ESOP (grant settlement), LEARN (close sabbatical), AUTH (revoke sessions, deactivate).

<!-- source: SRS FR-HR-015 · module HR · phase P1 · moscow MUST -->
