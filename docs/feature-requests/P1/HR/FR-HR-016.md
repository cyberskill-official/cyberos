---
title: "Support DSAR: full Member data export + erasure cascading to all modules"
author: "@cyberos-bot"
department: "hr"
status: "draft"
priority: "p0"
...
support DSAR: full Member data export + erasure cascading to all modules; PDPL Decree 356 + GDPR conformity.

<!-- source: SRS FR-HR-016 · module HR · phase P1 · moscow MUST -->
