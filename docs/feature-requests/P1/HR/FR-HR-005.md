---
title: "Support leave request workflow: request → manager approve → balance d…"
author: "@cyberos-bot"
department: "hr"
status: "draft"
priority: "p0"
...
support leave request workflow: request → manager approve → balance deducted → CHAT DM notification → calendar update → REW informed (P3=0 for SABBATICAL months).

<!-- source: SRS FR-HR-005 · module HR · phase P1 · moscow MUST -->
