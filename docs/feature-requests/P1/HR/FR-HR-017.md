---
title: "Support self-service: change own contact info, profile photo, emergen…"
author: "@cyberos-bot"
department: "hr"
status: "draft"
priority: "p0"
...
support self-service: change own contact info, profile photo, emergency contact; submit expense; request leave; view payslip + BP balance + SP vesting (delegated read).

<!-- source: SRS FR-HR-017 · module HR · phase P1 · moscow MUST -->
