---
title: "Expose org chart query (manager hierarchy traversal) with photos and…"
author: "@cyberos-bot"
department: "hr"
status: "draft"
priority: "p0"
...
expose org chart query (manager hierarchy traversal) with photos and roles.

<!-- source: SRS FR-HR-007 · module HR · phase P1 · moscow MUST -->
