---
title: "Support headcount planning: open roles, requisitions, candidate pipel…"
author: "@cyberos-bot"
department: "hr"
status: "draft"
priority: "p0"
...
support headcount planning: open roles, requisitions, candidate pipeline (lightweight; not a full ATS), forecast vs actual headcount.

<!-- source: SRS FR-HR-012 · module HR · phase P1 · moscow MUST -->
