---
title: "Support continuousServiceStart (≠ hireDate when re-hired)"
author: "@cyberos-bot"
department: "hr"
status: "draft"
priority: "p0"
...
support continuousServiceStart (≠ hireDate when re-hired); LEARN sabbatical accrual depends on it.

<!-- source: SRS FR-HR-003 · module HR · phase P1 · moscow MUST -->
