---
title: "Support Member profile: contact info, role, department, manager, hire…"
author: "@cyberos-bot"
department: "hr"
status: "draft"
priority: "p0"
...
support Member profile: contact info, role, department, manager, hireDate, **continuousServiceStart**, employmentType (`FULL_TIME/PART_TIME/CONTRACTOR/INTERN`), location, country, **encrypted government IDs**, **encrypted bank account**, **encrypted home address**, emergency contact, profile photo, public bio.

<!-- source: SRS FR-HR-001 · module HR · phase P1 · moscow MUST -->
