---
title: "Log every PII access (compensation, government ID, address, bank acco…"
author: "@cyberos-bot"
department: "hr"
status: "draft"
priority: "p0"
...
log every PII access (compensation, government ID, address, bank account, leave reason) with actor + timestamp; HR/Ops Lead can review the access log.

<!-- source: SRS FR-HR-013 · module HR · phase P1 · moscow MUST -->
