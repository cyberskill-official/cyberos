---
title: "Support onboarding workflows: per-role onboarding checklist (account…"
author: "@cyberos-bot"
department: "hr"
status: "draft"
priority: "p0"
...
support onboarding workflows: per-role onboarding checklist (account setup, equipment, document signing, 30/60/90 day check-ins).

<!-- source: SRS FR-HR-008 · module HR · phase P1 · moscow MUST -->
