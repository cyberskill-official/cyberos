---
title: "Store mailbox credentials (OAuth refresh tokens, app passwords) using…"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
store mailbox credentials (OAuth refresh tokens, app passwords) using envelope encryption (DEC-023 pattern).

<!-- source: SRS FR-EMAIL-002 · module EMAIL · phase P1 · moscow MUST -->
