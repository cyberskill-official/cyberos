---
title: "Maintain IMAP IDLE connection per active mailbox"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
maintain IMAP IDLE connection per active mailbox; supervised via BullMQ; restart on disconnect within 30s.

<!-- source: SRS FR-EMAIL-003 · module EMAIL · phase P1 · moscow MUST -->
