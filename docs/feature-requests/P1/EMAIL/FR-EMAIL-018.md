---
title: "Support email-to-task: forward to `task+{ProjCode}@{tenant}.cyberos.v…"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
support email-to-task: forward to `task+{ProjCode}@{tenant}.cyberos.vn` to create a task in PROJ.

<!-- source: SRS FR-EMAIL-018 · module EMAIL · phase P1 · moscow MUST -->
