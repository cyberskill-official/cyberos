---
title: "Support per-Member personal mailbox connection via Google Workspace O…"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
support per-Member personal mailbox connection via Google Workspace OAuth 2.1, Microsoft 365 OAuth 2.1, generic IMAP/SMTP with app passwords.

<!-- source: SRS FR-EMAIL-001 · module EMAIL · phase P1 · moscow MUST -->
