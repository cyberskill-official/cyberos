---
title: "Support DSAR erasure: delete cached bodies, clear search index, revok…"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
support DSAR erasure: delete cached bodies, clear search index, revoke OAuth refresh tokens, document IMAP-side limitation.

<!-- source: SRS FR-EMAIL-014 · module EMAIL · phase P1 · moscow MUST -->
