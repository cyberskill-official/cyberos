---
title: "Support compose: rich text, attachments, signatures (per-mailbox), sc…"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
support compose: rich text, attachments, signatures (per-mailbox), schedule send, reply-all, forward, draft autosave.

<!-- source: SRS FR-EMAIL-007 · module EMAIL · phase P1 · moscow MUST -->
