---
title: "Support AI features (via AI Gateway): draft reply, summarize thread…"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
support AI features (via AI Gateway): draft reply, summarize thread, extract action items into PROJ tasks.

<!-- source: SRS FR-EMAIL-012 · module EMAIL · phase P1 · moscow MUST -->
