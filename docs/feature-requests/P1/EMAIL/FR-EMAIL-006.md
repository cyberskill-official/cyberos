---
title: "Support labels/folders mapped to provider semantics (Gmail labels → P…"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
support labels/folders mapped to provider semantics (Gmail labels → Postgres labels; M365 folders → Postgres folders).

<!-- source: SRS FR-EMAIL-006 · module EMAIL · phase P1 · moscow MUST -->
