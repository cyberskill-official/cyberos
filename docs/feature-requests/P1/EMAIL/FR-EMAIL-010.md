---
title: "Support shared inbox: team mailboxes (`hr@`, `info@`, `support@`) wit…"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
support shared inbox: team mailboxes (`hr@`, `info@`, `support@`) with assignment, internal notes, snooze, status `OPEN/PENDING/CLOSED`.

<!-- source: SRS FR-EMAIL-010 · module EMAIL · phase P1 · moscow MUST -->
