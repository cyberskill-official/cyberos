---
title: "Emit `email.thread.received`, `email.thread.sent` (summary only) cons…"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
emit `email.thread.received`, `email.thread.sent` (summary only) consumed by BRAIN.

<!-- source: SRS FR-EMAIL-019 · module EMAIL · phase P1 · moscow MUST -->
