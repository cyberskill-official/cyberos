---
title: "Support search: server-side IMAP SEARCH where supported, fallback to…"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
support search: server-side IMAP SEARCH where supported, fallback to local index.

<!-- source: SRS FR-EMAIL-008 · module EMAIL · phase P1 · moscow MUST -->
