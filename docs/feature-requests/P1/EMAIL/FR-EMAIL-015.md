---
title: "Route outbound transactional email (notifications, magic links, MFA c…"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
route outbound transactional email (notifications, magic links, MFA codes, invoice send) through Postmark or SES with full SPF/DKIM/DMARC on `cyberskill.world`.

<!-- source: SRS FR-EMAIL-015 · module EMAIL · phase P1 · moscow MUST -->
