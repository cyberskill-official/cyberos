---
title: "Parse calendar invites (RFC 5545 ICS) and present preview + RSVP UI"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
parse calendar invites (RFC 5545 ICS) and present preview + RSVP UI; RSVP sends iMIP REPLY back via SMTP.

<!-- source: SRS FR-EMAIL-009 · module EMAIL · phase P1 · moscow MUST -->
