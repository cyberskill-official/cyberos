---
title: "Sync the latest 90 days of message bodies into encrypted Postgres + S…"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
sync the latest 90 days of message bodies into encrypted Postgres + S3 cache (per-tenant residency); older messages fetched on-demand.

<!-- source: SRS FR-EMAIL-004 · module EMAIL · phase P1 · moscow MUST -->
