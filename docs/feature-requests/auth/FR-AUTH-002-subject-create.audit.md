...
| G-011 | §1 #14 | OTel metrics (`auth_subject_create_total/latency_ms/count`) absent | low | ~15 LOC | **DEFERRED to FR-OBS-001** (a half-built metrics surface would conflict with the OBS module's future architecture; FR-OBS-001 introduces the project-wide metrics SDK + naming convention. Per-handler counter wiring lands AFTER FR-OBS-001 ships the SDK) |
...
| 2026-05-19T13:10:00Z | 213 | (above) | `shipped + strict-audited` | status-cell-only (slice-3 closed G-007 + G-008 + G-014; G-011 OTel metrics reassigned to FR-OBS-001) |
...
*End of FR-AUTH-002 audit. Spec quality: PASS 10/10. Implementation: **13/14 gaps closed across slice-1 + slice-2 + slice-3**; 1 gap (G-011 OTel metrics) reassigned to FR-OBS-001. 119/119 auth-lib tests pass · 16 ignored integration tests across two test binaries (admin_tenant_create_test.rs + admin_subject_create_test.rs). Status: **shipped + strict-audited**.*
