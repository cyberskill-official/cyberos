...
3. **MUST** cache flag on FR-RES-001 matrix row:
   ```sql
...
4. **MUST** schedule weekly digest Friday 16:00 tenant_tz per DEC-2053 via FR-MCP-007 — count flagged members + send to CHRO via FR-EMAIL-009 + FR-CHAT-005.
