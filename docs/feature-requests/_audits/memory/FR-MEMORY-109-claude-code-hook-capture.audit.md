...
Direct chain write from hook = correctness but 200ms latency; queued via socket = fast but eventual emit. Resolved: §1 #6 + #10 socket IPC to FR-MEMORY-107 daemon; AC #15 latency budget; §2 explains the architectural choice.
