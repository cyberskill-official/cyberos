...
### ISS-006 — Destructive tools without confirm break FR-MCP-006
FR-MCP-006 requires elicit_confirm for destructive tools; bridge needs to enforce. Resolved: §1 clause 9 — bridge checks `elicit_confirm` flag, returns authz_denied if missing; AC #15.
