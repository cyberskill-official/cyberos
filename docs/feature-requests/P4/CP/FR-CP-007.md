---
title: "Support approvals (UAT sign-off) → triggers `proj.uat_signed_off` event"
author: "@cyberos-bot"
...
support approvals (UAT sign-off) → triggers `proj.uat_signed_off` event.

<!-- source: SRS FR-CP-007 · module CP · phase P4 · moscow MUST -->
