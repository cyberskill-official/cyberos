---
title: "Expose reduced-scope graph contract via Federation `@inaccessible` /…"
author: "@cyberos-bot"
...
expose reduced-scope graph contract via Federation `@inaccessible` / `@tag` directives.

<!-- source: SRS FR-CP-001 · module CP · phase P4 · moscow MUST -->
