---
title: "Support tenant branded portal (logo, color, custom domain via DNS CNAME"
author: "@cyberos-bot"
...
support tenant branded portal (logo, color, custom domain via DNS CNAME; per-Tenant CSS override).

<!-- source: SRS FR-CP-003 · module CP · phase P4 · moscow MUST -->
