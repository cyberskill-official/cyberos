---
title: "Support comments routed to PROJ as Comment with `actor_kind=external_…"
author: "@cyberos-bot"
...
support comments routed to PROJ as Comment with `actor_kind=external_client`.

<!-- source: SRS FR-CP-006 · module CP · phase P4 · moscow MUST -->
