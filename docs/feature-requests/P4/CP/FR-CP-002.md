---
title: "Support auth via magic-link (default) or external IdP (OQ-009 final)"
author: "@cyberos-bot"
...
support auth via magic-link (default) or external IdP (OQ-009 final).

<!-- source: SRS FR-CP-002 · module CP · phase P4 · moscow MUST -->
