---
title: "Provide client dashboard: their projects + status, recent task update…"
author: "@cyberos-bot"
...
provide client dashboard: their projects + status, recent task updates (read-only or comment-only), upcoming deliverables, recent invoices, pending signatures.

<!-- source: SRS FR-CP-004 · module CP · phase P4 · moscow MUST -->
