---
title: "Support client onboarding via email invite + password + (optional) MFA"
author: "@cyberos-bot"
...
support client onboarding via email invite + password + (optional) MFA.

<!-- source: SRS FR-CP-012 · module CP · phase P4 · moscow MUST -->
