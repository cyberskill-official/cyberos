---
title: "Support project visibility: tasks shared via \"Share with client\" flag"
author: "@cyberos-bot"
...
support project visibility: tasks shared via "Share with client" flag; client sees status + comments + selected attachments; cannot see internal tasks.

<!-- source: SRS FR-CP-005 · module CP · phase P4 · moscow MUST -->
