---
title: "Support optional MCP for client-run agents (consent-gated"
author: "@cyberos-bot"
...
support optional MCP for client-run agents (consent-gated; per-client OAuth scope).

<!-- source: SRS FR-CP-011 · module CP · phase P4 · moscow SHOULD -->
