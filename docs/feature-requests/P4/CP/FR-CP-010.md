---
title: "Support client-facing chat (optional per-Tenant"
author: "@cyberos-bot"
...
support client-facing chat (optional per-Tenant; uses CHAT module with reduced scope).

<!-- source: SRS FR-CP-010 · module CP · phase P4 · moscow MUST -->
