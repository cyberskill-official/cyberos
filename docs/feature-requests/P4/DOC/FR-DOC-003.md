---
title: "Support multi-signer workflows: sequential or parallel"
author: "@cyberos-bot"
...
support multi-signer workflows: sequential or parallel.

<!-- source: SRS FR-DOC-003 · module DOC · phase P4 · moscow MUST -->
