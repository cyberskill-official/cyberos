---
title: "Support QES (Qualified Electronic Signatures) via QTSP and SES (Stand…"
author: "@cyberos-bot"
...
support QES (Qualified Electronic Signatures) via QTSP and SES (Standard Electronic Signatures).

<!-- source: SRS FR-DOC-005 · module DOC · phase P4 · moscow MUST -->
