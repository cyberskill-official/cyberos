---
title: "Integrate with CRM (Deal moves to \"Closed-Won\" on signing) and HR (em…"
author: "@cyberos-bot"
...
integrate with CRM (Deal moves to "Closed-Won" on signing) and HR (employment contracts archived).

<!-- source: SRS FR-DOC-007 · module DOC · phase P4 · moscow MUST -->
