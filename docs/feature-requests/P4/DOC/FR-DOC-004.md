---
title: "Store signed PDF + signing certificate + IP/timestamp per signer + si…"
author: "@cyberos-bot"
...
store signed PDF + signing certificate + IP/timestamp per signer + signing intent declaration.

<!-- source: SRS FR-DOC-004 · module DOC · phase P4 · moscow MUST -->
