...
source_decisions:
  - docs/feature-requests/ai/FR-AI-005-tenant-policy-yaml-loader.md §3 (Provider enum + model_alias_map)
  - docs/feature-requests/ai/FR-AI-007-provider-cost-table-loader.md §1 (cost entry must exist)
