...
source_decisions:
  - docs/feature-requests/ai/FR-AI-001-cost-ledger-precheck/spec.md §1 #8 (YAML config promoted to normative)
  - docs/feature-requests/ai/FR-AI-005-tenant-policy-yaml-loader/spec.md (loader pattern reuse)
  - docs/feature-requests/ai/FR-AI-006-model-alias-resolution/spec.md §1 #5 (cost-entry validation)
