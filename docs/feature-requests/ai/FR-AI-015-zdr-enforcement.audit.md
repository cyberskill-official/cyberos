...
- §3 specifies the memory audit row builder (`canonical::zdr_violation`) inside this FR, not punting to FR-AI-003. The owning-FR-builds-the-builder pattern matches FR-AI-014's `canonical::persona_loaded` fix.
