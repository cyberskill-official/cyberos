...
| [FR-AI-003](FR-AI-003-brain-audit-bridge.md) | MUST | 1 | 5 | BRAIN audit-row bridge — canonical Writer for AI Gateway |
...
| [FR-AI-014](FR-AI-014-persona-version-stamping.md) | MUST | 3 | 8 | Persona-version system-prompt injection from BRAIN memories/personas/<handle>.md |
...
| [FR-AI-021](FR-AI-021-operator-cli.md) | MUST | 5 | 14 | cyberos-ai operator CLI (usage · models · policy · failover · invoice · breaker · expiry · brain) wi |
...
- **BRAIN**: FR-BRAIN-101→FR-AI-019, FR-BRAIN-111→FR-AI-012
