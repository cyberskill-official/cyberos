...
FR-AI-015 §1 #6 mandates an `ai.zdr_violation` memory row on every ZDR refusal — the proof-of-refusal primitive. The first-pass FR-AI-016 has no equivalent for residency violations.
