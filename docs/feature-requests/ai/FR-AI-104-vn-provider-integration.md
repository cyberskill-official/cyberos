---
id: FR-AI-104
title: "AI VN provider integration — Viettel Cloud + FPT Cloud as Vn1-residency LLM/embedding providers with FR-AI-016 region set extension"
module: AI
priority: SHOULD
status: draft
verify: T
...
source_decisions:
  - DEC-2380 2026-05-17 — Add Viettel Cloud + FPT Cloud as approved Vn1-residency providers; integrates with FR-AI-016 region resolution
...
risk_if_skipped: "Without VN providers, Vn1 tenants stuck (FR-AI-016 refuses). Without DEC-2383 failover, single-provider outage = Vn1 service down. Without DEC-2380 region set extension, FR-AI-016 contract unfulfilled."
---
...
2. **MUST** add to FR-AI-016 region set per DEC-2380 — modify `residency_resolver.rs` to include Viettel + FPT region strings for `Vn1`.
...
**Why preserve refusal contract (DEC-2380)?** FR-AI-016 `vn1_no_provider_yet` becomes `vn1_provider_outage` after integration — both-down case still refused, never silently routed elsewhere.
