...
source_decisions:
  - docs/feature-requests/ai/FR-AI-001-cost-ledger-precheck.md §3 (TenantPolicy shape)
  - docs/feature-requests/ai/FR-AI-001-cost-ledger-precheck.md §9 Q2 (missing-policy default = refuse)
