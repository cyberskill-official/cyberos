...
source_decisions:
  - docs/feature-requests/ai/FR-AI-008-multi-provider-router/spec.md §1 #16 (router exposes call_provider_streaming with SSE pipeline)
  - docs/feature-requests/ai/FR-AI-002-cost-ledger-reconcile/spec.md §1 #5 (cancel-before-first-token reconciles as Cancelled and refunds)
