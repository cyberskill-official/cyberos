...
source_decisions:
  - docs/feature-requests/ai/FR-AI-008-multi-provider-router.md §1 #5 (failover policy needs a circuit breaker to avoid hammering a dead provider)
  - docs/feature-requests/ai/FR-AI-008-multi-provider-router.md §6 (build_provider_chain hook for breaker filtering)
