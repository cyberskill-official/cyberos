...
source_decisions:
  - docs/feature-requests/ai/FR-AI-001-cost-ledger-precheck/spec.md §3 (cost_ledger_hold TTL = 60s)
  - docs/feature-requests/ai/FR-AI-002-cost-ledger-postcall-reconcile/spec.md §3 (state machine: held → expired)
...
*End of FR-AI-004. Run `feature-request-audit` next: `cargo run -p cyberos-skill-cli -- run feature-request-audit --input '{"fr_path": "docs/feature-requests/ai/FR-AI-004-cost-hold-expiry-cleanup/spec.md"}'`*
