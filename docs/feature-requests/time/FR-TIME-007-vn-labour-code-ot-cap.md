...
7. **MUST** consume per-Member `vn_ot_approval` flag per DEC-1393 from `hr_members.vn_ot_approval`. FR-HR-001 owns this field; CLO sets after MOLISA approval received.
...
| Member changes residency from vn-1 to sg-1 | residency immutable per FR-TEN-103 | Cannot happen | Inherent |
