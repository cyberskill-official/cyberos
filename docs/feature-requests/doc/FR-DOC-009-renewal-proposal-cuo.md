...
source_decisions:
  - DEC-1730 2026-05-17 — Triggered at d90 alert (FR-DOC-008) for contracts with auto_renew=true OR manually by CLO
...
5. **MUST** on approval per DEC-1734:
   ...
   - Status='draft'.
   - Lifecycle status compute via FR-DOC-007 (will be 'draft' if effective > now).
...
**Why d90 trigger (DEC-1730)?** Aligns with FR-DOC-008 first alert; gives full quarter for negotiation.
