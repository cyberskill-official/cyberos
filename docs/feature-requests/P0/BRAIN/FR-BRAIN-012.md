---
title: "Expose `brain.ask(question, scope?)`: RAG endpoint via AI Gateway"
author: "@cyberos-bot"
...
expose `brain.ask(question, scope?)`: RAG endpoint via AI Gateway; force source-citation; "I don't know" if no relevant chunks.

<!-- source: SRS FR-BRAIN-012 · module BRAIN · phase P0 · moscow MUST -->
