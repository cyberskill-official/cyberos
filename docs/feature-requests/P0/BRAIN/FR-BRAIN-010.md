---
title: "Dispatch to regional cluster per `tenant.residency`"
author: "@cyberos-bot"
...
dispatch to regional cluster per `tenant.residency`; cross-region read forbidden.

<!-- source: SRS FR-BRAIN-010 · module BRAIN · phase P0 · moscow MUST -->
