---
title: "Expose `brain.list_chunks_for_member(member_id)` for Member self-serv…"
author: "@cyberos-bot"
...
expose `brain.list_chunks_for_member(member_id)` for Member self-serve DSAR (own footprint).

<!-- source: SRS FR-BRAIN-013 · module BRAIN · phase P0 · moscow MUST -->
