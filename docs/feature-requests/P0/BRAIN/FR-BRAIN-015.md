---
title: "Run nightly retention purge `DELETE FROM knowledge_chunk WHERE retent…"
author: "@cyberos-bot"
...
run nightly retention purge `DELETE FROM knowledge_chunk WHERE retention_until < NOW()` in 1000-row batches.

<!-- source: SRS FR-BRAIN-015 · module BRAIN · phase P0 · moscow MUST -->
