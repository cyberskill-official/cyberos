---
title: "Call AI Gateway `embed` (cached)"
author: "@cyberos-bot"
...
call AI Gateway `embed` (cached); persist `body_embedding` (vector(1536)) + `body_search_tsv` + `body_pgroonga` in atomic transaction.

<!-- source: SRS FR-BRAIN-006 · module BRAIN · phase P0 · moscow MUST -->
