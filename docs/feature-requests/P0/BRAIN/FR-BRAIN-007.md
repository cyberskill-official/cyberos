---
title: "Be idempotent on `(tenant_id, source_module, source_entity_id, source…"
author: "@cyberos-bot"
...
be idempotent on `(tenant_id, source_module, source_entity_id, source_entity_version)`.

<!-- source: SRS FR-BRAIN-007 · module BRAIN · phase P0 · moscow MUST -->
