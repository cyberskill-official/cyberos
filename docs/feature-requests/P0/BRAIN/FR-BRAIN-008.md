---
title: "Re-embed on source row update"
author: "@cyberos-bot"
...
re-embed on source row update; old version retained 24h then GC'd.

<!-- source: SRS FR-BRAIN-008 · module BRAIN · phase P0 · moscow MUST -->
