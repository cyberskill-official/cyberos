---
title: "Track ingestion latency per source"
author: "@cyberos-bot"
...
track ingestion latency per source; emit OBS metric for SLO.

<!-- source: SRS FR-BRAIN-017 · module BRAIN · phase P0 · moscow MUST -->
