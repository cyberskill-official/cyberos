---
title: "Support `brain.reindex_source(source_module)` for parameter or schema…"
author: "@cyberos-bot"
...
support `brain.reindex_source(source_module)` for parameter or schema changes.

<!-- source: SRS FR-BRAIN-016 · module BRAIN · phase P0 · moscow MUST -->
