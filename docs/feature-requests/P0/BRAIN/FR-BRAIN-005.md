---
title: "Queue ingestion jobs in BullMQ `brain-ingest` queue"
author: "@cyberos-bot"
...
queue ingestion jobs in BullMQ `brain-ingest` queue; concurrency 8 per pod; retry 3× exponential backoff; DLQ on permanent failure.

<!-- source: SRS FR-BRAIN-005 · module BRAIN · phase P0 · moscow MUST -->
