---
title: "Maintain `knowledge_chunk` table with the schema in §4"
author: "@cyberos-bot"
...
maintain `knowledge_chunk` table with the schema in §4.6.2.

<!-- source: SRS FR-BRAIN-001 · module BRAIN · phase P0 · moscow MUST -->
