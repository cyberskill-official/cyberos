---
title: "Apply ingestion policy per source — embed (possibly redacted) text, a…"
author: "@cyberos-bot"
...
apply ingestion policy per source — embed (possibly redacted) text, assign `pii_class`, set `dsar_marker = member_id` reference, set `retention_until` per source-module retention rules.

<!-- source: SRS FR-BRAIN-004 · module BRAIN · phase P0 · moscow MUST -->
