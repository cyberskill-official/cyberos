---
title: "Support DSAR erasure: tombstone `deleted_at` + body → \"[redacted]\""
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
support DSAR erasure: tombstone `deleted_at` + body → "[redacted]"; full purge after retention; cascades to BRAIN chunks.

<!-- source: SRS FR-CHAT-015 · module CHAT · phase P0 · moscow MUST -->
