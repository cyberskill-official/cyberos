---
title: "Apply tenant residency to message + file storage per DEC-011"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
apply tenant residency to message + file storage per DEC-011.

<!-- source: SRS FR-CHAT-014 · module CHAT · phase P0 · moscow MUST -->
