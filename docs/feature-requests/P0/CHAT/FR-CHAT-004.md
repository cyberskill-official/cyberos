---
title: "Support emoji reactions, message edit (with `edited_at`), soft-delete…"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
support emoji reactions, message edit (with `edited_at`), soft-delete (never hard-delete; tombstone + redacted body for compliance + retention).

<!-- source: SRS FR-CHAT-004 · module CHAT · phase P0 · moscow MUST -->
