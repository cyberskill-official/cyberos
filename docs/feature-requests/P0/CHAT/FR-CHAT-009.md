---
title: "Deliver realtime via Socket"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
deliver realtime via Socket.IO over WebSocket with long-poll fallback; auth via JWT in handshake.

<!-- source: SRS FR-CHAT-009 · module CHAT · phase P0 · moscow MUST -->
