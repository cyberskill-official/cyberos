---
title: "Emit `chat.message_sent` event to NATS for downstream consumers (BRAI…"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
emit `chat.message_sent` event to NATS for downstream consumers (BRAIN ingestion, search index, AI summarize triggers, audit ingestion).

<!-- source: SRS FR-CHAT-012 · module CHAT · phase P0 · moscow MUST -->
