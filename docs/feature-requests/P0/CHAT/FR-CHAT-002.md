---
title: "Support threads — parent message + replies, with \"also send to channe…"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
support threads — parent message + replies, with "also send to channel" option.

<!-- source: SRS FR-CHAT-002 · module CHAT · phase P0 · moscow MUST -->
