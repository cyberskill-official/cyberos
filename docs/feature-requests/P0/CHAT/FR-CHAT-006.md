---
title: "Support slash commands (built-in `/giphy`, `/shrug`, `/genie`, `/remind`"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
support slash commands (built-in `/giphy`, `/shrug`, `/genie`, `/remind`; custom commands registered from MCP tool surface).

<!-- source: SRS FR-CHAT-006 · module CHAT · phase P0 · moscow MUST -->
