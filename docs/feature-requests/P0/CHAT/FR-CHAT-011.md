---
title: "Persist messages append-only with `audit_hash = sha256(prev_audit_has…"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
persist messages append-only with `audit_hash = sha256(prev_audit_hash || canonical_json(payload))` per channel — Merkle chain.

<!-- source: SRS FR-CHAT-011 · module CHAT · phase P0 · moscow MUST -->
