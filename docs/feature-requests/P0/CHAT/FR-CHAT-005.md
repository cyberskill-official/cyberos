---
title: "Support file uploads via S3-compatible per-tenant-residency-tagged bu…"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
support file uploads via S3-compatible per-tenant-residency-tagged bucket; signed URL to client; metadata in `chat_message.files` jsonb. Inline preview for image/PDF/video (≤50MB)/CSV/Excel.

<!-- source: SRS FR-CHAT-005 · module CHAT · phase P0 · moscow MUST -->
