---
title: "Support workspaces (1 per tenant), public channels, private channels…"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
support workspaces (1 per tenant), public channels, private channels, DMs, group DMs (≤9 participants).

<!-- source: SRS FR-CHAT-001 · module CHAT · phase P0 · moscow MUST -->
