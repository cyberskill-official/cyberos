---
title: "Support full-text search via tsvector + Vietnamese PGroonga"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
support full-text search via tsvector + Vietnamese PGroonga; semantic search via pgvector embeddings of message bodies (lazy-indexed, surfaced through BRAIN).

<!-- source: SRS FR-CHAT-007 · module CHAT · phase P0 · moscow MUST -->
