---
title: "Support channel notification preferences: `all` / `mentions` / `nothing`"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
support channel notification preferences: `all` / `mentions` / `nothing`.

<!-- source: SRS FR-CHAT-022 · module CHAT · phase P0 · moscow MUST -->
