---
title: "Support thread/channel AI summarize via `chat.summarize_thread` and `…"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p1"
...
support thread/channel AI summarize via `chat.summarize_thread` and `chat.summarize_channel` MCP tools.

<!-- source: SRS FR-CHAT-017 · module CHAT · phase P0 · moscow SHOULD -->
