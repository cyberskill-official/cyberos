---
title: "Support `@user`, `@channel`, `@here`, `@team` mentions and route web-…"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
support `@user`, `@channel`, `@here`, `@team` mentions and route web-push notifications per Member preferences.

<!-- source: SRS FR-CHAT-003 · module CHAT · phase P0 · moscow MUST -->
