...
install New Relic Node.js agent on every subgraph + MCP server + Socket.IO sidecar + EMAIL workers + BRAIN ingestion workers + Genie service.

<!-- source: SRS FR-OBS-001 · module OBS · phase P0 · moscow MUST -->
