---
title: "Define SLOs per module (latency, error rate, freshness) and track 28-…"
author: "@cyberos-bot"
...
define SLOs per module (latency, error rate, freshness) and track 28-day error budget.

<!-- source: SRS FR-OBS-004 · module OBS · phase P0 · moscow MUST -->
