---
title: "Monitor BRAIN denylist enforcement: any chunk with `source_module IN…"
author: "@cyberos-bot"
...
monitor BRAIN denylist enforcement: any chunk with `source_module IN ('rew', 'esop')` is sev-0.

<!-- source: SRS FR-OBS-009 · module OBS · phase P0 · moscow MUST -->
