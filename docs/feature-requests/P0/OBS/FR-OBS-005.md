---
title: "Route NRQL alerts to CHAT `#cyberos-alerts`"
author: "@cyberos-bot"
...
route NRQL alerts to CHAT `#cyberos-alerts`; sev-0 also pages PagerDuty.

<!-- source: SRS FR-OBS-005 · module OBS · phase P0 · moscow MUST -->
