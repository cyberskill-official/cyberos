---
title: "Run nightly compensation guardrail check: P1 reduction = 0"
author: "@cyberos-bot"
...
run nightly compensation guardrail check: P1 reduction = 0; P3 cap respected on every payslip; BP ledger balance reconciles to events; ESOP event chain valid.

<!-- source: SRS FR-OBS-006 · module OBS · phase P0 · moscow MUST -->
