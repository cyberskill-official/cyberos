---
title: "Structured-log via pino with OTLP export"
author: "@cyberos-bot"
...
structured-log via pino with OTLP export; correlation ID per request propagated through subgraph + MCP + workers.

<!-- source: SRS FR-OBS-003 · module OBS · phase P0 · moscow MUST -->
