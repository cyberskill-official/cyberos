---
title: "Invoke MCP tools for action requests using Member's JWT"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
invoke MCP tools for action requests using Member's JWT; **MUST** require explicit user confirmation (Yes/Edit/No chip) before executing any write tool.

<!-- source: SRS FR-GENIE-007 · module GENIE · phase P0 · moscow MUST -->
