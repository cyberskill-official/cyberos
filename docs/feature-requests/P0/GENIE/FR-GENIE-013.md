---
title: "Render visual mascot states: idle, listening, thinking, speaking, err…"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
render visual mascot states: idle, listening, thinking, speaking, error, succeeded — based on the CyberSkill logo (PRD §11).

<!-- source: SRS FR-GENIE-013 · module GENIE · phase P0 · moscow MUST -->
