---
title: "Support voice input (P1 stretch via Whisper API or on-device — OQ-020)"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p1"
...
support voice input (P1 stretch via Whisper API or on-device — OQ-020).

<!-- source: SRS FR-GENIE-015 · module GENIE · phase P0 · moscow SHOULD -->
