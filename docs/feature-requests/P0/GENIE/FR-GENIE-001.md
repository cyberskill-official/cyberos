---
title: "Be invocable via floating button on every MFE remote"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
be invocable via floating button on every MFE remote; ⌘+G global keyboard shortcut; `/genie` slash command in CHAT.

<!-- source: SRS FR-GENIE-001 · module GENIE · phase P0 · moscow MUST -->
