---
title: "Maintain `genie_persona_version` table (immutable"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
maintain `genie_persona_version` table (immutable; UPDATE/DELETE blocked at DB-policy level) per DEC-031 pattern.

<!-- source: SRS FR-GENIE-004 · module GENIE · phase P0 · moscow MUST -->
