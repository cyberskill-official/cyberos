---
title: "Call `brain.ask` for factual queries"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
call `brain.ask` for factual queries; force source citation; render citations as clickable `cyberos://{module}/{path}` chips.

<!-- source: SRS FR-GENIE-006 · module GENIE · phase P0 · moscow MUST -->
