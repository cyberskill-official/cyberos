---
title: "Audit-log every conversation turn + tool invocation: actor, persona_v…"
author: "@cyberos-bot"
department: "product"
status: "draft"
priority: "p0"
...
audit-log every conversation turn + tool invocation: actor, persona_version_id, prompt, response, citations[], tool_invoked?, before, after, occurred_at.

<!-- source: SRS FR-GENIE-010 · module GENIE · phase P0 · moscow MUST -->
