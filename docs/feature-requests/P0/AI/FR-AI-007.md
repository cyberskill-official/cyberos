---
title: "Auto-fallback Bedrock → OpenAI → Anthropic on provider 5xx within ret…"
author: "@cyberos-bot"
...
auto-fallback Bedrock → OpenAI → Anthropic on provider 5xx within retry budget (default 3 retries with exponential backoff).

<!-- source: SRS FR-AI-007 · module AI · phase P0 · moscow MUST -->
