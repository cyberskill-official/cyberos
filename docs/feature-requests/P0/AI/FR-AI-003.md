---
title: "Expose `aiGateway.tool_call(...)` for function-calling support"
author: "@cyberos-bot"
...
expose `aiGateway.tool_call(...)` for function-calling support.

<!-- source: SRS FR-AI-003 · module AI · phase P0 · moscow MUST -->
