---
title: "Support per-tenant model preference override (tenant-level config)"
author: "@cyberos-bot"
...
support per-tenant model preference override (tenant-level config).

<!-- source: SRS FR-AI-013 · module AI · phase P0 · moscow SHOULD -->
