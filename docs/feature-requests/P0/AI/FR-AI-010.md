---
title: "Log every LLM call to OBS with cost, latency, token counts"
author: "@cyberos-bot"
...
log every LLM call to OBS with cost, latency, token counts; mark AI-derived outputs as PD per DEC-012.

<!-- source: SRS FR-AI-010 · module AI · phase P0 · moscow MUST -->
