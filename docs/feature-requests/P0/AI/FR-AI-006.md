---
title: "Cache embeddings by `sha256(text)` in Redis with 30-day TTL"
author: "@cyberos-bot"
...
cache embeddings by `sha256(text)` in Redis with 30-day TTL.

<!-- source: SRS FR-AI-006 · module AI · phase P0 · moscow MUST -->
