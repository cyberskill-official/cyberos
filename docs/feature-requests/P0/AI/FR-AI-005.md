---
title: "Redact PII (emails, phone, ID numbers, comp values, ESOP balances, BP…"
author: "@cyberos-bot"
...
redact PII (emails, phone, ID numbers, comp values, ESOP balances, BP balances, special-category) by default; routes can opt out only with explicit `pii_safe_route` scope.

<!-- source: SRS FR-AI-005 · module AI · phase P0 · moscow MUST -->
