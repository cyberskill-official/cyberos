---
title: "Expose `aiGateway.embed({text, model})` returning a vector"
author: "@cyberos-bot"
...
expose `aiGateway.embed({text, model})` returning a vector.

<!-- source: SRS FR-AI-002 · module AI · phase P0 · moscow MUST -->
