---
title: "Never be invoked from REW/ESOP/LEARN math paths"
author: "@cyberos-bot"
...
never be invoked from REW/ESOP/LEARN math paths. CI lint rule enforces (`@cyberos/eslint-config` rule `no-ai-in-math`).

<!-- source: SRS FR-AI-009 · module AI · phase P0 · moscow MUST -->
