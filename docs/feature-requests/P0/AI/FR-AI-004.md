---
title: "Enforce per-tenant monthly USD budget cap"
author: "@cyberos-bot"
...
enforce per-tenant monthly USD budget cap; reject calls when exceeded with 402-equivalent error; alert via OBS at 80% threshold.

<!-- source: SRS FR-AI-004 · module AI · phase P0 · moscow MUST -->
