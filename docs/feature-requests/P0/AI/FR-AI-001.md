---
title: "Expose `aiGateway.complete({prompt, model, temperature, max_tokens, s…"
author: "@cyberos-bot"
...
expose `aiGateway.complete({prompt, model, temperature, max_tokens, stream})` for chat completion.

<!-- source: SRS FR-AI-001 · module AI · phase P0 · moscow MUST -->
