---
title: "Maintain a model registry (`model_registry` table) tracking provider…"
author: "@cyberos-bot"
...
maintain a model registry (`model_registry` table) tracking provider, version, modality, training-data summary, eval results, deprecation date.

<!-- source: SRS FR-AI-012 · module AI · phase P0 · moscow MUST -->
