---
title: "Support self-service password reset via email link (single-use, 1h ex…"
author: "@cyberos-bot"
...
support self-service password reset via email link (single-use, 1h expiry).

<!-- source: SRS FR-AUTH-014 · module AUTH · phase P0 · moscow MUST -->
