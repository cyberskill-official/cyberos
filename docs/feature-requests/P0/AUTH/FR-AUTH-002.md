...
support Google OAuth 2.1 OIDC sign-in. Microsoft 365 OAuth supported as P1 add for EMAIL provider linking.

<!-- source: SRS FR-AUTH-002 · module AUTH · phase P0 · moscow MUST -->
