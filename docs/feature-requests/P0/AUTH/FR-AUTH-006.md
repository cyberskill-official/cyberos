---
title: "Require TOTP MFA enrollment for **all roles** before first non-MFA ac…"
author: "@cyberos-bot"
...
require TOTP MFA enrollment for **all roles** before first non-MFA action (NYDFS Part 500 §11 alignment).

<!-- source: SRS FR-AUTH-006 · module AUTH · phase P0 · moscow MUST -->
