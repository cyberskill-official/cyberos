---
title: "Apply tenant `residency` from the JWT to dispatch all queries to the…"
author: "@cyberos-bot"
...
apply tenant `residency` from the JWT to dispatch all queries to the regional cluster (DEC-011).

<!-- source: SRS FR-AUTH-016 · module AUTH · phase P0 · moscow MUST -->
