---
title: "Enforce `app.tenant_id` Postgres session var per request before any d…"
author: "@cyberos-bot"
...
enforce `app.tenant_id` Postgres session var per request before any data query.

<!-- source: SRS FR-AUTH-008 · module AUTH · phase P0 · moscow MUST -->
