---
title: "Issue RS256 JWT with claims `sub`, `tid`, `roles[]`, `scopes[]`, `res…"
author: "@cyberos-bot"
...
issue RS256 JWT with claims `sub`, `tid`, `roles[]`, `scopes[]`, `residency`, `exp` ≤24h. Rotation with refresh-token replay detection.

<!-- source: SRS FR-AUTH-003 · module AUTH · phase P0 · moscow MUST -->
