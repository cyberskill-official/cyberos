---
title: "Support email + password sign-in"
author: "@cyberos-bot"
...
support email + password sign-in. Passwords stored as Argon2id (memory=64MB, iterations=3, parallelism=4). HIBP breach check on password set/change.

<!-- source: SRS FR-AUTH-001 · module AUTH · phase P0 · moscow MUST -->
