---
title: "Support Member invitation via single-use token (7-day expiry)"
author: "@cyberos-bot"
...
support Member invitation via single-use token (7-day expiry).

<!-- source: SRS FR-AUTH-004 · module AUTH · phase P0 · moscow MUST -->
