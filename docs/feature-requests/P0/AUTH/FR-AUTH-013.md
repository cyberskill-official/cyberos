---
title: "Support fine-grained scope claims (`projects:read`, `projects:write`…"
author: "@cyberos-bot"
...
support fine-grained scope claims (`projects:read`, `projects:write`, `compensation:read`, `compensation:write`, `esop:read`, `esop:write`, `genie:invoke`, etc.).

<!-- source: SRS FR-AUTH-013 · module AUTH · phase P0 · moscow MUST -->
