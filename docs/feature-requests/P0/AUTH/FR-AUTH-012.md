---
title: "Support per-Member API tokens (limited scope, audited, rotatable, exp…"
author: "@cyberos-bot"
...
support per-Member API tokens (limited scope, audited, rotatable, expiry configurable).

<!-- source: SRS FR-AUTH-012 · module AUTH · phase P0 · moscow MUST -->
