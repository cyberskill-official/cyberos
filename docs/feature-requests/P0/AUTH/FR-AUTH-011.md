---
title: "Allow only Founder/CEO role to create new tenants through P3"
author: "@cyberos-bot"
...
allow only Founder/CEO role to create new tenants through P3; the Tenant Admin self-create flow is gated to P4.

<!-- source: SRS FR-AUTH-011 · module AUTH · phase P0 · moscow MUST -->
