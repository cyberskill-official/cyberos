---
title: "Support role assignment from `{owner, admin, member, viewer, client…"
author: "@cyberos-bot"
...
support role assignment from `{owner, admin, member, viewer, client, board, hr_lead, account_manager, engineering_lead}`. Multi-role per Member supported.

<!-- source: SRS FR-AUTH-005 · module AUTH · phase P0 · moscow MUST -->
