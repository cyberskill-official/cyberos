---
title: "Publish prompt templates (\"Weekly OKR review\", \"Monthly payro…)"
author: "@cyberos-bot"
...
publish prompt templates ("Weekly OKR review", "Monthly payroll close", "New client kickoff", "Quarterly Board pack") as MCP Prompts.

<!-- source: SRS FR-MCP-010 · module MCP · phase P0 · moscow MUST -->
