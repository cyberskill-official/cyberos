---
title: "Support OAuth scope-down flow so Member can delegate a 3rd-party agen…"
author: "@cyberos-bot"
...
support OAuth scope-down flow so Member can delegate a 3rd-party agent with reduced scopes (P4).

<!-- source: SRS FR-MCP-009 · module MCP · phase P0 · moscow MUST -->
