---
title: "Expose Streamable HTTP at `https://mcp.cyberos.vn/mcp` (regional resi…"
author: "@cyberos-bot"
...
expose Streamable HTTP at `https://mcp.cyberos.vn/mcp` (regional residency mirrors at `mcp-eu`, `mcp-us`, `mcp-apac`).

<!-- source: SRS FR-MCP-001 · module MCP · phase P0 · moscow MUST -->
