---
title: "Provide self-describing tool enumeration for any MCP client"
author: "@cyberos-bot"
...
provide self-describing tool enumeration for any MCP client.

<!-- source: SRS FR-MCP-011 · module MCP · phase P0 · moscow MUST -->
