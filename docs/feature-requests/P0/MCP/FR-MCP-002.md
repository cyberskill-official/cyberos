---
title: "Authenticate via OAuth 2"
author: "@cyberos-bot"
...
authenticate via OAuth 2.1 + PKCE; per RFC 9728 publish protected-resource metadata.

<!-- source: SRS FR-MCP-002 · module MCP · phase P0 · moscow MUST -->
