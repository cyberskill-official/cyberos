---
title: "Support the Tasks primitive for >10s long-running operations (PDF ren…"
author: "@cyberos-bot"
...
support the Tasks primitive for >10s long-running operations (PDF render, valuation re-compute, mailbox bulk import, BRAIN reindex).

<!-- source: SRS FR-MCP-005 · module MCP · phase P0 · moscow MUST -->
