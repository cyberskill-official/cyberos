---
title: "Aggregate line items from `time.list_entries({status: APPROVED})`"
author: "@cyberos-bot"
...
aggregate line items from `time.list_entries({status: APPROVED})`; manual line items supported.

<!-- source: SRS FR-INV-002 · module INV · phase P2 · moscow MUST -->
