---
title: "Generate invoice number per tenant per year (`{tenant_prefix}-{yyyy}-…"
author: "@cyberos-bot"
...
generate invoice number per tenant per year (`{tenant_prefix}-{yyyy}-{nnnn}`).

<!-- source: SRS FR-INV-001 · module INV · phase P2 · moscow MUST -->
