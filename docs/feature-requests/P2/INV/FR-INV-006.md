---
title: "Support Stripe payment links + webhook reconciliation"
author: "@cyberos-bot"
...
support Stripe payment links + webhook reconciliation; idempotent on duplicate webhook.

<!-- source: SRS FR-INV-006 · module INV · phase P2 · moscow MUST -->
