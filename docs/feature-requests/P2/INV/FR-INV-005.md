---
title: "Generate PDF server-side (React PDF) with bilingual VN/EN"
author: "@cyberos-bot"
...
generate PDF server-side (React PDF) with bilingual VN/EN; tenant-branded.

<!-- source: SRS FR-INV-005 · module INV · phase P2 · moscow MUST -->
