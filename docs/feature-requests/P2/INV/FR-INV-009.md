---
title: "Emit `invoice.issued`, `invoice.viewed`, `invoice.collected`, `invoic…"
author: "@cyberos-bot"
...
emit `invoice.issued`, `invoice.viewed`, `invoice.collected`, `invoice.overdue` events.

<!-- source: SRS FR-INV-009 · module INV · phase P2 · moscow MUST -->
