---
title: "Flag Vietnamese e-invoice format requirement when tenant locale is `v…"
author: "@cyberos-bot"
...
flag Vietnamese e-invoice format requirement when tenant locale is `vi-VN` (legal advisory pending — RSK-007); integrate with VN GDT e-invoice provider (OQ-016).

<!-- source: SRS FR-INV-007 · module INV · phase P2 · moscow MUST -->
