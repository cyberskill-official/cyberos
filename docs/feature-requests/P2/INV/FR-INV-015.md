---
title: "Export accountant-friendly monthly invoice register CSV/XLSX"
author: "@cyberos-bot"
...
export accountant-friendly monthly invoice register CSV/XLSX.

<!-- source: SRS FR-INV-015 · module INV · phase P2 · moscow MUST -->
