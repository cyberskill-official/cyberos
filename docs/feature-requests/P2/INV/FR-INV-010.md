---
title: "Payload `invoice.collected`: `{tenant_id, invoice_id, project_id, cas…"
author: "@cyberos-bot"
...
payload `invoice.collected`: `{tenant_id, invoice_id, project_id, cash_collected_vnd, currency, exchange_rate_used}` consumed by REW + ESOP.

<!-- source: SRS FR-INV-010 · module INV · phase P2 · moscow MUST -->
