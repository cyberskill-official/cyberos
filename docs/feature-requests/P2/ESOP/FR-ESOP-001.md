---
title: "Maintain `sp_grant`, `sp_event`, `sp_valuation`, `cfo_input`, `put_op…"
author: "@cyberos-bot"
department: "hr"
status: "draft"
priority: "p0"
...
maintain `sp_grant`, `sp_event`, `sp_valuation`, `cfo_input`, `put_option_request` as append-only tables; UPDATE/DELETE blocked at DB-policy level.

<!-- source: SRS FR-ESOP-001 · module ESOP · phase P2 · moscow MUST -->
