---
title: "Support M&A acceleration: on `esop.simulate_acceleration` or actual `…"
author: "@cyberos-bot"
department: "hr"
status: "draft"
priority: "p0"
...
support M&A acceleration: on `esop.simulate_acceleration` or actual `liquidity_event_executed` event, all SP for all Members vests immediately to 100%. Member elects cash at deal valuation OR conversion to actual ESOP shares.

<!-- source: SRS FR-ESOP-008 · module ESOP · phase P2 · moscow MUST -->
