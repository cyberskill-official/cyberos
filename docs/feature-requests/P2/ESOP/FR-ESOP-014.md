---
title: "Support `esop.recompute_member_state(member_id, as_of_date)` returnin…"
author: "@cyberos-bot"
department: "hr"
status: "draft"
priority: "p0"
...
support `esop.recompute_member_state(member_id, as_of_date)` returning vesting + balance + valuation reproducibly.

<!-- source: SRS FR-ESOP-014 · module ESOP · phase P2 · moscow MUST -->
