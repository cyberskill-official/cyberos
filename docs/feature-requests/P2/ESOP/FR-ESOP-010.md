---
title: "Apply MVP Award SP multiplier: on `mvp_award_granted` event from REW…"
author: "@cyberos-bot"
department: "hr"
status: "draft"
priority: "p0"
...
apply MVP Award SP multiplier: on `mvp_award_granted` event from REW, next-year SP grant for recipient gets ×1.5; recorded as event metadata.

<!-- source: SRS FR-ESOP-010 · module ESOP · phase P2 · moscow MUST -->
