---
title: "Publish annual valuation via `esop.publish_valuation` (Founder/CEO +…"
author: "@cyberos-bot"
department: "hr"
status: "draft"
priority: "p0"
...
publish annual valuation via `esop.publish_valuation` (Founder/CEO + Board dual-sign): `value_per_sp_vnd = (cfo × industry_multiplier) / outstanding_sp`. If `cfo ≤ 0`, emit valuation with `applied_floor=true` and copy prior year's value (Article 5a).

<!-- source: SRS FR-ESOP-005 · module ESOP · phase P2 · moscow MUST -->
