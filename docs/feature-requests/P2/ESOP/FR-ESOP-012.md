---
title: "Materialize current vesting position + balance via materialized view…"
author: "@cyberos-bot"
department: "hr"
status: "draft"
priority: "p0"
...
materialize current vesting position + balance via materialized view refreshed hourly + on event; nightly reconciliation compares MV to event-log reconstruction; alert on drift.

<!-- source: SRS FR-ESOP-012 · module ESOP · phase P2 · moscow MUST -->
