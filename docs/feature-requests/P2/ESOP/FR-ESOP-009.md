---
title: "Enforce termination settlement (consumes `member.terminated` from HR)"
author: "@cyberos-bot"
department: "hr"
status: "draft"
priority: "p0"
...
enforce termination settlement (consumes `member.terminated` from HR):

<!-- source: SRS FR-ESOP-009 · module ESOP · phase P2 · moscow MUST -->
