---
title: "Enforce pool size cap: refresh grants pre-validated `total_outstandin…"
author: "@cyberos-bot"
department: "hr"
status: "draft"
priority: "p0"
...
enforce pool size cap: refresh grants pre-validated `total_outstanding_sp + new_qty ≤ 0.15 × total_actual_shares`; over-cap rejected.

<!-- source: SRS FR-ESOP-006 · module ESOP · phase P2 · moscow MUST -->
