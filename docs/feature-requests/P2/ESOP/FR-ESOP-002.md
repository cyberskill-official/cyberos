---
title: "Issue SP grant by `esop.issue_grant`"
author: "@cyberos-bot"
department: "hr"
status: "draft"
priority: "p0"
...
issue SP grant by `esop.issue_grant`; restricted to `{owner, board}`.

<!-- source: SRS FR-ESOP-002 · module ESOP · phase P2 · moscow MUST -->
