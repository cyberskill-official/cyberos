---
title: "Redact SP balances + valuations from AI Gateway prompts unless on the…"
author: "@cyberos-bot"
department: "hr"
status: "draft"
priority: "p0"
...
redact SP balances + valuations from AI Gateway prompts unless on the explicit `esop.simulate_explain` PII-safe route.

<!-- source: SRS FR-ESOP-013 · module ESOP · phase P2 · moscow MUST -->
