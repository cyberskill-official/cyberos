---
title: "Maintain Merkle chain on `sp_event`: `audit_hash = sha256(prev_event_…"
author: "@cyberos-bot"
department: "hr"
status: "draft"
priority: "p0"
...
maintain Merkle chain on `sp_event`: `audit_hash = sha256(prev_event_audit_hash || canonical_json(payload))` per grant.

<!-- source: SRS FR-ESOP-011 · module ESOP · phase P2 · moscow MUST -->
