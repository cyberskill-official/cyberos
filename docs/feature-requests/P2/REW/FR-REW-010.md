---
title: "Implement Management Risk Shield: on `proj.client_bad_debt` event, pa…"
author: "@cyberos-bot"
department: "hr"
status: "draft"
priority: "p0"
...
implement Management Risk Shield: on `proj.client_bad_debt` event, pay 50% of Holdback from internal Risk Reserve Fund; emit `rew.risk_shield_paid` audit event.

<!-- source: SRS FR-REW-010 · module REW · phase P2 · moscow MUST -->
