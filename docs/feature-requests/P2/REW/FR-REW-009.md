---
title: "Compute Project Bonus Pool: `pool = 0.05 × (project_revenue − direct_…"
author: "@cyberos-bot"
department: "hr"
status: "draft"
priority: "p0"
...
compute Project Bonus Pool: `pool = 0.05 × (project_revenue − direct_engineering_salary − cloud_cost)`. Allocation real-time by VP. Disbursed 70% on `proj.uat_signed_off` + 30% Holdback at end of `warranty_period`.

<!-- source: SRS FR-REW-009 · module REW · phase P2 · moscow MUST -->
