---
title: "Run quarterly bias testing on VP scoring + peer-review (demographic p…"
author: "@cyberos-bot"
department: "hr"
status: "draft"
priority: "p0"
...
run quarterly bias testing on VP scoring + peer-review (demographic parity, equalized odds, 4/5ths rule) per Fairlearn / Aequitas / AIF360.

<!-- source: SRS FR-LEARN-014 · module LEARN · phase P2 · moscow MUST -->
