...
source_decisions:
  - DEC-1900 2026-05-17 — 3 visibility tiers: public (unauth OK), org_only (any tenant member), role_restricted (specific roles via FR-AUTH-101)
