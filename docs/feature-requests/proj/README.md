...
| [FR-PROJ-002](FR-PROJ-002-brain-decision-anchoring.md) | MUST | 1 | 7 | BRAIN-anchored proj.decision row per Issue state change — reason + prior_chain link + cross-module r |
...
| [FR-PROJ-008](FR-PROJ-008-brain-audit-row-per-mutation.md) | MUST | 2 | 5 | BRAIN audit row per issue mutation — chained to PROJ history_event table with field-level diff and c |
| [FR-PROJ-009](FR-PROJ-009-brain-link-schema.md) | MUST | 2 | 5 | BRAIN_LINK schema — Issue ↔ BRAIN memory linkage (cites | implements | supersedes) with bidirectiona |
| [FR-PROJ-010](FR-PROJ-010-citation-drift-detector.md) | SHOULD | 3 | 4 | Citation drift detector — nightly sweep flags stale BRAIN_LINKs (deleted target, superseded chain, b |
...
- **BRAIN**: FR-PROJ-008→FR-BRAIN-101
