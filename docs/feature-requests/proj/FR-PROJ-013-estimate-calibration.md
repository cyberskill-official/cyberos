...
2. **MUST** schedule a nightly cron at 03:00 local time (after FR-PROJ-010 drift sweep).
...
- The UI hint in §1 #8 lives in FR-PROJ-001's issue create form: when assignee + task_class chosen, fetches latest snapshot and displays "recommended × <multiplier>".
