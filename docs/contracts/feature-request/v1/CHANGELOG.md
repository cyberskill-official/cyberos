# CHANGELOG — `cyberos/docs/contracts/feature-request/v1/`
...
- Moved from `cyberos/docs/skills/cuo/_shared/feature-request-template/` to `cyberos/docs/contracts/feature-request/v1/` per registry v0.2.0 + DEC-090. Body of `template.md` is byte-identical to v1.0.0.
...
- Body of `template.md` is byte-identical → existing consumers (`cuo/cpo/fr-create` v0.1.0, `cuo/cpo/fr-audit` v0.1.0) continue to validate against `feature_request@1`.
