# ANTI_FABRICATION.md — rules for srs-audit

Anti-fabrication discipline for the `srs-audit` skill. The skill MUST ask
...
Run `cyberos skill-quality calibration srs-audit` to see current
