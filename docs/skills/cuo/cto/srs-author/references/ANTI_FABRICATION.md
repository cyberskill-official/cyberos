# ANTI_FABRICATION.md — rules for srs-author

Anti-fabrication discipline for the `srs-author` skill. The skill MUST ask
...
Run `cyberos skill-quality calibration srs-author` to see current
