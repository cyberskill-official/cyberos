# ANTI_FABRICATION.md — rules for spec-to-impl-plan

Anti-fabrication discipline for the `spec-to-impl-plan` skill. The skill MUST ask
...
Run `cyberos skill-quality calibration spec-to-impl-plan` to see current
