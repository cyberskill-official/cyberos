# ANTI_FABRICATION.md — rules for prd-audit

Anti-fabrication discipline for the `prd-audit` skill. The skill MUST ask
...
Run `cyberos skill-quality calibration prd-audit` to see current
