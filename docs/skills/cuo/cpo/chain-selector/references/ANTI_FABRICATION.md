# ANTI_FABRICATION.md — rules for chain-selector

Anti-fabrication discipline for the `chain-selector` skill. The skill MUST ask
...
Run `cyberos skill-quality calibration chain-selector` to see current
