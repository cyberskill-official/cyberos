# ANTI_FABRICATION.md — rules for prd-author

Anti-fabrication discipline for the `prd-author` skill. The skill MUST ask
...
Run `cyberos skill-quality calibration prd-author` to see current
