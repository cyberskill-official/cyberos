...
```
CONTRACT_DRIFT
this_skill:                   cuo/cpo/fr-author
this_skill_version:           0.1.0
this_prompt_revision:         fr_author@2.0.0
manifest_skill_revision:      <observed value from manifest.skill_revisions.fr_author>
...
remediation: Either re-run with a skill version matching the manifest, OR
             ...
             before advancing).
             The template (loaded from cyberos/docs/contracts/feature-request/
