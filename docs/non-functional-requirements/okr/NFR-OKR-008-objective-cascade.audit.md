...
NFR-OKR-008 ("OKR objective cascade integrity — child objectives MUST chain to parent at all times") passes the nfr-spec@1 rubric on first author. The doc has:
