...
NFR-OKR-007 ("OKR retro-approval gate — quarterly retro MUST be CEO-signed before closing") passes the nfr-spec@1 rubric on first author. The doc has:
