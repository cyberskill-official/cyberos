...
owner: CHRO
created: 2026-05-18
related_frs: [FR-OKR-006]
---

## §1 — Statement (BCP-14 normative)

1. The Monday OKR digest (`FR-OKR-006`) **MUST** be delivered only to currently-active members; terminated members **MUST** be removed within 24h of HR transition.
