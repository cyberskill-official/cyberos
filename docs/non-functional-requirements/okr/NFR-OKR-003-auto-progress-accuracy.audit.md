...
NFR-OKR-003 ("OKR auto-progress accuracy — batch-computed progress MUST match per-KR sample within ±2%") passes the nfr-spec@1 rubric on first author. The doc has:
