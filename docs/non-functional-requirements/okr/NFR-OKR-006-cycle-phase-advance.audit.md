...
NFR-OKR-006 ("OKR cycle-phase advance correctness — cycle phases MUST advance per declared schedule") passes the nfr-spec@1 rubric on first author. The doc has:
