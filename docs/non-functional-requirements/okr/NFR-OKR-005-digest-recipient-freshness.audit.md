...
NFR-OKR-005 ("OKR digest-recipient freshness — Monday digest list MUST match current tenant roster") passes the nfr-spec@1 rubric on first author. The doc has:
