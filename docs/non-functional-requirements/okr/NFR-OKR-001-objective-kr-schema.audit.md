...
NFR-OKR-001 ("OKR objective-KR schema invariants — KR types closed enum; numeric KRs measurable") passes the nfr-spec@1 rubric on first author. The doc has:
