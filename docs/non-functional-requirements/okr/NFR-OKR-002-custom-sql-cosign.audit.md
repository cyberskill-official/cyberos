...
NFR-OKR-002 ("OKR custom-SQL co-sign — custom-SQL KRs MUST require CTO + objective-owner co-sign") passes the nfr-spec@1 rubric on first author. The doc has:
