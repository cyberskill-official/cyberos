...
NFR-RES-005 ("RES weekly digest freshness — Monday digest MUST include data through Sunday EOD") passes the nfr-spec@1 rubric on first author. The doc has:
