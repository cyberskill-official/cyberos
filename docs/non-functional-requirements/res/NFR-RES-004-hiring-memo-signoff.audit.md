...
NFR-RES-004 ("RES hiring-memo signoff — CUO-generated memo MUST have hiring-manager + CHRO co-sign") passes the nfr-spec@1 rubric on first author. The doc has:
