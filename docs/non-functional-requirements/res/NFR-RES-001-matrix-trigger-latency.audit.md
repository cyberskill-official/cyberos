...
NFR-RES-001 ("RES matrix-trigger latency — over/under flags MUST surface within 1h of capacity change") passes the nfr-spec@1 rubric on first author. The doc has:
