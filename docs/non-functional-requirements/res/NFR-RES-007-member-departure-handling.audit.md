...
NFR-RES-007 ("RES member-departure handling — terminated members MUST be removed from active allocations within 24h") passes the nfr-spec@1 rubric on first author. The doc has:
