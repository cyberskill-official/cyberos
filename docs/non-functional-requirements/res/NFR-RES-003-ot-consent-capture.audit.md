...
NFR-RES-003 ("RES OT consent capture — VN overtime MUST require + persist worker consent") passes the nfr-spec@1 rubric on first author. The doc has:
