...
NFR-RES-006 ("RES capacity-flag accuracy — flag MUST match human-confirmed over/under state ≥ 95% of time") passes the nfr-spec@1 rubric on first author. The doc has:
