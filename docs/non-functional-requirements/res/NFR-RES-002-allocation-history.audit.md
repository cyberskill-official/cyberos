...
NFR-RES-002 ("RES allocation-change history — every allocation mutation MUST emit an audit row") passes the nfr-spec@1 rubric on first author. The doc has:
