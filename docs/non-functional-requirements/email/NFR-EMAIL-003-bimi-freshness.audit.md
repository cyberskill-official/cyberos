...
NFR-EMAIL-003 ("EMAIL BIMI freshness — VMC + BIMI record MUST stay valid; auto-alert on expiry") passes the nfr-spec@1 rubric on first author. The doc has:
