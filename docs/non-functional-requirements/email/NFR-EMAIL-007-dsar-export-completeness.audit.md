...
NFR-EMAIL-007 ("EMAIL DSAR export completeness — export MUST contain all subject's messages + metadata") passes the nfr-spec@1 rubric on first author. The doc has:
