...
NFR-EMAIL-004 ("EMAIL DKIM/SPF/DMARC pass-through — outbound mail MUST be DMARC-aligned") passes the nfr-spec@1 rubric on first author. The doc has:
