...
NFR-EMAIL-002 ("EMAIL CaMeL prompt-injection blocking — recall ≥ 95% on the held-out adversarial set") passes the nfr-spec@1 rubric on first author. The doc has:
