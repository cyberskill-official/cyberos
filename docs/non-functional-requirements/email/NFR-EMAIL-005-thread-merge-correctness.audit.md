...
NFR-EMAIL-005 ("EMAIL thread merge correctness — In-Reply-To + References MUST group messages correctly") passes the nfr-spec@1 rubric on first author. The doc has:
