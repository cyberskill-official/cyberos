...
NFR-EMAIL-006 ("EMAIL dual-LLM separation — quarantined LLM MUST NOT see untrusted content + tool surface") passes the nfr-spec@1 rubric on first author. The doc has:
