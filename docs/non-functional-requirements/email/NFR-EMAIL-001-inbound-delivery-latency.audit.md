...
NFR-EMAIL-001 ("EMAIL inbound delivery latency — SMTP receipt to inbox visible < 30s p95") passes the nfr-spec@1 rubric on first author. The doc has:
