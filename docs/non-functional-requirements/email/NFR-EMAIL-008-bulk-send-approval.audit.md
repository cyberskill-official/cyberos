...
NFR-EMAIL-008 ("EMAIL bulk-send approval — sends > 100 recipients MUST require explicit approval") passes the nfr-spec@1 rubric on first author. The doc has:
