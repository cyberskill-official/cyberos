...
NFR-TEN-002 ("TEN four-residency pinning — tenant data MUST stay in pinned region; 0 cross-region writes") passes the nfr-spec@1 rubric on first author. The doc has:
