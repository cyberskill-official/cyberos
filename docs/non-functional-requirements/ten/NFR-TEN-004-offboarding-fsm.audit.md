...
NFR-TEN-004 ("TEN 90-day offboarding FSM — termination MUST advance through declared states") passes the nfr-spec@1 rubric on first author. The doc has:
