...
NFR-TEN-001 ("TEN provisioning saga reliability — every tenant create MUST be transactional") passes the nfr-spec@1 rubric on first author. The doc has:
