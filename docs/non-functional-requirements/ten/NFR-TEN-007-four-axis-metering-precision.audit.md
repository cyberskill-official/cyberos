...
NFR-TEN-007 ("TEN four-axis metering precision — users/storage/AI/seats measured within ±0.1%") passes the nfr-spec@1 rubric on first author. The doc has:
