...
NFR-TEN-005 ("TEN signed bundle determinism — same tenant export MUST produce same hash") passes the nfr-spec@1 rubric on first author. The doc has:
