...
NFR-TEN-006 ("TEN hostile-override approval window — emergency termination requires CEO + CLO co-sign") passes the nfr-spec@1 rubric on first author. The doc has:
