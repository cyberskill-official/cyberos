...
NFR-TEN-009 ("TEN VND domestic rail uptime — VND-billing path MUST maintain 99.5% monthly availability") passes the nfr-spec@1 rubric on first author. The doc has:
