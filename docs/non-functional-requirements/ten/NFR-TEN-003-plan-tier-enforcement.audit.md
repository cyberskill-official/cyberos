...
NFR-TEN-003 ("TEN plan-tier enforcement — over-quota operations MUST be blocked or queued") passes the nfr-spec@1 rubric on first author. The doc has:
