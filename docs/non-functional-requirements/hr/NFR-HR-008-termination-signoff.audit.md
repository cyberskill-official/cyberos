...
NFR-HR-008 ("HR termination signoff window — termination MUST be signed by CHRO + line manager within 72h") passes the nfr-spec@1 rubric on first author. The doc has:
