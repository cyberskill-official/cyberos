...
NFR-HR-007 ("HR onboarding saga durability — every step MUST be replayable; crashes recoverable") passes the nfr-spec@1 rubric on first author. The doc has:
