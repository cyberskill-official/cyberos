...
NFR-HR-001 ("HR member schema invariants — required fields + closed enum types + unique member_id") passes the nfr-spec@1 rubric on first author. The doc has:
