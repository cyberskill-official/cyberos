...
NFR-HR-006 ("HR accrual-correction audit — every manual leave adjustment MUST require reason + approver") passes the nfr-spec@1 rubric on first author. The doc has:
