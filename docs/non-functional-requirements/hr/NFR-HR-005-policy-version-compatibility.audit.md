...
NFR-HR-005 ("HR policy-version compatibility — policy changes MUST be backward-compatible for in-flight cases") passes the nfr-spec@1 rubric on first author. The doc has:
