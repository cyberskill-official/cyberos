...
NFR-HR-003 ("HR CCCD-photo access logging — every read MUST be logged with reason; sev-1 on bypass") passes the nfr-spec@1 rubric on first author. The doc has:
