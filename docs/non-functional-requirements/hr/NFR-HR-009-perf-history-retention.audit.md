...
NFR-HR-009 ("HR performance history retention — performance signals MUST be retained ≥ 7 years") passes the nfr-spec@1 rubric on first author. The doc has:
