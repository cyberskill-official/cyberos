...
NFR-HR-002 ("HR contract-history immutability — contract changes MUST create new versions, never edit old") passes the nfr-spec@1 rubric on first author. The doc has:
