...
NFR-CUO-005 ("CUO persona-version stamping — every chain MUST record persona+workflow version") passes the nfr-spec@1 rubric on first author. The doc has:
