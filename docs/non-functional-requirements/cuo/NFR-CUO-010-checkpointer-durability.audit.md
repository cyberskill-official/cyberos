...
NFR-CUO-010 ("CUO LangGraph Postgres checkpointer durability — checkpoint writes MUST be fsync'd") passes the nfr-spec@1 rubric on first author. The doc has:
