...
NFR-CUO-006 ("CUO workflow-pattern parsing — YAML safe-load + closed enum + clean error reporting") passes the nfr-spec@1 rubric on first author. The doc has:
