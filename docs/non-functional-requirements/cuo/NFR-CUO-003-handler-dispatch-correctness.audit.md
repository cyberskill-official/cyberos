...
NFR-CUO-003 ("CUO handler dispatch correctness — workflow pattern maps to single handler") passes the nfr-spec@1 rubric on first author. The doc has:
