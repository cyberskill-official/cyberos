...
NFR-CUO-007 ("CUO replay safety — replayed chain MUST produce same audit row count + order") passes the nfr-spec@1 rubric on first author. The doc has:
