...
NFR-CUO-008 ("CUO route decision latency — natural-language → persona+workflow < 1.5s") passes the nfr-spec@1 rubric on first author. The doc has:
