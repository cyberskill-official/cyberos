...
NFR-CUO-002 ("CUO memory audit-chain emission — every chain execution MUST emit ≥ 2 rows") passes the nfr-spec@1 rubric on first author. The doc has:
