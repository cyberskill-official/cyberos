...
NFR-CUO-009 ("CUO per-step rollback — failed step MUST trigger declared compensations in reverse order") passes the nfr-spec@1 rubric on first author. The doc has:
