...
NFR-CUO-004 ("CUO LLM invoker fallback ladder — MockInvoker → SubprocessInvoker → LLMInvoker") passes the nfr-spec@1 rubric on first author. The doc has:
