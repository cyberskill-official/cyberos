...
NFR-DOC-005 ("DOC IDV method coverage — all 4 declared methods MUST be reachable per tenant") passes the nfr-spec@1 rubric on first author. The doc has:
