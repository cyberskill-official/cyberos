...
NFR-DOC-001 ("DOC eIDAS QTSP attestation — signatures MUST be QES-grade for EU jurisdiction docs") passes the nfr-spec@1 rubric on first author. The doc has:
