...
NFR-DOC-004 ("DOC VNeID linkage — identity-verified signers MUST be bound to VNeID identifier") passes the nfr-spec@1 rubric on first author. The doc has:
