...
NFR-DOC-003 ("DOC VN-CA signature compliance — Vietnamese signatures MUST chain to NEAC root") passes the nfr-spec@1 rubric on first author. The doc has:
