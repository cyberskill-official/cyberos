...
NFR-DOC-008 ("DOC signing workflow integrity — multi-party sign MUST complete in declared order") passes the nfr-spec@1 rubric on first author. The doc has:
