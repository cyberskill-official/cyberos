...
NFR-DOC-006 ("DOC expiry alert latency — alerts MUST fire at 90/30/7/1 day(s) before document expiry") passes the nfr-spec@1 rubric on first author. The doc has:
