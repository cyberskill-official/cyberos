...
NFR-DOC-009 ("DOC third-party import validation — imported signed docs MUST be signature-verified") passes the nfr-spec@1 rubric on first author. The doc has:
