...
NFR-MCP-004 ("MCP task primitive lifecycle — task state transitions MUST be linear + auditable") passes the nfr-spec@1 rubric on first author. The doc has:
