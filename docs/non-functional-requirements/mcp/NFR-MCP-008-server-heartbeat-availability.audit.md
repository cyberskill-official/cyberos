...
NFR-MCP-008 ("MCP server heartbeat availability — registered servers MUST respond within 2s") passes the nfr-spec@1 rubric on first author. The doc has:
