...
NFR-MCP-007 ("MCP OAuth PKCE — authorization code flow MUST require PKCE; no implicit grant") passes the nfr-spec@1 rubric on first author. The doc has:
