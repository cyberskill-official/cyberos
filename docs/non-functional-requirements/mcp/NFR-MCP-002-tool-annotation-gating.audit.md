...
NFR-MCP-002 ("MCP tool annotation gating — destructive ops require explicit human approval annotation") passes the nfr-spec@1 rubric on first author. The doc has:
