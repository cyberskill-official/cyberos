...
NFR-MCP-005 ("MCP elicitation prompt safety — server-issued prompts MUST be scoped + escapable") passes the nfr-spec@1 rubric on first author. The doc has:
