...
NFR-MCP-003 ("MCP audience-bound tokens — OAuth tokens MUST be aud-scoped to the MCP server") passes the nfr-spec@1 rubric on first author. The doc has:
