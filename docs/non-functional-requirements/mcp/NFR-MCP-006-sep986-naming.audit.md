...
NFR-MCP-006 ("MCP SEP-986 naming compliance — all server/tool identifiers MUST match SEP-986 regex") passes the nfr-spec@1 rubric on first author. The doc has:
