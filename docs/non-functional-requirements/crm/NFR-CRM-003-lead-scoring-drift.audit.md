...
NFR-CRM-003 ("CRM lead-scoring drift — score model MUST be re-evaluated quarterly against actual outcomes") passes the nfr-spec@1 rubric on first author. The doc has:
