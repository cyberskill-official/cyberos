...
NFR-CRM-006 ("CRM bank-config audit — account banking changes MUST emit signed audit row") passes the nfr-spec@1 rubric on first author. The doc has:
