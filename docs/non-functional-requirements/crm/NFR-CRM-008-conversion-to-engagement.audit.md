...
NFR-CRM-008 ("CRM conversion-to-engagement integrity — closed deal MUST link to a PROJ engagement") passes the nfr-spec@1 rubric on first author. The doc has:
