...
NFR-CRM-005 ("CRM MST validation freshness — VN business accounts MUST have MST validated within 90 days") passes the nfr-spec@1 rubric on first author. The doc has:
