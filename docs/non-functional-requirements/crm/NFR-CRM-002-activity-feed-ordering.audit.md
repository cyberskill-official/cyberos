...
NFR-CRM-002 ("CRM activity-feed ordering — feed MUST be strictly chronologically consistent") passes the nfr-spec@1 rubric on first author. The doc has:
