...
NFR-CRM-001 ("CRM account-contact-deal schema invariants — required fields + closed enum + relational integrity") passes the nfr-spec@1 rubric on first author. The doc has:
