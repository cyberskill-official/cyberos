...
NFR-CRM-004 ("CRM win-loss approval — deals > threshold MUST be approved by CFO before close") passes the nfr-spec@1 rubric on first author. The doc has:
