...
NFR-REW-003 ("REW bonus-pool conservation — pool inflow MUST equal sum of distributions + carry-over") passes the nfr-spec@1 rubric on first author. The doc has:
