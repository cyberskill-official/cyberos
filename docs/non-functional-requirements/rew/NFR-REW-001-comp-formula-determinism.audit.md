...
NFR-REW-001 ("REW comp-formula determinism — same inputs MUST produce same payroll output across reruns") passes the nfr-spec@1 rubric on first author. The doc has:
