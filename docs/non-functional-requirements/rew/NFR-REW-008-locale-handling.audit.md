...
NFR-REW-008 ("REW locale handling — payslip currency + tax tables MUST match member residency") passes the nfr-spec@1 rubric on first author. The doc has:
