...
NFR-REW-006 ("REW gross/net reconciliation — gross - deductions MUST equal net for every payslip") passes the nfr-spec@1 rubric on first author. The doc has:
