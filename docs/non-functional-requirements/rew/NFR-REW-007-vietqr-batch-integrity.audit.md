...
NFR-REW-007 ("REW VietQR payroll batch integrity — batch hash MUST match sum of payslip nets") passes the nfr-spec@1 rubric on first author. The doc has:
