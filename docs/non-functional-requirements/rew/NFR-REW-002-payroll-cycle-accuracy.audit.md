...
NFR-REW-002 ("REW payroll-cycle accuracy — monthly run MUST close within +/- 1 VND vs hand-verified sample") passes the nfr-spec@1 rubric on first author. The doc has:
