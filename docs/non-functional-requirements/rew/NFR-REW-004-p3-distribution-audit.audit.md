...
NFR-REW-004 ("REW P3 distribution audit — quarterly distribution MUST have CFO+CHRO co-sign before execution") passes the nfr-spec@1 rubric on first author. The doc has:
