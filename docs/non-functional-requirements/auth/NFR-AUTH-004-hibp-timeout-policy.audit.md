...
NFR-AUTH-004 ("AUTH HIBP API timeout policy — 2s hard timeout; fail-open with audit row on timeout") passes the nfr-spec@1 rubric on first author. The doc has:
