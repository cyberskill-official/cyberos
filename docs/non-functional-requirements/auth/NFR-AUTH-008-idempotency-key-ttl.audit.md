...
NFR-AUTH-008 ("AUTH Idempotency-Key TTL — 24-hour replay window; hourly cleanup sweeper") passes the nfr-spec@1 rubric on first author. The doc has:
