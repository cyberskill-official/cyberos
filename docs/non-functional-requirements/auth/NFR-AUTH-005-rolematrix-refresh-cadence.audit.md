...
NFR-AUTH-005 ("AUTH RoleMatrix refresh cadence — ≤ 60s revocation latency; alert on 3 consecutive failures") passes the nfr-spec@1 rubric on first author. The doc has:
