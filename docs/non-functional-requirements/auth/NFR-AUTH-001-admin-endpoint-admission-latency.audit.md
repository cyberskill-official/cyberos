...
NFR-AUTH-001 ("AUTH admin endpoint admission latency — verify_jwt + RBAC check < 50ms p95") passes the nfr-spec@1 rubric on first author. The doc has:
