...
NFR-AUTH-002 ("AUTH RLS cross-tenant leak — zero rows leaked under property test sweep of 1k random tenants") passes the nfr-spec@1 rubric on first author. The doc has:
