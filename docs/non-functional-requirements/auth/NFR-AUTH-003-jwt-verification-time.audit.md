...
NFR-AUTH-003 ("AUTH JWT signature verification time — < 1ms p99 single key; < 5ms p99 with 7-day rotation window") passes the nfr-spec@1 rubric on first author. The doc has:
