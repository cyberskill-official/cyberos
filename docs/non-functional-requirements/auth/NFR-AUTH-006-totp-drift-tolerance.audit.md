...
NFR-AUTH-006 ("AUTH TOTP drift tolerance — accept ±1 step; reject ±2; rate-limit retries") passes the nfr-spec@1 rubric on first author. The doc has:
