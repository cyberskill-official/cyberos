...
NFR-AUTH-007 ("AUTH signing-key rotation — active key always present; old key honored 7 days post-rotation") passes the nfr-spec@1 rubric on first author. The doc has:
