...
NFR-AUTH-010 ("AUTH OIDC state-token TTL — 10-minute hard expiry; CSRF-resistant; one-shot") passes the nfr-spec@1 rubric on first author. The doc has:
