...
NFR-CHAT-002 ("CHAT WebSocket fanout latency — p95 < 200ms from persist to all subscribed clients") passes the nfr-spec@1 rubric on first author. The doc has:
