...
NFR-CHAT-006 ("CHAT DSAR message export completeness — every message subject authored OR received + chain proof") passes the nfr-spec@1 rubric on first author. The doc has:
