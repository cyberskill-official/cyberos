...
NFR-CHAT-003 ("CHAT memory bridge replication lag — p95 < 2s from chat message to memory put") passes the nfr-spec@1 rubric on first author. The doc has:
