...
NFR-CHAT-005 ("CHAT VN-search recall floor — hybrid lexical + diacritic-folded recall@10 ≥ 0.90") passes the nfr-spec@1 rubric on first author. The doc has:
