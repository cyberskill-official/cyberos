...
NFR-CHAT-004 ("CHAT Mattermost fork upstream-merge cadence — monthly minor rebase; quarterly major") passes the nfr-spec@1 rubric on first author. The doc has:
