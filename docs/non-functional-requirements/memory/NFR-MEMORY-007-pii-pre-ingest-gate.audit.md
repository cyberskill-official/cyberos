...
NFR-MEMORY-007 ("memory PII pre-ingest gate — Presidio + VN-PII recall ≥ 99% before row hits Layer 2") passes the nfr-spec@1 rubric on first author. The doc has:
...
*End of NFR-MEMORY-007.audit.md.*
