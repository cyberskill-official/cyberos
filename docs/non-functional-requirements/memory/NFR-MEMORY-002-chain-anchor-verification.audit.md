...
NFR-MEMORY-002 ("memory chain-anchor verification — every l2_memory read re-checks anchor; mismatch → quarantine") passes the nfr-spec@1 rubric on first author. The doc has:
...
*End of NFR-MEMORY-002.audit.md.*
