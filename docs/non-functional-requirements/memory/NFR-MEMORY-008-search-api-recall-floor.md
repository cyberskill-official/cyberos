---
id: NFR-MEMORY-008
title: "memory search API recall floor — lexical hybrid recall@10 ≥ 0.85 on test corpus"
module: memory
...
- Recall test `services/memory/tests/search_recall_test.rs` (T) — runs the corpus; asserts thresholds.
