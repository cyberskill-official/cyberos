...
NFR-MEMORY-006 ("memory STH publication frequency — consolidate every 24h or 100MB whichever first") passes the nfr-spec@1 rubric on first author. The doc has:
...
*End of NFR-MEMORY-006.audit.md.*
