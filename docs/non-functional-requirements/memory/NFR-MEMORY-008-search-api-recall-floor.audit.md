...
NFR-MEMORY-008 ("memory search API recall floor — lexical hybrid recall@10 ≥ 0.85 on test corpus") passes the nfr-spec@1 rubric on first author. The doc has:
...
*End of NFR-MEMORY-008.audit.md.*
