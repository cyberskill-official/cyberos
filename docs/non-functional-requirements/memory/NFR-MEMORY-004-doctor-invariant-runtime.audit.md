...
NFR-MEMORY-004 ("memory doctor invariant runtime — full invariant pass < 30s on 100k-row store") passes the nfr-spec@1 rubric on first author. The doc has:
...
*End of NFR-MEMORY-004.audit.md.*
