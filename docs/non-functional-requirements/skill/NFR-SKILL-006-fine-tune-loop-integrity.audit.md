...
NFR-SKILL-006 ("SKILL fine-tune loop integrity — author+audit pair MUST stay in lockstep") passes the nfr-spec@1 rubric on first author. The doc has:
