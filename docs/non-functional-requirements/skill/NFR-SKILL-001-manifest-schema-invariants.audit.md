...
NFR-SKILL-001 ("SKILL manifest schema invariants — required-field gate + semver discipline") passes the nfr-spec@1 rubric on first author. The doc has:
