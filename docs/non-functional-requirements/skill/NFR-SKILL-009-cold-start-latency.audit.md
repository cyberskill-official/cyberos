...
NFR-SKILL-009 ("SKILL cold-start latency — bundle pull + manifest parse + capability admit < 2s") passes the nfr-spec@1 rubric on first author. The doc has:
