...
NFR-SKILL-005 ("SKILL VN-bundle compliance — MST/VietQR/HoaDon skills MUST pass external validator") passes the nfr-spec@1 rubric on first author. The doc has:
