...
NFR-SKILL-007 ("SKILL deterministic-output mode — fixed seed produces byte-identical output") passes the nfr-spec@1 rubric on first author. The doc has:
