...
NFR-SKILL-010 ("SKILL output contract conformance — produced output MUST match declared schema") passes the nfr-spec@1 rubric on first author. The doc has:
