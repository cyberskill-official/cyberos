...
NFR-SKILL-008 ("SKILL sandbox isolation — skill execution MUST NOT escape declared capabilities") passes the nfr-spec@1 rubric on first author. The doc has:
