...
NFR-BRAIN-007 ("BRAIN PII pre-ingest gate — Presidio + VN-PII recall ≥ 99% before row hits Layer 2") passes the nfr-spec@1 rubric on first author. The doc has:
