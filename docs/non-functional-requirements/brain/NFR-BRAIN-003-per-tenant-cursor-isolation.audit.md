...
NFR-BRAIN-003 ("BRAIN per-tenant cursor isolation — cursor advance for tenant A never affects tenant B") passes the nfr-spec@1 rubric on first author. The doc has:
