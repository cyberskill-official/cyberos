...
NFR-BRAIN-005 ("BRAIN deterministic export bit-identity — two runs on same store produce byte-identical zip") passes the nfr-spec@1 rubric on first author. The doc has:
