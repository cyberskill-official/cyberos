...
NFR-BRAIN-001 ("BRAIN Layer-2 ingest lag — p95 < 1s from Layer-1 commit to l2_memory row visible") passes the nfr-spec@1 rubric on first author. The doc has:
