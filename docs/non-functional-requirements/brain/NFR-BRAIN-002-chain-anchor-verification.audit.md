...
NFR-BRAIN-002 ("BRAIN chain-anchor verification — every l2_memory read re-checks anchor; mismatch → quarantine") passes the nfr-spec@1 rubric on first author. The doc has:
