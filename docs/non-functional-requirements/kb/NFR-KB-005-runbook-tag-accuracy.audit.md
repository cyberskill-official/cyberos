...
NFR-KB-005 ("KB runbook-tag accuracy — runbook docs MUST be findable by incident-keyword + tag combo") passes the nfr-spec@1 rubric on first author. The doc has:
