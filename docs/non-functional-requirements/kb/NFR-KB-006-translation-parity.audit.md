...
NFR-KB-006 ("KB translation parity — translated doc MUST reference + lag source by ≤ 24h") passes the nfr-spec@1 rubric on first author. The doc has:
