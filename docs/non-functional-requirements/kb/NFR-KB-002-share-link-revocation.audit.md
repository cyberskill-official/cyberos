...
NFR-KB-002 ("KB share-link revocation — revoked link MUST stop working within 60s globally") passes the nfr-spec@1 rubric on first author. The doc has:
