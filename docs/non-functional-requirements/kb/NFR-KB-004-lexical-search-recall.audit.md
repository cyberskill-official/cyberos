...
NFR-KB-004 ("KB lexical search recall — FTS5 + pgroonga MUST cover known-keyword queries at ≥ 99%") passes the nfr-spec@1 rubric on first author. The doc has:
