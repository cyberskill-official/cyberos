...
NFR-KB-001 ("KB document versioning history — every save MUST create an immutable version row") passes the nfr-spec@1 rubric on first author. The doc has:
