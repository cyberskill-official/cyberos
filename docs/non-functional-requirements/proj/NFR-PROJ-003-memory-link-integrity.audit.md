...
NFR-PROJ-003 ("PROJ memory_link integrity — every memory_link MUST resolve to a real memory row") passes the nfr-spec@1 rubric on first author. The doc has:
