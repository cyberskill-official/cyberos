...
NFR-PROJ-001 ("PROJ Yjs CRDT convergence — concurrent edits MUST converge to identical state across all clients") passes the nfr-spec@1 rubric on first author. The doc has:
