...
NFR-PROJ-004 ("PROJ cycle-window enforcement — work added mid-cycle MUST be flagged + tracked") passes the nfr-spec@1 rubric on first author. The doc has:
