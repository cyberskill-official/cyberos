...
NFR-PROJ-002 ("PROJ billable cascade correctness — rate-card change MUST propagate to all unbilled time") passes the nfr-spec@1 rubric on first author. The doc has:
