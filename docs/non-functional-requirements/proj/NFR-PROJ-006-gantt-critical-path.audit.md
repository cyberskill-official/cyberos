...
NFR-PROJ-006 ("PROJ Gantt critical path correctness — CPM algorithm MUST match reference output") passes the nfr-spec@1 rubric on first author. The doc has:
