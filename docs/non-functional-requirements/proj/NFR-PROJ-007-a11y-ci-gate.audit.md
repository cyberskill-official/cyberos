...
NFR-PROJ-007 ("PROJ a11y-ci gate — every page MUST pass axe-core with 0 critical/serious issues") passes the nfr-spec@1 rubric on first author. The doc has:
