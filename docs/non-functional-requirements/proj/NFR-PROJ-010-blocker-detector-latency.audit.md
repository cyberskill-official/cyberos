...
NFR-PROJ-010 ("PROJ blocker detector latency — blocker MUST surface within 4h of cause") passes the nfr-spec@1 rubric on first author. The doc has:
