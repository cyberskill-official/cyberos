...
NFR-PROJ-009 ("PROJ issue state machine — transitions MUST conform to the declared FSM") passes the nfr-spec@1 rubric on first author. The doc has:
