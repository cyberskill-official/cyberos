...
NFR-PROJ-008 ("PROJ design-tokens drift — UI MUST consume tokens; raw hex/px values are CI-banned") passes the nfr-spec@1 rubric on first author. The doc has:
