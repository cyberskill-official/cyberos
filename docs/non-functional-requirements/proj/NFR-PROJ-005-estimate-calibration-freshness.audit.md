...
NFR-PROJ-005 ("PROJ estimate-calibration freshness — calibration data MUST refresh weekly") passes the nfr-spec@1 rubric on first author. The doc has:
