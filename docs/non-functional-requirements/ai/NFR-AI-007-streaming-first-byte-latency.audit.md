...
NFR-AI-007 ("AI Gateway streaming first-byte latency — p95 < 2s for non-cached completions") passes the nfr-spec@1 rubric on first author. The doc has:
