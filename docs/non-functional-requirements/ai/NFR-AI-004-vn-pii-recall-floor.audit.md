...
NFR-AI-004 ("VN-PII detector recall floor — recall ≥ 99% on quarterly refresh corpus") passes the nfr-spec@1 rubric on first author. The doc has:
