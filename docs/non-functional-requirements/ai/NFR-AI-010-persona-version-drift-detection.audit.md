...
NFR-AI-010 ("AI persona-version drift detection — LangSmith cosine deviation > 0.30 triggers alert") passes the nfr-spec@1 rubric on first author. The doc has:
