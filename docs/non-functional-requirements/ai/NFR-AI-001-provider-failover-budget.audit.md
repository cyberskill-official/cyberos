...
NFR-AI-001 ("AI Gateway provider failover latency budget — p95 < 5s from primary error to secondary first chunk") passes the nfr-spec@1 rubric on first author. The doc has:
