...
NFR-AI-006 ("AI Gateway per-tenant cache cross-leak — zero cross-tenant reads under 10k random JWTs") passes the nfr-spec@1 rubric on first author. The doc has:
