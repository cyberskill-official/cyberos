...
NFR-AI-009 ("AI Gateway residency pinning enforcement — provider region matches tenant policy 100%") passes the nfr-spec@1 rubric on first author. The doc has:
