...
NFR-AI-003 ("AI Gateway circuit-breaker trip policy — 3 errors in 30s opens; recovery probe at 60s") passes the nfr-spec@1 rubric on first author. The doc has:
