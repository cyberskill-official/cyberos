...
NFR-OBS-001 ("RED metric coverage — every service emits rate/error/duration via cyberos-obs-sdk") passes the nfr-spec@1 rubric on first author. The doc has:
