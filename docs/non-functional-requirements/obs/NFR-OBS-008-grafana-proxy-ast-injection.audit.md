...
NFR-OBS-008 ("Grafana proxy AST-injection coverage — PromQL + LogQL + TraceQL all rewritten with tenant_id") passes the nfr-spec@1 rubric on first author. The doc has:
