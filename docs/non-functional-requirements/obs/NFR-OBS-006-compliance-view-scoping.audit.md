...
NFR-OBS-006 ("OBS compliance view scoping — per-tenant RLS-equivalent on Grafana proxy") passes the nfr-spec@1 rubric on first author. The doc has:
