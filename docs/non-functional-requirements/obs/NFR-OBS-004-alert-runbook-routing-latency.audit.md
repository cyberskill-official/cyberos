...
NFR-OBS-004 ("Alert-to-CUO-runbook routing latency — p95 < 30s from rule fire to runbook surface") passes the nfr-spec@1 rubric on first author. The doc has:
