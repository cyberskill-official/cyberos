...
NFR-OBS-007 ("Chain-of-custody manifest completeness — every alert carries trace_id + alertmanager_id + runbook_id") passes the nfr-spec@1 rubric on first author. The doc has:
