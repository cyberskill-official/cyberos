...
NFR-OBS-002 ("Trace continuity — W3C traceparent propagates across ≥ 2 service hops; CI test enforces") passes the nfr-spec@1 rubric on first author. The doc has:
