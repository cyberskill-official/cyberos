...
NFR-OBS-003 ("Tail-sampling efficiency — 100% errors + 10% normal; sampler CPU overhead < 2%") passes the nfr-spec@1 rubric on first author. The doc has:
