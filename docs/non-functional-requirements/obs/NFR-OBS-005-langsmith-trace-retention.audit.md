...
NFR-OBS-005 ("LangSmith AI-trace retention — 90-day window, queryable by persona_version") passes the nfr-spec@1 rubric on first author. The doc has:
