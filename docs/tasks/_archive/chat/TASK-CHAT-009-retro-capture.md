...
related_tasks: [TASK-CHAT-005, TASK-CHAT-008, TASK-MEMORY-111, TASK-MEMORY-101]
depends_on: [TASK-CHAT-008]
blocks: []
...
**Why redaction (§1 #5)?** Pre-existing channel messages may contain PII; capture should not bypass TASK-MEMORY-111.
...
- **TASK-CHAT-005** — bridge picks up the picker request.
- **TASK-CHAT-008** — @lumi mention dispatch.
- **TASK-MEMORY-111** — redaction.
- **TASK-MEMORY-101** — MemoryWriter.
...
| User's tenant has lumi_enabled=false | already blocked at TASK-CHAT-008 | no retro reachable | None |
...
| Lumi reply about capture itself contains @lumi | filtered by TASK-CHAT-008 self-skip | None | None |
