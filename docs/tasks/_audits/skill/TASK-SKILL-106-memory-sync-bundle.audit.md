...
TASK-SKILL-106 authored direct-to-10/10 (compact stub spec). ~380 lines. 8 §1 clauses (frontmatter, API, slice-3 stub return, audit emit, invoke surfaces, exit semantics, OTel, future P2 delegation). 3 §2 rationale. SKILL.md + Rust + bash CLI in §3. 8 ACs. 2 tests. 5 failure modes. 3 notes.

## §2 — Findings (all resolved)

### ISS-001 — Stub vs full impl
Could ship full sync but blocks on TASK-MEMORY-103 (P2). Resolved: §1 #3 + DEC-400 stub scaffold; reserve OCI ID.
