...
authoring_md_compliance: 2026-05-19 (per task-audit skill §3.12 — 8 canonical ISSes verified; §3.13 description-format rule is the spec's own subject so meta-compliant)
---
