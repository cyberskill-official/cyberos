...
Implementation gated by `APPROVE protocol change P21 §3.1` chat-turn — same pattern as TASK-MEMORY-115 / 117. Writer raises `ProtocolAmendmentMissingError` if §3.1 doesn't list `put_if`.

---

*End of TASK-MEMORY-118 audit.*
