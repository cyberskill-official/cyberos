...
Subject's channel join/leave history is personal data (reveals workplace activity). Resolved: §1 #14 + `channel_memberships.jsonl` sourced from TASK-CHAT-005 memory rows + AC #18.
