...
### ISS-007 — Error envelope was open-set (strict-redo pass, task-audit skill §3.10 rule 30 + rule 27)
...
### ISS-008 — JIT was race-prone under concurrent first-login (strict-redo pass, TASK-AI-009-style "MUST emit once" pattern)
...
### ISS-010 — Username sanitisation undefined for non-Latin emails (strict-redo pass, task-audit skill §3.10 rule 30)
...
### ISS-013 — No traceparent propagation contract (strict-redo pass, task-audit skill §3.7 rule 22)
