...
§1 #18 + DEC-930 specify vn-1 physically lives in ap-southeast-1 with PDPL §17 contract-residency clause. But the CUSTOMER-facing disclosure isn't anywhere in this FR — that's a TEN-101 signup-flow surface. Resolved: §11.19 explicit cross-reference to `services/ten/web/signup/consents/vi/pdpl-vn-residency-disclosure-v1.md` consent template; TASK-TEN-101's audit confirms this is presented for VN-residency tenants. AC #12 verifies the Terraform region tag.
