...
Implementation-ready. Estimated effort: ~1.5 days for proposal_applier.py + version_bump.py + classifier + 3 CLI subcommands + tests. Depends on TASK-CUO-201 (proposals must exist + be enumerated through the same docs/proposals/ tree).

**Score = 10/10.**

*End of TASK-CUO-202 audit.*
