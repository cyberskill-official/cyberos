...
First-pass let claim mapping reference any role. Resolved: §1 #10 + `parse_config` validates against TASK-AUTH-101 closed enum; unknown role → 400 at config save.
