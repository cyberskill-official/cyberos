...
TASK-AI-018 was expanded from 180 lines to ~990 lines matching TASK-AI-014 / TASK-AI-017 depth.
...
### ISS-003 — 5 regression scenarios mentioned in subtasks but not enumerated

- **severity:** error
- **rule_id:** spec-completeness / promise-vs-implementation
- **location:** subtasks (claim "5 hardcoded scenarios"), §1/§5/§6 (no scenario list)
- **status:** resolved

#### Description

First-pass had `subtasks: "0.5h: Regression-test data (5 hardcoded scenarios known to have leaked before)"` and §5 showed only ONE example (`regression_scenario_001_underscore_collision`). The other four were left as `// ... 4 more regression scenarios`.
...
*End of TASK-AI-018 audit (final). Status: PASS at 10/10.*
