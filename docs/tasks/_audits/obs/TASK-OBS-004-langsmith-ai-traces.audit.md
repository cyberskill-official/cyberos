...
First-pass mentioned `langsmith_export: bool` policy field but no audit row when toggled. Privacy decision should be auditable. Resolved: §1 #3 enabled-via-TASK-AI-021 CLI emits `obs.langsmith_export_enabled` memory row; AC #16.
