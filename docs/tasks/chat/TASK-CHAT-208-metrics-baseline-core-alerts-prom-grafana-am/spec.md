---
id: TASK-CHAT-208
title: "Metrics baseline + core alerts (Prom/Grafana/AM)"
...
verify: N
---
# TASK-CHAT-208: Metrics baseline + core alerts (Prom/Grafana/AM)

## 1. Description

Author the normative clauses when this task is picked up; it was migrated as a draft stub.

Migrated 2026-07-08 from the chat improvement backlog, folded into the task system as `class: improvement`. Source report refs: C69.
