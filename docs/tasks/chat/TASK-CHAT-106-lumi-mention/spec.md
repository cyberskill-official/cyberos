...
# TASK-CHAT-106: @lumi assistant participant in channels

TASK-CHAT-008 (archived) holds the intent; builds on the ai-gateway path shipped for summarize/replies.
