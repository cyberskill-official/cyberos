---
id: TASK-CHAT-205
title: "Edit-history revisions table"
...
---
# TASK-CHAT-205: Edit-history revisions table

## 1. Description

Author the normative clauses when this task is picked up; it was migrated as a draft stub.

Migrated 2026-07-08 from the chat improvement backlog, folded into the task system as `class: improvement`. Source report refs: C29.
