...
related_tasks: [TASK-PLUGIN-001, TASK-PLUGIN-005, TASK-PLUGIN-006, TASK-PLUGIN-007, TASK-TEN-005, TASK-PORTAL-005]
depends_on: [TASK-PLUGIN-006, TASK-PLUGIN-007]
blocks: []
...
| agentskills.io unreachable | mirror call | soft fail; outbox queue | Mirror retries via TASK-PLUGIN-006 outbox |
...
| Audit emission fails | TASK-PLUGIN-006 outbox path | publish succeeds; audit queued | Inherent retry |
...
- §11.6 **Mirror retry semantics.** Mirror failures populate the TASK-PLUGIN-006 outbox with kind=`plugin.mirror_retry` (special variant). Retry worker checks every 5 minutes. Mirror is best-effort, not blocking.
