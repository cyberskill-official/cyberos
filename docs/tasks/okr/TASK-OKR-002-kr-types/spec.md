...
related_tasks: [TASK-OKR-001, TASK-OKR-003, TASK-OKR-004, TASK-MEMORY-111]
...
6. **MUST** emit 3 memory audit kinds per DEC-1974. PII per TASK-MEMORY-111: KR text hashed; type + progress ok.
