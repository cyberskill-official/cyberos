...
related_tasks: [TASK-OKR-002, TASK-OKR-004, TASK-PROJ-013, TASK-INV-009, TASK-HR-008, TASK-LEARN-001, TASK-MEMORY-111]
...
7. **MUST** emit 4 memory audit kinds per DEC-1985. PII per TASK-MEMORY-111: resolved value SHA-256 hashed; module/metric ok.
...
- §11.5 Auto-progress cron (TASK-OKR-004) calls resolve() and writes to current_value.
