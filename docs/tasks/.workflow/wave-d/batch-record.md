...
1. TASK-DOCS-004 - folder-per-FR (491 migrated), corpus 100% strict-yaml (42 repaired/63 lines),
...
3. TASK-DOCS-005 - 491 self-contained CDS FR pages (media, cross-links, audit blocks), catalog
