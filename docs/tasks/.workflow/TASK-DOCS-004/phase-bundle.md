...
yaml trips on; zero manual): corpus now 100% strict-yaml. Migrator scripts/migrate_task_layout.py:
491 task specs + audits moved to <module>/<STEM>/{spec.md,audit.md}, idempotent, sweep rewrites
...
## verification
test_task_layout.sh 6/6 (AC 1-6: zero flat files, 491 folders==491 specs, idempotent, regen loud +
...
human approval for reviewing->ready_to_test and testing->done of this batch's tasks.
