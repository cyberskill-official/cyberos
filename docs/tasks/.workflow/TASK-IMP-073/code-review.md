# TASK-IMP-073 — code-review packet (steps 17–18, code-review@1)
...
Reply with e.g. **"TASK-IMP-073 review: approved"** (→ `ready_to_test`, then testing gates run) or **"TASK-IMP-073 review: rejected — <reason>"** (→ routed back to `ready_to_implement`, `routed_back_count` +1).
