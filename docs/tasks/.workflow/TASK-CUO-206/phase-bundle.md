...
New: modules/skill/contracts/task/SHIP-MANIFEST.md (ship-manifest@1 field table, lifecycle,
...
docs/tasks/.workflow/.gitignore (*.ship.json).
...
the matrix above). Full regression: all 5 tools/install suites PASS; pre-commit payload rebuild +
