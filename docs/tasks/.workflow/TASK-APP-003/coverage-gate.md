...
Deferred: AC #4/#5 need macOS + real certs (spec §5 sanctions the documented deferral). **Standing hard blocker #1: updater-exclusion follow-up task before MAS_RELEASE ever flips** — acceptance of this task ships the channel inert, not the flag.
