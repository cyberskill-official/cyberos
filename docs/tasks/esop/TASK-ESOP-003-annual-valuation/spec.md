...
related_tasks: [TASK-ESOP-001, TASK-ESOP-004, TASK-AUTH-101, TASK-MEMORY-111]
depends_on: [TASK-ESOP-001]
blocks: [TASK-ESOP-004]
...
subtasks:
  ...
  - "0.3h: integration with TASK-ESOP-004"
...
6. **MUST** emit 5 memory audit kinds per DEC-2274. PII per TASK-MEMORY-111: share price SHA256.
