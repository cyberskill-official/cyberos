...
related_tasks: [TASK-HR-001, TASK-ESOP-002, TASK-ESOP-003, TASK-ESOP-004, TASK-MEMORY-111]
depends_on: [TASK-HR-001]
blocks: [TASK-ESOP-002, TASK-ESOP-003, TASK-ESOP-006, TASK-ESOP-007, TASK-TEN-201]
...
5. **MUST** emit 5 memory audit kinds per DEC-2254. PII per TASK-MEMORY-111: total_shares SHA256; member_id (uuid) ok.
...
| Cancel post-cliff | validate | 409 | use TASK-ESOP-005 |
...
- §11.2 Status lifecycle: pending_signing → active (after dual-sign) → fully_vested (TASK-ESOP-002 cron) or cancelled (TASK-ESOP-005 BL).
- §11.3 memory audit body: grant_id, member_id, kind, status; share counts SHA256.
- §11.4 Cancel allowed only pre-cliff — post-cliff requires TASK-ESOP-005 GL/BL flow.
