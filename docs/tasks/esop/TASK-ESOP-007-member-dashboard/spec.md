...
related_tasks: [TASK-ESOP-001, TASK-ESOP-002, TASK-ESOP-003, TASK-AUTH-101, TASK-MEMORY-111]
...
source_decisions:
  ...
  - DEC-2312 2026-05-17 — Estimated current value computed: vested_shares × TASK-ESOP-003 committed price (latest)
...
6. **MUST** emit 4 memory audit kinds per DEC-2314. PII per TASK-MEMORY-111: estimated_value SHA256.
...
- §11.4 Next vest date computed from grant + TASK-ESOP-002 schedule.
