...
_Generated 2026-05-17 — 9 tasks, 51 engineering-hours total._
...
| [TASK-TIME-003](TASK-TIME-003-manual-entry-form/spec.md) | MUST | 1 | 6 | TIME manual entry form — retroactive time logging with date validation + per-day total cap + task-TIME |
