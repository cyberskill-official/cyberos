...
related_tasks: [TASK-DOC-002, TASK-DOC-003, TASK-DOC-004, TASK-DOC-001, TASK-AI-003, TASK-MEMORY-111]
depends_on: [TASK-DOC-002]
blocks: []
...
source_decisions:
  ...
  - DEC-1801 2026-05-17 — Re-stamping triggered at year-9 (1 year before typical TS authority cert expires); TASK-MCP-007 cron scans all B-LT sigs
...
8. **MUST** emit 4 memory audit kinds per DEC-1805. PII per TASK-MEMORY-111: validation data + TS token hashed.
