...
related_tasks: [TASK-DOC-001, TASK-DOC-008, TASK-DOC-009, TASK-AI-003, TASK-MEMORY-111]
depends_on: [TASK-DOC-001]
blocks: [TASK-DOC-008, TASK-DOC-009]
...
risk_if_skipped: "Without lifecycle metadata, contracts can't be queried by status/expiry — TASK-DOC-008 alerts impossible. Without DEC-1712 auto-status, manual status updates drift from reality. Without DEC-1714 parent chain, amendments float disconnected from parents."
---
...
7. **MUST** emit 3 memory audit kinds per DEC-1715. PII per TASK-MEMORY-111: parties JSON hashed; dates and status enum ok.
