...
related_tasks: [TASK-DOC-001, TASK-AUTH-105, TASK-DOC-005, TASK-AI-003, TASK-MEMORY-111]
depends_on: [TASK-AUTH-105]
blocks: [TASK-DOC-005]
...
source_decisions:
  ...
  - DEC-1743 2026-05-17 — eIDAS Level mapping: webauthn=high, vneid=substantial, sms_otp+email_link=low; document signing per TASK-DOC-005 enforces minimum level
...
6. **MUST** define audit table at migration `0005`:
   ...
   CREATE TABLE doc_identity_verifications (
     ...
     failure_reason TEXT,
     ip_address TEXT,  -- hashed per TASK-MEMORY-111
     user_agent TEXT,
     trace_id CHAR(32),
...
8. **MUST** emit 4 memory audit kinds per DEC-1745. PII per TASK-MEMORY-111: ip_address SHA-256 hashed; signer_id (uuid) ok.
