...
service: tools/install/ + .github/workflows/ + .githooks/
new_files:
...
5. **No 0.0.0 escape hatch remains** (§1 #3) - `grep -n "0\.0\.0" tools/install/build.sh` shows only the placeholder-substitution seds, no fallback echo.
