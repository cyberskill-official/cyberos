---
id: TASK-IMP-144
title: "v4.0 — transition-locked state engine (close frontmatter bypass)"
template: task@1
type: improvement
module: improvement
status: draft
...
# TASK-IMP-144: v4.0 transition-locked state engine (draft)
...
3. Capability-scoped agent identities (memory ACL + backlog writes) as a follow-on milestone inside v4.0.

## Non-goals

- Replacing ship-tasks skill chain.
- Cross-tool conformance kit (separate v4.0 track).
