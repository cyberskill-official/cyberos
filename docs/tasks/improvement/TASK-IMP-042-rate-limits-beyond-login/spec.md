---
id: TASK-IMP-042
title: "Rate limits beyond login"
...
verify: N
---
# TASK-IMP-042: Rate limits beyond login

## 1. Description

**Groomed 2026-07-25 (batch/10e):** closed — won't-do for 1.x: rate limits beyond login is platform auth.
...
Migrated 2026-07-08 from the deep-audit improvement backlog, folded into the task system as `class: improvement`. Source report refs: R24.
