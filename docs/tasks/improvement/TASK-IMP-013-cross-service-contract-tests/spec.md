---
id: TASK-IMP-013
title: "Cross-service contract tests"
...
---
# TASK-IMP-013: Cross-service contract tests

## 1. Description

Author the normative clauses when this task is picked up; it was migrated as a draft stub.

Migrated 2026-07-08 from the deep-audit improvement backlog, folded into the task system as `class: improvement`. Source report refs: R14.
