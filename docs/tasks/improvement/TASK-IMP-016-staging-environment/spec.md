...
verify: N
---
# TASK-IMP-016: Staging environment

## 1. Description

**Groomed 2026-07-25 (batch/10e):** closed — won't-do for 1.x: staging environment is infra, not payload.

Author the normative clauses when this task is picked up; it was migrated as a draft stub.

Migrated 2026-07-08 from the deep-audit improvement backlog, folded into the task system as `class: improvement`. Source report refs: R31.
