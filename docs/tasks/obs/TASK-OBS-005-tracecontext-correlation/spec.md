...
related_tasks: [TASK-OBS-001, TASK-OBS-002, TASK-OBS-003, TASK-OBS-004, TASK-AI-022]
depends_on: [TASK-OBS-001, TASK-OBS-003, TASK-OBS-004]
blocks: []
...
```rust
// crates/cyberos-obs-sdk/src/red.rs (modified per TASK-OBS-003 §1 #3 hook)
...
10. **LangSmith trace correlates** — TASK-OBS-004 export uses same trace_id; test queries LangSmith for trace_id and finds the AI call.
...
- Probabilistic sampling decision propagation (TASK-OBS-006 owns) — already covered.
...
| LangSmith trace_id format mismatch | Integration test asserts hex format | Test fails | TASK-OBS-004 fix |
...
*End of TASK-OBS-005. Status: draft (10/10 target).*
