...
- **TASK-OBS-008** — compliance views; this task signs their exports.
- **TASK-AUTH-006** — bootstrap CLI generates initial signing key; quarterly rotation cron.
...
*End of TASK-OBS-009. Status: draft (10/10 target).*
