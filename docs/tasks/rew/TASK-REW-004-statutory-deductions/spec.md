...
related_tasks: [TASK-HR-005, TASK-REW-002, TASK-REW-005, TASK-MEMORY-111]
...
source_decisions:
  ...
  - DEC-2182 2026-05-17 — Rate lookups via TASK-HR-005 + TASK-REW-002 versioned policy; deterministic per period
...
subtasks:
  ...
  - "1.0h: docs"
  - "0.4h: integration test with TASK-REW-005"
...
6. **MUST** emit 3 memory audit kinds per DEC-2184. PII per TASK-MEMORY-111: amounts SHA-256 hashed.

7. **MUST** thread trace_id from TASK-REW-005 compute → deductions → audit.
