...
related_tasks: [TASK-HR-001, TASK-AUTH-105, TASK-REW-002, TASK-REW-003, TASK-MEMORY-111]
depends_on: [TASK-HR-001, TASK-AUTH-101]
blocks: [TASK-REW-002, TASK-REW-003, TASK-REW-005, TASK-REW-007, TASK-REW-010]
...
7. **MUST** emit 4 memory audit kinds per DEC-2154. PII per TASK-MEMORY-111: encrypted_amount never in memory chain; income_kind enum ok; member_id (uuid) ok.
...
- §11.1 KMS key created at tenant provisioning via TASK-AUTH-105 KMS module; alias `rew-{tenant_id}`.
...
- §11.4 CFO email notification on decrypt via TASK-EMAIL-009 (sev-1 path).
