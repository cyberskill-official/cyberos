...
related_tasks: [TASK-REW-001, TASK-AUTH-101, TASK-MEMORY-111]
...
6. **MUST** emit 3 memory audit kinds per DEC-2174. PII per TASK-MEMORY-111: amounts SHA-256 hashed.
...
- §11.3 Demotion consent doc per VN Labour Code Art. 35 — written agreement scanned + TASK-DOC-001.
