...
---
# TASK-MEMORY-244: Rust denylist enforcement at emit/ingest + admin binary hardening

## 1. Description

secret-shaped content rejected at validate; admin runs require dedicated role + break-glass flag + chained invocation row

Migrated 2026-07-08 from the memory improvement backlog, folded into the task system as `class: improvement`. Source report refs: R87, R88.
