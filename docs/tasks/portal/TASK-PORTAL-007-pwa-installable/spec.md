...
related_tasks: [TASK-PORTAL-001, TASK-PORTAL-002, TASK-PORTAL-003, TASK-PORTAL-005, TASK-PORTAL-006, TASK-EMAIL-001, TASK-AI-003, TASK-MEMORY-111]
...
source_decisions:
  ...
  - DEC-1261 2026-05-17 — Per-tenant manifest at `/manifest.json` dynamically composed from TASK-PORTAL-002 brand pack (name, icons, theme_color)
  ...
  - DEC-1263 2026-05-17 — Web Push notifications via VAPID per RFC 8292; per-user subscription stored encrypted; TASK-PORTAL-006 status-change events deliver as push
...
14. **MUST** apply per-tenant brand to install-prompt + notification icon + push notification body (theme_color from TASK-PORTAL-002).
...
14. **Brand pack applied** — install icon + theme color match TASK-PORTAL-002 active pack.
