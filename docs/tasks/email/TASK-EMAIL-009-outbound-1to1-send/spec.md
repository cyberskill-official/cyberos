---
id: TASK-EMAIL-009
title: "EMAIL outbound 1:1 send — DKIM-signed via TASK-EMAIL-004 + AM confirm-before-send + queue + bounce handling"
...
related_tasks: [TASK-EMAIL-004, TASK-EMAIL-010, TASK-EMAIL-011, TASK-AUTH-101, TASK-AI-003, TASK-MEMORY-111]
depends_on: [TASK-EMAIL-004]
blocks: [TASK-EMAIL-010, TASK-EMAIL-003, TASK-INV-010]

source_pages:
  - website/docs/modules/email.html#outbound

source_decisions:
  - DEC-1480 2026-05-17 — Per-message send: AM/Member composes; TASK-EMAIL-004 DKIM-signs; queued via Stalwart SMTP; bounce + complaint tracked
