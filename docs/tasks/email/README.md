...
_Generated 2026-05-17 — 11 tasks, 85 engineering-hours total._
...
| [TASK-EMAIL-007](TASK-EMAIL-007-convert-to-issue/spec.md) | SHOULD | 1 | 6 | EMAIL convert-to-issue — one-click create task-PROJ issue from message with thread backlink + attachme |
