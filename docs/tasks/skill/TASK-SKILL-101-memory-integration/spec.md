...
related_tasks: [TASK-AI-003, TASK-AI-022, TASK-SKILL-102]
depends_on: [TASK-AI-003]
blocks: [TASK-SKILL-102, TASK-SKILL-103]
...
source_decisions:
  ...
  - DEC-202 (trace_id propagation; correlate with TASK-AI-022 + TASK-OBS-005)
...
- **TASK-AI-003** — memory_writer::emit() bridge.
- **TASK-AI-022** — trace_id propagation.
- **TASK-OBS-005** — TraceContext correlation.
- **TASK-SKILL-102 (downstream)** — OCI registry uses these audit rows.
