...
related_tasks: [TASK-HR-004, TASK-HR-005, TASK-MCP-007, TASK-MEMORY-111]
depends_on: [TASK-HR-004]
blocks: []
...
8. **MUST** emit 4 memory audit kinds per DEC-1855. PII per TASK-MEMORY-111: reason SHA-256 hashed.
...
- §11.1 Cron via TASK-MCP-007 `kind: 'hr.accrual_batch'`, daily 02:00 tenant_tz.
