...
related_tasks: [TASK-HR-001, TASK-AUTH-101, TASK-TIME-001, TASK-LEARN-001, TASK-KB-001, TASK-CHAT-005, TASK-REW-001, TASK-MEMORY-111]
...
source_decisions:
  ...
  - DEC-1883 2026-05-17 — Trigger: member.active transition (from probation/inactive); TASK-HR-002 contract type must be set
...
8. **MUST** emit 6 memory audit kinds per DEC-1885. PII per TASK-MEMORY-111: member_id (uuid) ok; failure_reason hashed.
