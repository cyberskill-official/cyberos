...
related_tasks: [TASK-PROJ-001, TASK-PROJ-002, TASK-PROJ-015, TASK-PROJ-018]
...
- **TASK-PROJ-001** — issues + parent_issue_id field.
- **TASK-PROJ-002** — WebSocket for live updates.
- **TASK-PROJ-015** — Timeline primitives reused.
- **TASK-PROJ-018** — gold-border design token.
...
- Parent roll-up not in Timeline (TASK-PROJ-015) because flat-swimlane view; Gantt adds it for hierarchical planning.
