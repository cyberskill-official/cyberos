...
related_tasks: [TASK-PROJ-002, TASK-PROJ-003, TASK-AUTH-001, TASK-AUTH-003, TASK-AI-003]
depends_on: [TASK-AUTH-001, TASK-AUTH-003]
blocks: [TASK-PROJ-002, TASK-PROJ-004, TASK-PROJ-005, TASK-PROJ-008, TASK-PROJ-009, TASK-EMAIL-007, TASK-RES-001]
...
- **TASK-AUTH-001** — tenants exist before engagements created.
- **TASK-AUTH-003** — RLS pattern; add 4 PROJ tables to TENANT_SCOPED_TABLES.
- **TASK-AI-003** — memory_writer for audit row emission.
- **TASK-PROJ-002 (downstream)** — memory decision anchoring uses these structures.
...
- Time tracking integration (TASK-TIME-001) — slice 3+.
...
*End of TASK-PROJ-001. Status: draft (10/10 target).*
