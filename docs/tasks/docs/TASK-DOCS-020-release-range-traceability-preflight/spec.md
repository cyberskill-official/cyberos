...
verify: T
phase: Status-v3 Phase 4/6
owner: Stephen Cheng (CTO)
created: 2026-07-27
shipped: null
memory_chain_hash: null
related_tasks: [TASK-DOCS-009, TASK-DOCS-024]
...
Execute Phase 4/6 for T13 exactly as specified in the plan, preserving non-negotiables: THE RULE, no history rewrite, determinism, offline-first, consumer sovereignty. Every commit cites `TASK-DOCS-020`.
...
- Primary: acceptance core is true — tag dry-run warns on unlinked range; flips blocking with v2.0.0.
- Guardrail: no hand-edited derived payload copies; pair/parity and payload hooks remain the mirror path.

## Scope

In: plan §7 T13 and its Phase 4/6 steps.
