---
id: TASK-DOCS-016
title: "Delete docs/status-v3-preview and move integration docs"
...
related_tasks: [TASK-DOCS-013, TASK-DOCS-014, TASK-DOCS-015]
depends_on: [TASK-DOCS-013, TASK-DOCS-014, TASK-DOCS-015]
blocks: []
source_pages:
...
# TASK-DOCS-016: Delete docs/status-v3-preview and move integration docs

## Summary

Deliver plan item T9 (Phase 2) from `docs/plans/PLAN-status-v3-platform-2026-07-27/plan.md`: no dangling links; preview gone in same PR as swap.
...
Execute Phase 2 for T9 exactly as specified in the plan, preserving non-negotiables: THE RULE, no history rewrite, determinism, offline-first, consumer sovereignty. Every commit cites `TASK-DOCS-016`.
...
- Primary: acceptance core is true — no dangling links; preview gone in same PR as swap.
- Guardrail: no hand-edited derived payload copies; pair/parity and payload hooks remain the mirror path.

## Scope

In: plan §7 T9 and its Phase 2 steps.
...
Upstream: TASK-DOCS-013, TASK-DOCS-014, TASK-DOCS-015.
Downstream: none.
