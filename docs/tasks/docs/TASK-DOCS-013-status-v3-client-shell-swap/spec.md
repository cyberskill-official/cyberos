---
id: TASK-DOCS-013
title: "v3 client into modules/templates + shell swap + legacy emission"
...
verify: T
phase: Status-v3 Phase 2
owner: Stephen Cheng (CTO)
created: 2026-07-27
shipped: null
memory_chain_hash: null
related_tasks: [TASK-DOCS-010, TASK-DOCS-014, TASK-DOCS-015, TASK-DOCS-016, TASK-DOCS-017, TASK-DOCS-018, TASK-DOCS-028]
depends_on: [TASK-DOCS-010]
blocks: [TASK-DOCS-014, TASK-DOCS-015, TASK-DOCS-016, TASK-DOCS-017, TASK-DOCS-018, TASK-DOCS-028]
source_pages:
...
# TASK-DOCS-013: v3 client into modules/templates + shell swap + legacy emission

## Summary

Deliver plan item T6 (Phase 2) from `docs/plans/PLAN-status-v3-platform-2026-07-27/plan.md`: P2 gate: emitted page is v3 canvas; legacy page reachable; CYBEROS_STATUS_LEGACY=1 rollback works.
...
Execute Phase 2 for T6 exactly as specified in the plan, preserving non-negotiables: THE RULE, no history rewrite, determinism, offline-first, consumer sovereignty. Every commit cites `TASK-DOCS-013`.
...
- Primary: acceptance core is true — P2 gate: emitted page is v3 canvas; legacy page reachable; CYBEROS_STATUS_LEGACY=1 rollback works.
- Guardrail: no hand-edited derived payload copies; pair/parity and payload hooks remain the mirror path.

## Scope

In: plan §7 T6 and its Phase 2 steps.
...
Upstream: TASK-DOCS-010.
Downstream: TASK-DOCS-014, TASK-DOCS-015, TASK-DOCS-016, TASK-DOCS-017, TASK-DOCS-018, TASK-DOCS-028.
