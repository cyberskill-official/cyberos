---
id: TASK-DOCS-028
title: "Docs: status-feed spec, traceability runbook, help/AGENT-ENTRY text"
...
related_tasks: [TASK-DOCS-013, TASK-DOCS-019]
depends_on: [TASK-DOCS-013, TASK-DOCS-019]
blocks: []
source_pages:
...
# TASK-DOCS-028: Docs: status-feed spec, traceability runbook, help/AGENT-ENTRY text

## Summary

Deliver plan item T21 (Phase 8) from `docs/plans/PLAN-status-v3-platform-2026-07-27/plan.md`: doc anchors green; stale lens/tab refs retired.
...
Execute Phase 8 for T21 exactly as specified in the plan, preserving non-negotiables: THE RULE, no history rewrite, determinism, offline-first, consumer sovereignty. Every commit cites `TASK-DOCS-028`.
...
- Primary: acceptance core is true — doc anchors green; stale lens/tab refs retired.
- Guardrail: no hand-edited derived payload copies; pair/parity and payload hooks remain the mirror path.

## Scope

In: plan §7 T21 and its Phase 8 steps.
...
Upstream: TASK-DOCS-013, TASK-DOCS-019.
Downstream: none.
