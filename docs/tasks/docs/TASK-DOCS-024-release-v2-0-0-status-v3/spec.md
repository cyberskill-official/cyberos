...
verify: T
phase: Status-v3 Phase 6
owner: Stephen Cheng (CTO)
created: 2026-07-27
shipped: null
memory_chain_hash: null
related_tasks: [TASK-DOCS-020, TASK-DOCS-022, TASK-DOCS-025]
depends_on: [TASK-DOCS-020, TASK-DOCS-022]
blocks: [TASK-DOCS-025]
source_pages:
...
Execute Phase 6 for T17 exactly as specified in the plan, preserving non-negotiables: THE RULE, no history rewrite, determinism, offline-first, consumer sovereignty. Every commit cites `TASK-DOCS-024`.
...
- Primary: acceptance core is true — P6 gate: Release-As 2.0.0 PR ready; operator cuts tag.
- Guardrail: no hand-edited derived payload copies; pair/parity and payload hooks remain the mirror path.

## Scope

In: plan §7 T17 and its Phase 6 steps.
...
Upstream: TASK-DOCS-020, TASK-DOCS-022.
Downstream: TASK-DOCS-025.
