...
source_decisions:
  ...
  - "2026-07-12 field finding (TASK-DOCS-003 ship): regen_backlog's read_fm silently skips 42 yaml-invalid FRs - BACKLOG says 444 where frontmatter says 486. The skip becomes loud and the files get repaired here."
...
# TASK-DOCS-004: Folder-per-FR layout
