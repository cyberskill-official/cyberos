---
id: TASK-DOCS-026
title: "Pilot migrations (zero-task, medium, sachviet layout)"
...
related_tasks: [TASK-DOCS-025, TASK-DOCS-027]
depends_on: [TASK-DOCS-025]
blocks: [TASK-DOCS-027]
source_pages:
...
# TASK-DOCS-026: Pilot migrations (zero-task, medium, sachviet layout)

## Summary

Deliver plan item T19 (Phase 7) from `docs/plans/PLAN-status-v3-platform-2026-07-27/plan.md`: 3 clean audits including sachviet layout migration.
...
Execute Phase 7 for T19 exactly as specified in the plan, preserving non-negotiables: THE RULE, no history rewrite, determinism, offline-first, consumer sovereignty. Every commit cites `TASK-DOCS-026`.
...
- Primary: acceptance core is true — 3 clean audits including sachviet layout migration.
- Guardrail: no hand-edited derived payload copies; pair/parity and payload hooks remain the mirror path.

## Scope

In: plan §7 T19 and its Phase 7 steps.
...
Upstream: TASK-DOCS-025.
Downstream: TASK-DOCS-027.
