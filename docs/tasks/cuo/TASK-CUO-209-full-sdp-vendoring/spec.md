...
8. **Workflows untouched** (§1 #8) - ship-tasks.md and create-tasks.md are diff-clean in this task's commits (git history); the regression suite asserts the durable form (docs vendored intact in the payload) post-amendment.
