...
related_tasks: [TASK-KB-002, TASK-AI-019, TASK-KB-006, TASK-MEMORY-111]
depends_on: [TASK-AI-019, TASK-KB-001]
blocks: [TASK-KB-006]
...
4. **MUST** ingest via TASK-AI-019 memory Layer 2 — call AI-019 ingest API with doc context + chunk embeddings.
...
9. **MUST** emit 4 memory audit kinds per DEC-1925. PII per TASK-MEMORY-111: query + chunk text SHA-256 hashed; embedding never in chain (binary).
...
- §11.1 BGE-M3 model hosted via TASK-AI-019 inference endpoint; service-side caching of embeddings.
