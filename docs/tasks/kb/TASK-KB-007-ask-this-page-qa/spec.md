...
related_tasks: [TASK-KB-006, TASK-CUO-101, TASK-AI-003, TASK-MEMORY-108, TASK-MEMORY-111]
depends_on: [TASK-KB-001, TASK-KB-006, TASK-CUO-101, TASK-MEMORY-108]
blocks: []
...
subtasks:
  ...
  - "0.9h: answer_generator.rs (TASK-AI-003 with structured prompt)"
...
9. **MUST** emit 4 memory audit kinds per DEC-1945. PII per TASK-MEMORY-111: question + answer text SHA-256 hashed; citation ids ok.
...
- §11.2 1-hop link query: `TASK-MEMORY-108 link_graph WHERE source=$doc_id OR target=$doc_id`.
