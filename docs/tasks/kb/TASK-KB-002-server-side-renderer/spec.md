...
related_tasks: [TASK-KB-001, TASK-KB-005, TASK-AI-019, TASK-MEMORY-111]
...
source_decisions:
  ...
  - DEC-1891 2026-05-17 — Plaintext extraction strips formatting + sanitises for TASK-AI-019 memory Layer 2 vector ingest
...
7. **MUST** emit 3 memory audit kinds per DEC-1894. PII per TASK-MEMORY-111: rendered_content text SHA-256 hashed.
