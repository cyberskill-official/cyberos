...
related_tasks: [TASK-KB-004, TASK-KB-005, TASK-KB-007, TASK-AI-020, TASK-MEMORY-111]
depends_on: [TASK-AI-020, TASK-KB-005]
blocks: [TASK-KB-007]
...
6. **MUST** emit 3 memory audit kinds per DEC-1934. PII per TASK-MEMORY-111: query SHA256 in chain; results count ok.
...
10. **MUST** evict cache rows past `expires_at` via TASK-MCP-007 nightly cron.
...
- §11.1 BGE-rerank model hosted via TASK-AI-020 inference service.
