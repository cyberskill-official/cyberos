# CyberOS changelog - legacy 1.x line (retired 2026-07-12)

This is the pre-reset release history, moved out of CHANGELOG.md on 2026-07-20 because it carried a second `## [1.0.0]` heading (dated 2026-07-10) that collided with the real 1.0.0 release (dated 2026-07-14) - two anchors for one version breaks every tool that resolves a section by version. Content is unchanged; only the location moved. The active line starts at 0.1.0 in [../CHANGELOG.md](../CHANGELOG.md).
