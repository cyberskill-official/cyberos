...
of every deliverable (TASK-DOCS-002 doctrine); these shells are how that source is SHOWN.
...
consumers never fork a shell - extend via slot content, or amend this module by task.
