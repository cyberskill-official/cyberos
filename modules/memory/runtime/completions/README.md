...
- Dynamic values where cheap to enumerate: persona slugs, memory types, task IDs from `cyberos task list`.
...
- Aspect 1.4 in the operator manual: [`README.md`](../../README.md)
