"""Tests for FR-BRAIN-105 (watched-folder invariants) +
FR-BRAIN-110 (daemon heartbeat) + FR-BRAIN-111 (pre-ingest PII gate)."""
...
# ---------------------------------------------------------------------------
# FR-BRAIN-110 — daemon heartbeat / supervisor
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# FR-BRAIN-111 — pre-ingest PII gate
# ---------------------------------------------------------------------------
