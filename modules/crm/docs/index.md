...
`R-CRM-010`| Open-pipeline data ingested into memory by accident ((FR pending) violation)| Low| High| CDO| memory ingest path gated by deal.status in ('won','lost'); CI test asserts.
