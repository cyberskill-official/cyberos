# `compensation-plan-audit` — human summary format
...
```
COMP-PLAN audit batch complete

Audited N COMP-PLAN(s):
  - COMP-PLAN-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - COMP-PLAN-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - COMP-PLAN-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        comp-plan_rubric@1.0
