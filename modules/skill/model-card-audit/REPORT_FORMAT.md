# `model-card` audit-report format

Every `model-card-audit` invocation writes a sibling `model-card.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "model-card_rubric@1.0"
audited_file:           "./model-cards/MODEL-CARD-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "model-card_rubric@1.0"
