# `model-card-audit` — human summary format
...
```
MODEL-CARD audit batch complete

Audited N MODEL-CARD(s):
  - MODEL-CARD-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - MODEL-CARD-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - MODEL-CARD-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        model-card_rubric@1.0
