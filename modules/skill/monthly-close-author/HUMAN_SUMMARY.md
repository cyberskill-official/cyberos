# `monthly-close-author` — human summary format
...
```
MONTHLY-CLOSE batch <batch_run_id> complete

Wrote N MONTHLY-CLOSE(s):
  - MONTHLY-CLOSE-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - MONTHLY-CLOSE-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - MONTHLY-CLOSE-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        monthly-close-audit will run automatically on PASS items. HITL items wait for your reply.
```
