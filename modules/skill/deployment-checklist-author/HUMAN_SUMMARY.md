# `deployment-checklist-author` — human summary format
...
```
DEPLOY-CHECKLIST batch <batch_run_id> complete

Wrote N DEPLOY-CHECKLIST(s):
  - DEPLOY-CHECKLIST-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - DEPLOY-CHECKLIST-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - DEPLOY-CHECKLIST-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        deployment-checklist-audit will run automatically on PASS items. HITL items wait for your reply.
```
