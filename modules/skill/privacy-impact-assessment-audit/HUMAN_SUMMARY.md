# `privacy-impact-assessment-audit` — human summary format
...
```
PIA audit batch complete

Audited N PIA(s):
  - PIA-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - PIA-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - PIA-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        pia_rubric@1.0
