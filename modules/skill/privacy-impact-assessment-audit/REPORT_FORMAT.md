# `pia` audit-report format

Every `privacy-impact-assessment-audit` invocation writes a sibling `pia.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "pia_rubric@1.0"
audited_file:           "./pias/PIA-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "pia_rubric@1.0"
