...
description: |
  Author a per-AI-model model card (identity + intended use + out-of-scope uses + training data + evaluation results + bias analysis + safety considerations + limitations + contact). Hugging Face model-card pattern + Mitchell et al. 2019. CAIO + Chief Ethics Officer co-authored.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
