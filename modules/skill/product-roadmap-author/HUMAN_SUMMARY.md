# `product-roadmap-author` — human summary format
...
```
PRODUCT-ROADMAP batch <batch_run_id> complete

Wrote N PRODUCT-ROADMAP(s):
  - PRODUCT-ROADMAP-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - PRODUCT-ROADMAP-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - PRODUCT-ROADMAP-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        product-roadmap-audit will run automatically on PASS items. HITL items wait for your reply.
```
