...
- `cyberos/skill/contracts/retrospective/` — the artefact template this skill audits.
- `cyberos/skill/contracts/nats-subjects/` — the NATS subject naming contract.
- `cyberos/skill/retrospective-author/` — the sibling author skill whose output this skill validates.
