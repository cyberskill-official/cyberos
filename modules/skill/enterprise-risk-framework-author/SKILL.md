...
description: |
  Author an annual enterprise-risk framework (risk-appetite vs risk-tolerance + KRI taxonomy + scenario library + stress-test catalog + governance cadence). COSO ERM + ISO 31000 aligned. CRO-Risk authored.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
