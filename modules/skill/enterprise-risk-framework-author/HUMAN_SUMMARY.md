# `enterprise-risk-framework-author` — human summary format
...
```
ENTERPRISE-RISK-FRAMEWORK batch <batch_run_id> complete

Wrote N ENTERPRISE-RISK-FRAMEWORK(s):
  - ENTERPRISE-RISK-FRAMEWORK-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - ENTERPRISE-RISK-FRAMEWORK-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - ENTERPRISE-RISK-FRAMEWORK-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        enterprise-risk-framework-audit will run automatically on PASS items. HITL items wait for your reply.
```
