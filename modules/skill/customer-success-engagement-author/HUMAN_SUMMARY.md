# `customer-success-engagement-author` — human summary format
...
```
CS-ENGAGEMENT batch <batch_run_id> complete

Wrote N CS-ENGAGEMENT(s):
  - CS-ENGAGEMENT-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - CS-ENGAGEMENT-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - CS-ENGAGEMENT-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        customer-success-engagement-audit will run automatically on PASS items. HITL items wait for your reply.
```
