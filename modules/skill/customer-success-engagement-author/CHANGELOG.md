...
- NATS event emission for `cs-engagement_written`, `batch_complete`, `hitl_pause`.
...
- Self-audit passes on its own input set at 10/10 by `customer-success-engagement-audit`.
