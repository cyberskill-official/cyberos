...
description: |
  Author a per-customer engagement plan (context + health-score + QBR cadence + expansion theses + churn-risk indicators + executive coverage). CCO-Customer authored.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
