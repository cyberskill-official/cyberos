# `clinical-protocol-audit` — human summary format
...
```
CLINICAL-PROTOCOL audit batch complete

Audited N CLINICAL-PROTOCOL(s):
  - CLINICAL-PROTOCOL-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - CLINICAL-PROTOCOL-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - CLINICAL-PROTOCOL-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        clinical-protocol_rubric@1.0
