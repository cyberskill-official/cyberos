# `clinical-protocol` audit-report format

Every `clinical-protocol-audit` invocation writes a sibling `clinical-protocol.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "clinical-protocol_rubric@1.0"
audited_file:           "./clinical-protocols/CLINICAL-PROTOCOL-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "clinical-protocol_rubric@1.0"
