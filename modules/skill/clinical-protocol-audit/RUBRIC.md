# `clinical_protocol_rubric@1.0` — machine-checkable Clinical Protocol rubric
...
| `FM-004` | `template` equals `clinical-protocol@1` | error | true |
...
Per the `contracts/clinical-protocol/template.md` H2 list.
...
- `cyberos/skill/contracts/clinical-protocol/CONTRACT.md` + `template.md`
