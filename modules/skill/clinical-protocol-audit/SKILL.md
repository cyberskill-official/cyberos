...
description: |
  Audit one or more existing clinical-protocol@1 markdowns against
  clinical-protocol_rubric@1.0. Produces a sibling .audit.md per artefact plus
