# `project-plan` audit-report format

Every `project-plan-audit` invocation writes a sibling `project-plan.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "project-plan_rubric@1.0"
audited_file:           "./project-plans/PROJECT-PLAN-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "project-plan_rubric@1.0"
