# `project-plan-audit` — human summary format
...
```
PROJECT-PLAN audit batch complete

Audited N PROJECT-PLAN(s):
  - PROJECT-PLAN-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - PROJECT-PLAN-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - PROJECT-PLAN-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        project-plan_rubric@1.0
