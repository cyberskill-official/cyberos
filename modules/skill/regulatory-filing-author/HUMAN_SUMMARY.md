# `regulatory-filing-author` — human summary format
...
```
REGULATORY_FILING batch <batch_run_id> complete

Wrote N REGULATORY_FILING(s):
  - REGULATORY_FILING-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - REGULATORY_FILING-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - REGULATORY_FILING-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        regulatory-filing-audit will run automatically on PASS items. HITL items wait for your reply.
```
