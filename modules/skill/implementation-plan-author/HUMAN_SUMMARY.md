# `implementation-plan-author` — human summary format
...
```
IMPL-PLAN batch <batch_run_id> complete

Wrote N IMPL-PLAN(s):
  - IMPL-PLAN-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - IMPL-PLAN-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - IMPL-PLAN-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        implementation-plan-audit will run automatically on PASS items. HITL items wait for your reply.
```
