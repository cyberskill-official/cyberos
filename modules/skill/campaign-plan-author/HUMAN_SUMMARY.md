# `campaign-plan-author` — human summary format
...
```
CAMPAIGN-PLAN batch <batch_run_id> complete

Wrote N CAMPAIGN-PLAN(s):
  - CAMPAIGN-PLAN-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - CAMPAIGN-PLAN-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - CAMPAIGN-PLAN-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        campaign-plan-audit will run automatically on PASS items. HITL items wait for your reply.
```
