...
| `COV-GATE-002` | files_below_90pct is empty (COVERAGE_THRESHOLD, config-overridable once FR-CUO-207 lands; default 90 preserved) | SKILL.md threshold clause |
...
- coverage_gate_rubric@1.0: initial file-form of the gates already normative in SKILL.md prose (FR-SKILL-118; no bar raised, no bar lowered).
