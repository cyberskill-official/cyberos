# `coverage-gate-audit` - acceptance

1. `TRIGGER_TESTS.md` here - trigger cases per TASK-SKILL-111/112 conventions.
2. Structural: `bash tools/cyberos-install/check-pair-parity.sh modules/skill` reports no PARITY line for `coverage-gate-audit`.
