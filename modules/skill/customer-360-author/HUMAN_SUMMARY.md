# `customer-360-author` — human summary format
...
```
CUSTOMER_360 batch <batch_run_id> complete

Wrote N CUSTOMER_360(s):
  - CUSTOMER_360-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - CUSTOMER_360-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - CUSTOMER_360-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        customer-360-audit will run automatically on PASS items. HITL items wait for your reply.
```
