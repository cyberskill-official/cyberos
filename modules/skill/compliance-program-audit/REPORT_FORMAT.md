# `compliance-program` audit-report format

Every `compliance-program-audit` invocation writes a sibling `compliance-program.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "compliance-program_rubric@1.0"
audited_file:           "./compliance-programs/COMPLIANCE-PROGRAM-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "compliance-program_rubric@1.0"
