# `compliance-program-audit` — human summary format
...
```
COMPLIANCE-PROGRAM audit batch complete

Audited N COMPLIANCE-PROGRAM(s):
  - COMPLIANCE-PROGRAM-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - COMPLIANCE-PROGRAM-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - COMPLIANCE-PROGRAM-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        compliance-program_rubric@1.0
