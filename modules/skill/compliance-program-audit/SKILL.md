...
description: |
  Audit one or more existing compliance-program@1 markdowns against
  compliance-program_rubric@1.0. Produces a sibling .audit.md per artefact plus
