...
> Chains naturally after [`fr-author`](../fr-author/SKILL.md).

`prompt_revision: fr_audit@2.0.0` (port of the proven legacy `cuo/cpo/fr-audit@0.2.2`)
...
Also invoked automatically by the supervisor when `fr-author`'s output envelope sets `next_skill_recommendation: fr-audit` (the default chain).
