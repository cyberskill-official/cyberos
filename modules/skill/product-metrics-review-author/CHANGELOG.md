...
- NATS event emission for `product-metrics-review_written`, `batch_complete`, `hitl_pause`.
...
- Self-audit passes on its own input set at 10/10 by `product-metrics-review-audit`.
