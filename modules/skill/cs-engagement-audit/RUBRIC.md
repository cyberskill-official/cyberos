...
| `FM-004` | `template` equals `cs-engagement@1` | error | true |
...
Per the `contracts/cs-engagement/template.md` H2 list. Each H2 in the template MUST be present + non-empty in the authored artefact. See template for the canonical headings.

| rule_id | Check | Severity |
| ------- | ----- | -------- |
| `SEC-001` | Every H2 declared in `contracts/cs-engagement/template.md` is present in the authored artefact | error |
...
- `cyberos/skill/contracts/cs-engagement/CONTRACT.md` + `template.md`
