# `cs-engagement` audit-report format

Every `cs-engagement-audit` invocation writes a sibling `cs-engagement.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "cs-engagement_rubric@1.0"
audited_file:           "./cs-engagements/CS-ENGAGEMENT-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "cs-engagement_rubric@1.0"
