# `change-management-plan-audit` — human summary format
...
```
CHANGE-MGMT-PLAN audit batch complete

Audited N CHANGE-MGMT-PLAN(s):
  - CHANGE-MGMT-PLAN-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - CHANGE-MGMT-PLAN-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - CHANGE-MGMT-PLAN-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        change-mgmt-plan_rubric@1.0
