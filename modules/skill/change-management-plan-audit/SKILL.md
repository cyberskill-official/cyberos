...
description: |
  Audit one or more existing change-management-plan@1 markdowns against
  change-mgmt-plan_rubric@1.0. Produces a sibling .audit.md per artefact plus
