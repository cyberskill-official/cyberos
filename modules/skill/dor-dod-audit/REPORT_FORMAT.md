# `dor-dod` audit-report format

Every `dor-dod-audit` invocation writes a sibling `dor-dod.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "dor-dod_rubric@1.0"
audited_file:           "./dor-dods/DOR-DOD-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "dor-dod_rubric@1.0"
