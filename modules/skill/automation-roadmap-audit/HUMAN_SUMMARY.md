# `automation-roadmap-audit` — human summary format
...
```
AUTOMATION-ROADMAP audit batch complete

Audited N AUTOMATION-ROADMAP(s):
  - AUTOMATION-ROADMAP-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - AUTOMATION-ROADMAP-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - AUTOMATION-ROADMAP-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        automation-roadmap_rubric@1.0
