# `automation-roadmap` audit-report format

Every `automation-roadmap-audit` invocation writes a sibling `automation-roadmap.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "automation-roadmap_rubric@1.0"
audited_file:           "./automation-roadmaps/AUTOMATION-ROADMAP-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "automation-roadmap_rubric@1.0"
