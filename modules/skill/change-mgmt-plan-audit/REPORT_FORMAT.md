# `change-mgmt-plan` audit-report format

Every `change-mgmt-plan-audit` invocation writes a sibling `change-mgmt-plan.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "change-mgmt-plan_rubric@1.0"
audited_file:           "./change-mgmt-plans/CHANGE-MGMT-PLAN-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "change-mgmt-plan_rubric@1.0"
