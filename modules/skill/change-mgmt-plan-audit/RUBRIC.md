...
| `FM-004` | `template` equals `change-mgmt-plan@1` | error | true |
...
Per the `contracts/change-mgmt-plan/template.md` H2 list — every H2 in template MUST be present + non-empty in the authored artefact.

| rule_id | Check | Severity |
| ------- | ----- | -------- |
| `SEC-001` | Every H2 declared in `contracts/change-mgmt-plan/template.md` is present in the authored artefact | error |
...
- `cyberos/skill/contracts/change-mgmt-plan/CONTRACT.md` + `template.md`
