# litigation-mgmt-update_rubric@1.0 — compact universal rubric
...
| FM-002 | `artefact_type` matches `litigation-management-update@1` |
...
| ID | Rule |
|---|---|
| SEC-001 | Every H2 in `contracts/litigation-management-update/template.md` is present in the authored artefact |
