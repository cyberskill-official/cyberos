# `litigation-management-update-audit` — human summary format
...
```
LITIGATION_MGMT_UPDATE audit batch complete

Audited N LITIGATION_MGMT_UPDATE(s):
  - LITIGATION_MGMT_UPDATE-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - LITIGATION_MGMT_UPDATE-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - LITIGATION_MGMT_UPDATE-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        litigation-mgmt-update_rubric@1.0
