# `litigation-mgmt-update` audit-report format

Every `litigation-management-update-audit` invocation writes a sibling `litigation-mgmt-update.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "litigation-mgmt-update_rubric@1.0"
audited_file:           "./litigation-mgmt-updates/LITIGATION_MGMT_UPDATE-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "litigation-mgmt-update_rubric@1.0"
