...
metadata:
  ...
  module: skill
  stage: cross
  cyberos-template: enterprise-risk-framework@1
...
# enterprise-risk-framework-audit — ENTERPRISE-RISK-FRAMEWORK auditor

> Standalone trigger that runs `enterprise-risk-framework_rubric@1.0` against one or
> more existing `enterprise-risk-framework@1` markdowns and writes a sibling
> `enterprise-risk-framework.audit.md` per item. Halts on `needs_human` verdicts via
> the standard Question primitive; resumable on `audited_file_sha256`.
> Chains naturally after [`enterprise-risk-framework-author`](../enterprise-risk-framework-author/SKILL.md).

`prompt_revision: enterprise-risk-framework_audit@1.0.0`

## When to invoke this skill

CUO routes a request here when the user wants to:

- "Audit these existing `ENTERPRISE-RISK-FRAMEWORK`s."
- "Has `ENTERPRISE-RISK-FRAMEWORK-007` changed since the last audit?"
- "Tell me which `ENTERPRISE-RISK-FRAMEWORK`s would fail acceptance today."

Also invoked automatically by the supervisor when `enterprise-risk-framework-author`'s output envelope sets `next_skill_recommendation: enterprise-risk-framework-audit` (the default chain).
...
audit_rubric_version:            enterprise-risk-framework_rubric@1.0
...
```json
{
  "artefact_paths": ["./enterprise-risk-frameworks/ENTERPRISE-RISK-FRAMEWORK-001-foo.md", "./enterprise-risk-frameworks/ENTERPRISE-RISK-FRAMEWORK-002-bar.md"],
  "caller_persona": "cuo-cpo",
  "trace_id": "<uuid>",
  "upstream_context": {
    "from_skill": "enterprise-risk-framework-author",
...
```json
{
  ...
  "exit_code": 1,
  "per_artefact": [
    {"artefact_path": "./enterprise-risk-frameworks/ENTERPRISE-RISK-FRAMEWORK-001-foo.md", "audit_path": "./enterprise-risk-frameworks/ENTERPRISE-RISK-FRAMEWORK-001-foo.audit.md", "status": "pass", "iterations": 1, "audited_file_sha256": "<hex>"},
    {"artefact_path": "./enterprise-risk-frameworks/ENTERPRISE-RISK-FRAMEWORK-002-bar.md", "audit_path": "./enterprise-risk-frameworks/ENTERPRISE-RISK-FRAMEWORK-002-bar.audit.md", "status": "needs_human", "iterations": 3, "audited_file_sha256": "<hex>"}
  ],
  "hitl_required": true,
...
```
Persona: cuo-cpo
Skill:   enterprise-risk-framework-audit
Input:
  artefact_paths:  [./team-a/ENTERPRISE-RISK-FRAMEWORK-001-something.md, ./team-b/ENTERPRISE-RISK-FRAMEWORK-018-other.md]
  caller_persona:  cuo-cpo
  trace_id:        <uuid>
