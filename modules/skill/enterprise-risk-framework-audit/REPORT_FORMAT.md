# `enterprise-risk-framework` audit-report format

Every `enterprise-risk-framework-audit` invocation writes a sibling `enterprise-risk-framework.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "enterprise-risk-framework_rubric@1.0"
audited_file:           "./enterprise-risk-frameworks/ENTERPRISE-RISK-FRAMEWORK-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "enterprise-risk-framework_rubric@1.0"
