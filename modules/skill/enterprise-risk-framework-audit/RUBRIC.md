# `enterprise_risk_framework_rubric@1.0` — machine-checkable Enterprise Risk Framework rubric
...
| `FM-004` | `template` equals `enterprise-risk-framework@1` | error | true |
...
Per the `contracts/enterprise-risk-framework/template.md` H2 list — every H2 in template MUST be present + non-empty in the authored artefact.

| rule_id | Check | Severity |
| ------- | ----- | -------- |
| `SEC-001` | Every H2 declared in `contracts/enterprise-risk-framework/template.md` is present in the authored artefact | error |
...
- `cyberos/skill/contracts/enterprise-risk-framework/CONTRACT.md` + `template.md`
