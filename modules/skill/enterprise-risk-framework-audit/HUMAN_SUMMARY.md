# `enterprise-risk-framework-audit` — human summary format
...
```
ENTERPRISE-RISK-FRAMEWORK audit batch complete

Audited N ENTERPRISE-RISK-FRAMEWORK(s):
  - ENTERPRISE-RISK-FRAMEWORK-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - ENTERPRISE-RISK-FRAMEWORK-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - ENTERPRISE-RISK-FRAMEWORK-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        enterprise-risk-framework_rubric@1.0
