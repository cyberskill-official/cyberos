# `ai_use_case_portfolio_rubric@1.0` — machine-checkable AI Use Case Portfolio rubric
...
| `FM-004` | `template` equals `ai-use-case-portfolio@1` | error | true |
...
Per the `contracts/ai-use-case-portfolio/template.md` H2 list. Each H2 in the template MUST be present + non-empty in the authored artefact. See template for the canonical headings.

| rule_id | Check | Severity |
| ------- | ----- | -------- |
| `SEC-001` | Every H2 declared in `contracts/ai-use-case-portfolio/template.md` is present in the authored artefact | error |
...
- `cyberos/skill/contracts/ai-use-case-portfolio/CONTRACT.md` + `template.md`
