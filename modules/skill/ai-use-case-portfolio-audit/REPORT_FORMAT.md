# `ai-use-case-portfolio` audit-report format

Every `ai-use-case-portfolio-audit` invocation writes a sibling `ai-use-case-portfolio.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "ai-use-case-portfolio_rubric@1.0"
audited_file:           "./ai-use-case-portfolios/AI-USE-CASE-PORTFOLIO-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "ai-use-case-portfolio_rubric@1.0"
