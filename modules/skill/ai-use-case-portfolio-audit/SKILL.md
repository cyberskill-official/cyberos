---
# ── Identity ─────────────────────────────────────────────────────────
name: ai-use-case-portfolio-audit
description: >-
  Audit one or more existing ai-use-case-portfolio@1 markdowns against ai-use-case-portfolio_rubric@1.0. Produces a sibling .audit.md per artefact plus an AUDIT_BATCH_SUMMARY. Halts on needs_human verdicts; resumable on audited_file_sha256. Standalone trigger or chains naturally after ai-use-case-portfolio-author. Use when user asks to "audit this ai use case portfolio" or "check the ai use case portfolio". Do NOT use for "draft a new ai use case portfolio" (use ai-use-case-portfolio-author instead).
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
  stage: cross
  cyberos-template: ai-use-case-portfolio@1
  cyberos-rubric-version: ai-use-case-portfolio_rubric@1.0
...
depends_on_contracts:
  - id:        ai-use-case-portfolio
    ...
    pin_path:  cyberos/skill/contracts/ai-use-case-portfolio/
  - id:        nats-subjects
    version:   v1
...
# ai-use-case-portfolio-audit — AI-USE-CASE-PORTFOLIO auditor

> Standalone trigger that runs `ai-use-case-portfolio_rubric@1.0` against one or
> more existing `ai-use-case-portfolio@1` markdowns and writes a sibling
> `ai-use-case-portfolio.audit.md` per item. Halts on `needs_human` verdicts via
> the standard Question primitive; resumable on `audited_file_sha256`.
> Chains naturally after [`ai-use-case-portfolio-author`](../ai-use-case-portfolio-author/SKILL.md).

`prompt_revision: ai-use-case-portfolio_audit@1.0.0`

## When to invoke this skill

CUO routes a request here when the user wants to:

- "Audit these existing `AI-USE-CASE-PORTFOLIO`s."
- "Has `AI-USE-CASE-PORTFOLIO-007` changed since the last audit?"
- "Tell me which `AI-USE-CASE-PORTFOLIO`s would fail acceptance today."

Also invoked automatically by the supervisor when `ai-use-case-portfolio-author`'s output envelope sets `next_skill_recommendation: ai-use-case-portfolio-audit` (the default chain).
...
skill_version:                   1.0.0
prompt_revision:                 ai-use-case-portfolio_audit@1.0.0
template_version:                ai-use-case-portfolio@1   (loaded from cyberos/skill/contracts/ai-use-case-portfolio/template.md)
audit_rubric_version:            ai-use-case-portfolio_rubric@1.0
...
```json
{
  "artefact_paths": ["./ai-use-case-portfolios/AI-USE-CASE-PORTFOLIO-001-foo.md", "./ai-use-case-portfolios/AI-USE-CASE-PORTFOLIO-002-bar.md"],
  "caller_persona": "cuo-cpo",
  "trace_id": "<uuid>",
  "upstream_context": {
    "from_skill": "ai-use-case-portfolio-author",
    "manifest_path": "./ai-use-case-portfolios/manifest.json"
  }
}
```
...
```json
{
  ...
  "exit_code": 1,
  "per_artefact": [
    {"artefact_path": "./ai-use-case-portfolios/AI-USE-CASE-PORTFOLIO-001-foo.md", "audit_path": "./ai-use-case-portfolios/AI-USE-CASE-PORTFOLIO-001-foo.audit.md", "status": "pass", "iterations": 1, "audited_file_sha256": "<hex>"},
    {"artefact_path": "./ai-use-case-portfolios/AI-USE-CASE-PORTFOLIO-002-bar.md", "audit_path": "./ai-use-case-portfolios/AI-USE-CASE-PORTFOLIO-002-bar.audit.md", "status": "needs_human", "iterations": 3, "audited_file_sha256": "<hex>"}
  ],
  "hitl_required": true,
...
```
Persona: cuo-cpo
Skill:   ai-use-case-portfolio-audit
Input:
  artefact_paths:  [./team-a/AI-USE-CASE-PORTFOLIO-001-something.md, ./team-b/AI-USE-CASE-PORTFOLIO-018-other.md]
  caller_persona:  cuo-cpo
  trace_id:        <uuid>
