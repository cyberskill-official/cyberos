# `ai-use-case-portfolio-audit` — human summary format
...
```
AI-USE-CASE-PORTFOLIO audit batch complete

Audited N AI-USE-CASE-PORTFOLIO(s):
  - AI-USE-CASE-PORTFOLIO-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - AI-USE-CASE-PORTFOLIO-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - AI-USE-CASE-PORTFOLIO-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        ai-use-case-portfolio_rubric@1.0
