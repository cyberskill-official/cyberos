# `vendor-scorecard-audit` — human summary format
...
```
VENDOR-SCORECARD audit batch complete

Audited N VENDOR-SCORECARD(s):
  - VENDOR-SCORECARD-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - VENDOR-SCORECARD-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - VENDOR-SCORECARD-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        vendor-scorecard_rubric@1.0
