...
description: |
  Audit one or more existing vendor-scorecard@1 markdowns against
  vendor-scorecard_rubric@1.0. Produces a sibling .audit.md per artefact plus
