# `vendor-scorecard` audit-report format

Every `vendor-scorecard-audit` invocation writes a sibling `vendor-scorecard.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "vendor-scorecard_rubric@1.0"
audited_file:           "./vendor-scorecards/VENDOR-SCORECARD-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "vendor-scorecard_rubric@1.0"
