...
- NATS event emission for `dor-dod_written`, `batch_complete`, `hitl_pause`.
...
- Self-audit passes on its own input set at 10/10 by `definition-of-ready-and-done-audit`.
