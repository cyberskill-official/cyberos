# `definition-of-ready-and-done-author` — human summary format
...
```
DOR-DOD batch <batch_run_id> complete

Wrote N DOR-DOD(s):
  - DOR-DOD-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - DOR-DOD-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - DOR-DOD-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        definition-of-ready-and-done-audit will run automatically on PASS items. HITL items wait for your reply.
```
