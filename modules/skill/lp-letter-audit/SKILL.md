---
# ── Identity ─────────────────────────────────────────────────────────
name: lp-letter-audit
description: |
  Audit one or more existing lp-letter@1 markdowns against
...
depends_on_contracts:
  - id:        lp-letter
    ...
    pin_path:  cyberos/skill/contracts/lp-letter/
  - id:        nats-subjects
    version:   v1
...
# lp-letter-audit — LP-LETTER auditor

> Standalone trigger that runs `lp-letter_rubric@1.0` against one or
> more existing `lp-letter@1` markdowns and writes a sibling
...
> Chains naturally after [`lp-letter-author`](../lp-letter-author/SKILL.md).
...
Also invoked automatically by the supervisor when `lp-letter-author`'s output envelope sets `next_skill_recommendation: lp-letter-audit` (the default chain).
...
```
CONTRACT_ECHO
skill_id:                        lp-letter-audit
skill_version:                   1.0.0
prompt_revision:                 lp-letter_audit@1.0.0
template_version:                lp-letter@1   (loaded from cyberos/skill/contracts/lp-letter/template.md)
