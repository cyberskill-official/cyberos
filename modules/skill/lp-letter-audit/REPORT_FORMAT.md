# `lp-letter` audit-report format

Every `lp-letter-audit` invocation writes a sibling `lp-letter.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "lp-letter_rubric@1.0"
audited_file:           "./lp-letters/LP-LETTER-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "lp-letter_rubric@1.0"
