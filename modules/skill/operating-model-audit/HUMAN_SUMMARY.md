# `operating-model-audit` — human summary format
...
```
OPERATING-MODEL audit batch complete

Audited N OPERATING-MODEL(s):
  - OPERATING-MODEL-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - OPERATING-MODEL-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - OPERATING-MODEL-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        operating-model_rubric@1.0
