# `operating-model` audit-report format

Every `operating-model-audit` invocation writes a sibling `operating-model.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "operating-model_rubric@1.0"
audited_file:           "./operating-models/OPERATING-MODEL-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "operating-model_rubric@1.0"
