# `crisis-communications-playbook-audit` — human summary format
...
```
CRISIS-COMMS-PLAYBOOK audit batch complete

Audited N CRISIS-COMMS-PLAYBOOK(s):
  - CRISIS-COMMS-PLAYBOOK-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - CRISIS-COMMS-PLAYBOOK-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - CRISIS-COMMS-PLAYBOOK-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        crisis-comms-playbook_rubric@1.0
