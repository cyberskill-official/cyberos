...
description: |
  Audit one or more existing crisis-communications-playbook@1 markdowns against
  crisis-comms-playbook_rubric@1.0. Produces a sibling .audit.md per artefact plus
  ...
  crisis-communications-playbook-author.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
