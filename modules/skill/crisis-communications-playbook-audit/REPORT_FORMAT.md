...
Every `crisis-communications-playbook-audit` invocation writes a sibling `crisis-comms-playbook.audit.md` per audited artefact. The report format below is normative.
