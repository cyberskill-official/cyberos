# `crisis_comms_playbook_rubric@1.0` — machine-checkable Crisis Comms Playbook rubric
...
| `FM-004` | `template` equals `crisis-communications-playbook@1` | error | true |
...
Per the `contracts/crisis-communications-playbook/template.md` H2 list — every H2 in template MUST be present + non-empty in the authored artefact.

| rule_id | Check | Severity |
| ------- | ----- | -------- |
| `SEC-001` | Every H2 declared in `contracts/crisis-communications-playbook/template.md` is present in the authored artefact | error |
...
- `cyberos/skill/contracts/crisis-communications-playbook/CONTRACT.md` + `template.md`
