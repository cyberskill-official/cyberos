...
> Sourced from `cyberos/skill/contracts/implementation-plan/CONTRACT.md` and `../../../modules/cuo/docs/module.md` §2(f) Implementation; DORA findings on small-batch discipline + AI-assisted code review. Rubric version `1.0` is locked.
...
| `FM-103` | `linked_fr` | required, resolves to a task that passed task-audit at 10/10 | error | false |
...
| `XCHAIN-003` | `linked_fr` resolves to a task that passed task-audit at 10/10 (else block plan) | error |
...
- `../../../modules/cuo/docs/module.md` §2(f) — Implementation stage source
- `../../../modules/cuo/docs/module.md` §5 — AI integration source (drives §8 and COND-005)
