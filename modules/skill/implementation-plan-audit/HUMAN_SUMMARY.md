# `implementation-plan-audit` — human summary format
...
```
IMPL-PLAN audit batch complete

Audited N IMPL-PLAN(s):
  - IMPL-PLAN-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - IMPL-PLAN-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - IMPL-PLAN-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        impl-plan_rubric@1.0
