# `remote-policy` audit-report format

Every `remote-policy-audit` invocation writes a sibling `remote-policy.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "remote-policy_rubric@1.0"
audited_file:           "./remote-policys/REMOTE-POLICY-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "remote-policy_rubric@1.0"
