# `remote_policy_rubric@1.0` — machine-checkable Remote Policy rubric
...
| `FM-004` | `template` equals `remote-policy@1` | error | true |
...
Per the `contracts/remote-policy/template.md` H2 list.
...
- `cyberos/skill/contracts/remote-policy/CONTRACT.md` + `template.md`
