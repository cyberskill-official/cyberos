# `remote-policy-audit` — human summary format
...
```
REMOTE-POLICY audit batch complete

Audited N REMOTE-POLICY(s):
  - REMOTE-POLICY-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - REMOTE-POLICY-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - REMOTE-POLICY-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        remote-policy_rubric@1.0
