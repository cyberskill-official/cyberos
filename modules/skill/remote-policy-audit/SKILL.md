...
description: |
  Audit one or more existing remote-policy@1 markdowns against
  remote-policy_rubric@1.0. Produces a sibling .audit.md per artefact plus
