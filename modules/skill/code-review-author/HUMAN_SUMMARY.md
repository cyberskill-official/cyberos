# `code-review-author` — human summary format
...
```
CODE-REVIEW batch <batch_run_id> complete

Wrote N CODE-REVIEW(s):
  - CODE-REVIEW-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - CODE-REVIEW-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - CODE-REVIEW-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        code-review-audit will run automatically on PASS items. HITL items wait for your reply.
```
