...
> Sourced from `cyberos/docs/Software Development Process.md` §2(l) Project closure and §6 (consultancy considerations: offboarding pack). Rubric version `1.0` is locked.
...
- `cyberos/docs/Software Development Process.md` §2(l) — Closure source
- `cyberos/docs/Software Development Process.md` §6 — Offboarding pack source
