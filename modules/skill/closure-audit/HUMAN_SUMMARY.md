# `closure-audit` — human summary format
...
```
CLOSURE audit batch complete

Audited N CLOSURE(s):
  - CLOSURE-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - CLOSURE-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - CLOSURE-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        closure_rubric@1.0
