# `closure` audit-report format

Every `closure-audit` invocation writes a sibling `closure.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "closure_rubric@1.0"
audited_file:           "./closures/CLOSURE-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "closure_rubric@1.0"
