# `intellectual-property-strategy-author` — human summary format
...
```
IP_STRATEGY batch <batch_run_id> complete

Wrote N IP_STRATEGY(s):
  - IP_STRATEGY-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - IP_STRATEGY-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - IP_STRATEGY-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        intellectual-property-strategy-audit will run automatically on PASS items. HITL items wait for your reply.
```
