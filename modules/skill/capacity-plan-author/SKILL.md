...
description: |
  Author a quarterly capacity-plan rebase (per-team FTE × utilisation × backlog + new-work intake + utilisation forecast + hire/contract/defer recommendations). COO authored. Target utilisation 70-85% for consulting.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
