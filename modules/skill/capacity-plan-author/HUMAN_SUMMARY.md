# `capacity-plan-author` — human summary format
...
```
CAPACITY-PLAN batch <batch_run_id> complete

Wrote N CAPACITY-PLAN(s):
  - CAPACITY-PLAN-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - CAPACITY-PLAN-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - CAPACITY-PLAN-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        capacity-plan-audit will run automatically on PASS items. HITL items wait for your reply.
```
