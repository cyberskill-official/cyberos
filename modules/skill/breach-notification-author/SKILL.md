...
description: |
  Author a data-breach notification under regulatory deadline (incident summary + data classes exposed + affected subjects + regulator notification plan + data-subject notification plan + containment + remediation). CPO-Privacy + CISO + CLO co-authored. GDPR Art. 33 72h deadline.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
