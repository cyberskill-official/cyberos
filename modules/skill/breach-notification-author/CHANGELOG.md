...
- NATS event emission for `breach-notification_written`, `batch_complete`, `hitl_pause`.
...
- Self-audit passes on its own input set at 10/10 by `breach-notification-audit`.
