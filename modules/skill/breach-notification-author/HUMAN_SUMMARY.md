# `breach-notification-author` — human summary format
...
```
BREACH-NOTIFICATION batch <batch_run_id> complete

Wrote N BREACH-NOTIFICATION(s):
  - BREACH-NOTIFICATION-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - BREACH-NOTIFICATION-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - BREACH-NOTIFICATION-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        breach-notification-audit will run automatically on PASS items. HITL items wait for your reply.
```
