# `stage-gate-audit` — human summary format
...
```
STAGE-GATE audit batch complete

Audited N STAGE-GATE(s):
  - STAGE-GATE-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - STAGE-GATE-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - STAGE-GATE-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        stage-gate_rubric@1.0
