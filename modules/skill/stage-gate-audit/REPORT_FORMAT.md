# `stage-gate` audit-report format

Every `stage-gate-audit` invocation writes a sibling `stage-gate.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "stage-gate_rubric@1.0"
audited_file:           "./stage-gates/STAGE-GATE-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "stage-gate_rubric@1.0"
