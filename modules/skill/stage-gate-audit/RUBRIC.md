...
> Sourced from `../../../modules/cuo/docs/module.md` Template §4.3 (Stage-gate sign-off one-page). Rubric version `1.0` is locked.
...
- `../../../modules/cuo/docs/module.md` Template §4.3 — Stage-gate sign-off source
