# `pipeline-report` audit-report format

Every `pipeline-report-audit` invocation writes a sibling `pipeline-report.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "pipeline-report_rubric@1.0"
audited_file:           "./pipeline-reports/PIPELINE-REPORT-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "pipeline-report_rubric@1.0"
