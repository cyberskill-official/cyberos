# `pipeline-report-audit` — human summary format
...
```
PIPELINE-REPORT audit batch complete

Audited N PIPELINE-REPORT(s):
  - PIPELINE-REPORT-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - PIPELINE-REPORT-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - PIPELINE-REPORT-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        pipeline-report_rubric@1.0
