...
description: |
  Audit one or more existing pipeline-report@1 markdowns against
  pipeline-report_rubric@1.0. Produces a sibling .audit.md per artefact plus
