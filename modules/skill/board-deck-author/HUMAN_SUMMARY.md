# `board-deck-author` — human summary format
...
```
BOARD-DECK batch <batch_run_id> complete

Wrote N BOARD-DECK(s):
  - BOARD-DECK-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - BOARD-DECK-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - BOARD-DECK-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        board-deck-audit will run automatically on PASS items. HITL items wait for your reply.
```
