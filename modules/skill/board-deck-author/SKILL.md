...
description: |
  Author a quarterly board deck (10-15 slides) for the CEO or CFO. Renders executive summary + KPIs vs plan + strategic narrative + financial detail + risks + board asks. Validated by board-deck-audit.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
