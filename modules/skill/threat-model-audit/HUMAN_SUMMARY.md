# `threat-model-audit` — human summary format
...
```
THREAT-MODEL audit batch complete

Audited N THREAT-MODEL(s):
  - THREAT-MODEL-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - THREAT-MODEL-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - THREAT-MODEL-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        threat-model_rubric@1.0
