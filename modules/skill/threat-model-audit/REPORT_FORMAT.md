# `threat-model` audit-report format

Every `threat-model-audit` invocation writes a sibling `threat-model.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "threat-model_rubric@1.0"
audited_file:           "./threat-models/THREAT-MODEL-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "threat-model_rubric@1.0"
