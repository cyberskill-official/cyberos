# `contract-review-author` — human summary format
...
```
CONTRACT_REVIEW batch <batch_run_id> complete

Wrote N CONTRACT_REVIEW(s):
  - CONTRACT_REVIEW-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - CONTRACT_REVIEW-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - CONTRACT_REVIEW-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        contract-review-audit will run automatically on PASS items. HITL items wait for your reply.
```
