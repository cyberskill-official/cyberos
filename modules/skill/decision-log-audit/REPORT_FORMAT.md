# `decision-log` audit-report format

Every `decision-log-audit` invocation writes a sibling `decision-log.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "decision-log_rubric@1.0"
audited_file:           "./decision-logs/DECISION-LOG-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "decision-log_rubric@1.0"
