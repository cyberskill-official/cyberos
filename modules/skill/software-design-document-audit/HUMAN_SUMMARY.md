# `software-design-document-audit` — human summary format
...
```
SDD audit batch complete

Audited N SDD(s):
  - SDD-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - SDD-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - SDD-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        sdd_rubric@1.0
