# `sdd` audit-report format

Every `software-design-document-audit` invocation writes a sibling `sdd.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "sdd_rubric@1.0"
audited_file:           "./sdds/SDD-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "sdd_rubric@1.0"
