# `happiness-program` audit-report format

Every `happiness-program-audit` invocation writes a sibling `happiness-program.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "happiness-program_rubric@1.0"
audited_file:           "./happiness-programs/HAPPINESS-PROGRAM-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "happiness-program_rubric@1.0"
