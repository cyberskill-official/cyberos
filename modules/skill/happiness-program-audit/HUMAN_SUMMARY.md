# `happiness-program-audit` — human summary format
...
```
HAPPINESS-PROGRAM audit batch complete

Audited N HAPPINESS-PROGRAM(s):
  - HAPPINESS-PROGRAM-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - HAPPINESS-PROGRAM-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - HAPPINESS-PROGRAM-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        happiness-program_rubric@1.0
