...
description: |
  Audit one or more existing happiness-program@1 markdowns against
  happiness-program_rubric@1.0. Produces a sibling .audit.md per artefact plus
