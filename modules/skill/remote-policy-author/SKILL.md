...
description: |
  Author the annual remote/hybrid work policy (eligibility + arrangement types + tooling standards + meeting norms + tax/legal implications + culture rituals + performance reviews). GitLab Remote Manifesto + Buffer/Doist/Automattic patterns. Chief Remote Officer or CHRO authored.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
