# `program_charter_rubric@1.0` — machine-checkable Program Charter rubric
...
| `FM-004` | `template` equals `program-charter@1` | error | true |
...
Per the `contracts/program-charter/template.md` H2 list — every H2 in template MUST be present + non-empty in the authored artefact.

| rule_id | Check | Severity |
| ------- | ----- | -------- |
| `SEC-001` | Every H2 declared in `contracts/program-charter/template.md` is present in the authored artefact | error |
...
- `cyberos/skill/contracts/program-charter/CONTRACT.md` + `template.md`
