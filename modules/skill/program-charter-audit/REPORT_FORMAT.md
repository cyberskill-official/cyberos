# `program-charter` audit-report format

Every `program-charter-audit` invocation writes a sibling `program-charter.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "program-charter_rubric@1.0"
audited_file:           "./program-charters/PROGRAM-CHARTER-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "program-charter_rubric@1.0"
