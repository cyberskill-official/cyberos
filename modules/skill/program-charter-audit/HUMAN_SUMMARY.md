# `program-charter-audit` — human summary format
...
```
PROGRAM-CHARTER audit batch complete

Audited N PROGRAM-CHARTER(s):
  - PROGRAM-CHARTER-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - PROGRAM-CHARTER-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - PROGRAM-CHARTER-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        program-charter_rubric@1.0
