...
description: |
  Audit one or more existing program-charter@1 markdowns against
  program-charter_rubric@1.0. Produces a sibling .audit.md per artefact plus
