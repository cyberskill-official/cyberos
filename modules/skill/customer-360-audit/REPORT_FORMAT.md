# `customer-360` audit-report format

Every `customer-360-audit` invocation writes a sibling `customer-360.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "customer-360_rubric@1.0"
audited_file:           "./customer-360s/CUSTOMER_360-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "customer-360_rubric@1.0"
