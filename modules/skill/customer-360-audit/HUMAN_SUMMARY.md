# `customer-360-audit` — human summary format
...
```
CUSTOMER_360 audit batch complete

Audited N CUSTOMER_360(s):
  - CUSTOMER_360-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - CUSTOMER_360-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - CUSTOMER_360-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        customer-360_rubric@1.0
