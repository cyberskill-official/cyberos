# customer-360_rubric@1.0 — compact universal rubric
...
| FM-002 | `artefact_type` matches `customer-360@1` |
...
| ID | Rule |
|---|---|
| SEC-001 | Every H2 in `contracts/customer-360/template.md` is present in the authored artefact |
