# `hire-decision-author` — human summary format
...
```
HIRE-DECISION batch <batch_run_id> complete

Wrote N HIRE-DECISION(s):
  - HIRE-DECISION-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - HIRE-DECISION-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - HIRE-DECISION-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        hire-decision-audit will run automatically on PASS items. HITL items wait for your reply.
```
