...
description: |
  Author a C-suite hire decision record for board reporting. Renders role spec + candidate slate + interview-loop verdicts + offer terms + risks + decision rationale. CEO + CHRO co-authored.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
