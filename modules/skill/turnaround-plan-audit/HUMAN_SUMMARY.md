# `turnaround-plan-audit` — human summary format
...
```
TURNAROUND-PLAN audit batch complete

Audited N TURNAROUND-PLAN(s):
  - TURNAROUND-PLAN-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - TURNAROUND-PLAN-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - TURNAROUND-PLAN-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        turnaround-plan_rubric@1.0
