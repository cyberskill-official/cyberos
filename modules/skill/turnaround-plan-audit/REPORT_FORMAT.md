# `turnaround-plan` audit-report format

Every `turnaround-plan-audit` invocation writes a sibling `turnaround-plan.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "turnaround-plan_rubric@1.0"
audited_file:           "./turnaround-plans/TURNAROUND-PLAN-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "turnaround-plan_rubric@1.0"
