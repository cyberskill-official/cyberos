...
description: |
  Audit one or more existing turnaround-plan@1 markdowns against
  turnaround-plan_rubric@1.0. Produces a sibling .audit.md per artefact plus
