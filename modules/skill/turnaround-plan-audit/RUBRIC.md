# `turnaround_plan_rubric@1.0` — machine-checkable Turnaround Plan rubric
...
| `FM-004` | `template` equals `turnaround-plan@1` | error | true |
...
Per the `contracts/turnaround-plan/template.md` H2 list.
...
- `cyberos/skill/contracts/turnaround-plan/CONTRACT.md` + `template.md`
