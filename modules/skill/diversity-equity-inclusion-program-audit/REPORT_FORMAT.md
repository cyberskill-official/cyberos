...
Every `diversity-equity-inclusion-program-audit` invocation writes a sibling `dei-program.audit.md` per audited artefact. The report format below is normative.
