# `dei_program_rubric@1.0` — machine-checkable DEI Program rubric
...
| `FM-004` | `template` equals `diversity-equity-inclusion-program@1` | error | true |
...
Per the `contracts/diversity-equity-inclusion-program/template.md` H2 list. Each H2 in the template MUST be present + non-empty in the authored artefact. See template for the canonical headings.

| rule_id | Check | Severity |
| ------- | ----- | -------- |
| `SEC-001` | Every H2 declared in `contracts/diversity-equity-inclusion-program/template.md` is present in the authored artefact | error |
...
- `cyberos/skill/contracts/diversity-equity-inclusion-program/CONTRACT.md` + `template.md`
