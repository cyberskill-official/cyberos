# `diversity-equity-inclusion-program-audit` — human summary format
...
```
DEI-PROGRAM audit batch complete

Audited N DEI-PROGRAM(s):
  - DEI-PROGRAM-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - DEI-PROGRAM-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - DEI-PROGRAM-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        dei-program_rubric@1.0
