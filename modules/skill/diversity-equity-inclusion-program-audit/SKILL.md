...
description: |
  Audit one or more existing diversity-equity-inclusion-program@1 markdowns against
  dei-program_rubric@1.0. Produces a sibling .audit.md per artefact plus
  ...
  diversity-equity-inclusion-program-author.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
