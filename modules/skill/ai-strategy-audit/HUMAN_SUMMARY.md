# `ai-strategy-audit` — human summary format
...
```
AI_STRATEGY audit batch complete

Audited N AI_STRATEGY(s):
  - AI_STRATEGY-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - AI_STRATEGY-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - AI_STRATEGY-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        ai-strategy_rubric@1.0
