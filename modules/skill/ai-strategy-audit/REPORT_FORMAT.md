# `ai-strategy` audit-report format

Every `ai-strategy-audit` invocation writes a sibling `ai-strategy.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "ai-strategy_rubric@1.0"
audited_file:           "./ai-strategys/AI_STRATEGY-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "ai-strategy_rubric@1.0"
