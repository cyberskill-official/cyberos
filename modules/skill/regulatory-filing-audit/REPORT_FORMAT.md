# `regulatory-filing` audit-report format

Every `regulatory-filing-audit` invocation writes a sibling `regulatory-filing.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "regulatory-filing_rubric@1.0"
audited_file:           "./regulatory-filings/REGULATORY_FILING-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "regulatory-filing_rubric@1.0"
