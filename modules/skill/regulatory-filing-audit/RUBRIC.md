# regulatory-filing_rubric@1.0 — compact universal rubric
...
| FM-002 | `artefact_type` matches `regulatory-filing@1` |
...
| ID | Rule |
|---|---|
| SEC-001 | Every H2 in `contracts/regulatory-filing/template.md` is present in the authored artefact |
