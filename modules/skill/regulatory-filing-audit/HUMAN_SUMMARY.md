# `regulatory-filing-audit` — human summary format
...
```
REGULATORY_FILING audit batch complete

Audited N REGULATORY_FILING(s):
  - REGULATORY_FILING-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - REGULATORY_FILING-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - REGULATORY_FILING-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        regulatory-filing_rubric@1.0
