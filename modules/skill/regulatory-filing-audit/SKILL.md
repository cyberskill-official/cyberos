...
description: Audits a regulatory-filing@1 artefact against regulatory_filing_rubric@1.0. Validates FM + SEC structure with regulator-specific section ordering (SEC 10-K Items 1-15 / FDA IND CTD modules / AI Act Annex IV / GDPR Art. 33 / Vietnam Decree 13/2023 PDPD), material-disclosure sourcing, and exhibit cross-references.
  Audit one or more existing regulatory-filing@1 markdowns against
  regulatory-filing_rubric@1.0. Produces a sibling .audit.md per artefact plus
