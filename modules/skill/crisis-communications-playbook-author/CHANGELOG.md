...
- NATS event emission for `crisis-comms-playbook_written`, `batch_complete`, `hitl_pause`.
...
- Self-audit passes on its own input set at 10/10 by `crisis-communications-playbook-audit`.
