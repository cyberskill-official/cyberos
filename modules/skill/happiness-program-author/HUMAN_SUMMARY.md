# `happiness-program-author` — human summary format
...
```
HAPPINESS-PROGRAM batch <batch_run_id> complete

Wrote N HAPPINESS-PROGRAM(s):
  - HAPPINESS-PROGRAM-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - HAPPINESS-PROGRAM-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - HAPPINESS-PROGRAM-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        happiness-program-audit will run automatically on PASS items. HITL items wait for your reply.
```
