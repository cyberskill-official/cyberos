...
description: |
  Author the quarterly happiness program (culture rituals + perks + community engagement + survey results + action plan + budget). Officevibe/TINYpulse/Culture Amp survey patterns + Shawn Achor 'The Happiness Advantage'. Chief Happiness Officer authored.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
