# `rhythm-of-business-audit` — human summary format
...
```
RHYTHM-OF-BUSINESS audit batch complete

Audited N RHYTHM-OF-BUSINESS(s):
  - RHYTHM-OF-BUSINESS-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - RHYTHM-OF-BUSINESS-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - RHYTHM-OF-BUSINESS-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        rhythm-of-business_rubric@1.0
