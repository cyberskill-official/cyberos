# `rhythm_of_business_rubric@1.0` — machine-checkable Rhythm of Business rubric
...
| `FM-004` | `template` equals `rhythm-of-business@1` | error | true |
...
Per the `contracts/rhythm-of-business/template.md` H2 list. Each H2 in the template MUST be present + non-empty in the authored artefact. See template for the canonical headings.

| rule_id | Check | Severity |
| ------- | ----- | -------- |
| `SEC-001` | Every H2 declared in `contracts/rhythm-of-business/template.md` is present in the authored artefact | error |
...
- `cyberos/skill/contracts/rhythm-of-business/CONTRACT.md` + `template.md`
