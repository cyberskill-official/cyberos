---
# ── Identity ─────────────────────────────────────────────────────────
name: rhythm-of-business-audit
description: >-
  Audit one or more existing rhythm-of-business@1 markdowns against rhythm-of-business_rubric@1.0. Produces a sibling .audit.md per artefact plus an AUDIT_BATCH_SUMMARY. Halts on needs_human verdicts; resumable on audited_file_sha256. Standalone trigger or chains naturally after rhythm-of-business-author. Use when user asks to "audit this rhythm of business" or "check the rhythm of business". Do NOT use for "draft a new rhythm of business" (use rhythm-of-business-author instead).
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
  stage: cross
  cyberos-template: rhythm-of-business@1
  cyberos-rubric-version: rhythm-of-business_rubric@1.0
...
depends_on_contracts:
  - id:        rhythm-of-business
    ...
    pin_path:  cyberos/skill/contracts/rhythm-of-business/
  - id:        nats-subjects
    version:   v1
...
# rhythm-of-business-audit — RHYTHM-OF-BUSINESS auditor

> Standalone trigger that runs `rhythm-of-business_rubric@1.0` against one or
> more existing `rhythm-of-business@1` markdowns and writes a sibling
> `rhythm-of-business.audit.md` per item. Halts on `needs_human` verdicts via
> the standard Question primitive; resumable on `audited_file_sha256`.
> Chains naturally after [`rhythm-of-business-author`](../rhythm-of-business-author/SKILL.md).

`prompt_revision: rhythm-of-business_audit@1.0.0`

## When to invoke this skill

CUO routes a request here when the user wants to:

- "Audit these existing `RHYTHM-OF-BUSINESS`s."
- "Has `RHYTHM-OF-BUSINESS-007` changed since the last audit?"
- "Tell me which `RHYTHM-OF-BUSINESS`s would fail acceptance today."

Also invoked automatically by the supervisor when `rhythm-of-business-author`'s output envelope sets `next_skill_recommendation: rhythm-of-business-audit` (the default chain).
...
skill_version:                   1.0.0
prompt_revision:                 rhythm-of-business_audit@1.0.0
template_version:                rhythm-of-business@1   (loaded from cyberos/skill/contracts/rhythm-of-business/template.md)
audit_rubric_version:            rhythm-of-business_rubric@1.0
...
```json
{
  "artefact_paths": ["./rhythm-of-businesss/RHYTHM-OF-BUSINESS-001-foo.md", "./rhythm-of-businesss/RHYTHM-OF-BUSINESS-002-bar.md"],
  "caller_persona": "cuo-cpo",
  "trace_id": "<uuid>",
  "upstream_context": {
    "from_skill": "rhythm-of-business-author",
    "manifest_path": "./rhythm-of-businesss/manifest.json"
  }
}
```
...
```json
{
  ...
  "exit_code": 1,
  "per_artefact": [
    {"artefact_path": "./rhythm-of-businesss/RHYTHM-OF-BUSINESS-001-foo.md", "audit_path": "./rhythm-of-businesss/RHYTHM-OF-BUSINESS-001-foo.audit.md", "status": "pass", "iterations": 1, "audited_file_sha256": "<hex>"},
    {"artefact_path": "./rhythm-of-businesss/RHYTHM-OF-BUSINESS-002-bar.md", "audit_path": "./rhythm-of-businesss/RHYTHM-OF-BUSINESS-002-bar.audit.md", "status": "needs_human", "iterations": 3, "audited_file_sha256": "<hex>"}
  ],
  "hitl_required": true,
...
```
Persona: cuo-cpo
Skill:   rhythm-of-business-audit
Input:
  artefact_paths:  [./team-a/RHYTHM-OF-BUSINESS-001-something.md, ./team-b/RHYTHM-OF-BUSINESS-018-other.md]
  caller_persona:  cuo-cpo
  trace_id:        <uuid>
