# `rhythm-of-business` audit-report format

Every `rhythm-of-business-audit` invocation writes a sibling `rhythm-of-business.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "rhythm-of-business_rubric@1.0"
audited_file:           "./rhythm-of-businesss/RHYTHM-OF-BUSINESS-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "rhythm-of-business_rubric@1.0"
