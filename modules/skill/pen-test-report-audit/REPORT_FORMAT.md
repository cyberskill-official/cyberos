# `pen-test-report` audit-report format

Every `pen-test-report-audit` invocation writes a sibling `pen-test-report.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "pen-test-report_rubric@1.0"
audited_file:           "./pen-test-reports/PEN_TEST_REPORT-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "pen-test-report_rubric@1.0"
