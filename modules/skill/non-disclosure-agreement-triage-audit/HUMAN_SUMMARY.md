# `non-disclosure-agreement-triage-audit` — human summary format
...
```
NDA_TRIAGE audit batch complete

Audited N NDA_TRIAGE(s):
  - NDA_TRIAGE-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - NDA_TRIAGE-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - NDA_TRIAGE-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        nda-triage_rubric@1.0
