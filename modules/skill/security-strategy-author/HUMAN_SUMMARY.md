# `security-strategy-author` — human summary format
...
```
SECURITY_STRATEGY batch <batch_run_id> complete

Wrote N SECURITY_STRATEGY(s):
  - SECURITY_STRATEGY-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - SECURITY_STRATEGY-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - SECURITY_STRATEGY-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        security-strategy-audit will run automatically on PASS items. HITL items wait for your reply.
```
