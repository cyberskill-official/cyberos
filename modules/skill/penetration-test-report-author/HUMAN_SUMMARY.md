# `penetration-test-report-author` — human summary format
...
```
PEN_TEST_REPORT batch <batch_run_id> complete

Wrote N PEN_TEST_REPORT(s):
  - PEN_TEST_REPORT-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - PEN_TEST_REPORT-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - PEN_TEST_REPORT-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        penetration-test-report-audit will run automatically on PASS items. HITL items wait for your reply.
```
