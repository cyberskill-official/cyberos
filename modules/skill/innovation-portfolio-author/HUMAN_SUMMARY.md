# `innovation-portfolio-author` — human summary format
...
```
INNOVATION-PORTFOLIO batch <batch_run_id> complete

Wrote N INNOVATION-PORTFOLIO(s):
  - INNOVATION-PORTFOLIO-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - INNOVATION-PORTFOLIO-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - INNOVATION-PORTFOLIO-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        innovation-portfolio-audit will run automatically on PASS items. HITL items wait for your reply.
```
