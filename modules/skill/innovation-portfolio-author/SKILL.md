...
description: |
  Author the quarterly innovation portfolio review (portfolio summary + ventures by horizon H1/H2/H3 + per-venture status + go/kill/scale recommendations + portfolio metrics + pipeline coverage). McKinsey Three Horizons + Govindarajan Ten Types. Chief Innovation Officer authored.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
