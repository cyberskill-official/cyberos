...
- NATS event emission for `nda-triage_written`, `batch_complete`, `hitl_pause`.
...
- Self-audit passes on its own input set at 10/10 by `non-disclosure-agreement-triage-audit`.
