# `non-disclosure-agreement-triage-author` — human summary format
...
```
NDA_TRIAGE batch <batch_run_id> complete

Wrote N NDA_TRIAGE(s):
  - NDA_TRIAGE-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - NDA_TRIAGE-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - NDA_TRIAGE-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        non-disclosure-agreement-triage-audit will run automatically on PASS items. HITL items wait for your reply.
```
