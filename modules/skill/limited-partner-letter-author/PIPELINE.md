...
- `cyberos/skill/contracts/limited-partner-letter/` — the artefact template this skill generates.
- `cyberos/skill/contracts/nats-subjects/` — the NATS subject naming contract.
- `cyberos/skill/limited-partner-letter-audit/` — the sibling audit skill that validates this skill's output.
