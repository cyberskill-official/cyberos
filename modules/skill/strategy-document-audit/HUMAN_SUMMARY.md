# `strategy-document-audit` — human summary format
...
```
STRATEGY-DOC audit batch complete

Audited N STRATEGY-DOC(s):
  - STRATEGY-DOC-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - STRATEGY-DOC-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - STRATEGY-DOC-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        strategy-doc_rubric@1.0
