...
description: |
  Audit one or more existing strategy-document@1 markdowns against
  strategy-doc_rubric@1.0. Produces a sibling .audit.md per artefact plus
