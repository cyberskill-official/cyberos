# `bias-audit` audit-report format

Every `bias-audit-audit` invocation writes a sibling `bias-audit.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "bias-audit_rubric@1.0"
audited_file:           "./bias-audits/BIAS-AUDIT-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "bias-audit_rubric@1.0"
