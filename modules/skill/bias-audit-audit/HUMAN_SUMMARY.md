# `bias-audit-audit` — human summary format
...
```
BIAS-AUDIT audit batch complete

Audited N BIAS-AUDIT(s):
  - BIAS-AUDIT-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - BIAS-AUDIT-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - BIAS-AUDIT-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        bias-audit_rubric@1.0
