...
Every `litigation-mgmt-update-audit` invocation writes a sibling `litigation-mgmt-update.audit.md` per audited artefact. The report format below is normative.
