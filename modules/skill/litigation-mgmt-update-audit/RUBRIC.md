...
| FM-002 | `artefact_type` matches `litigation-mgmt-update@1` |
...
| ID | Rule |
|---|---|
| SEC-001 | Every H2 in `contracts/litigation-mgmt-update/template.md` is present in the authored artefact |
