# `clinical-protocol-author` — human summary format
...
```
CLINICAL-PROTOCOL batch <batch_run_id> complete

Wrote N CLINICAL-PROTOCOL(s):
  - CLINICAL-PROTOCOL-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - CLINICAL-PROTOCOL-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - CLINICAL-PROTOCOL-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        clinical-protocol-audit will run automatically on PASS items. HITL items wait for your reply.
```
