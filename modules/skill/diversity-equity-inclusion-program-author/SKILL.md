...
description: |
  Author the annual DEI / Inclusion & Belonging program (current representation + promotion parity + inclusion survey + ERG support + inclusive hiring + program goals + budget). CDO-Diversity or CHRO authored.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
