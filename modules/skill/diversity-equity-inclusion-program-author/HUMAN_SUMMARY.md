# `diversity-equity-inclusion-program-author` — human summary format
...
```
DEI-PROGRAM batch <batch_run_id> complete

Wrote N DEI-PROGRAM(s):
  - DEI-PROGRAM-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - DEI-PROGRAM-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - DEI-PROGRAM-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        diversity-equity-inclusion-program-audit will run automatically on PASS items. HITL items wait for your reply.
```
