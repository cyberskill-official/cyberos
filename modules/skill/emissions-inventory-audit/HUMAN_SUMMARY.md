# `emissions-inventory-audit` — human summary format
...
```
EMISSIONS-INVENTORY audit batch complete

Audited N EMISSIONS-INVENTORY(s):
  - EMISSIONS-INVENTORY-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - EMISSIONS-INVENTORY-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - EMISSIONS-INVENTORY-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        emissions-inventory_rubric@1.0
