# `emissions-inventory` audit-report format

Every `emissions-inventory-audit` invocation writes a sibling `emissions-inventory.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "emissions-inventory_rubric@1.0"
audited_file:           "./emissions-inventorys/EMISSIONS-INVENTORY-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "emissions-inventory_rubric@1.0"
