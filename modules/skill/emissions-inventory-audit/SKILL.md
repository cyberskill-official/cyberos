...
description: |
  Audit one or more existing emissions-inventory@1 markdowns against
  emissions-inventory_rubric@1.0. Produces a sibling .audit.md per artefact plus
