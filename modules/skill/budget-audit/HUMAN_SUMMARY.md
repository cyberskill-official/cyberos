# `budget-audit` — human summary format
...
```
BUDGET audit batch complete

Audited N BUDGET(s):
  - BUDGET-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - BUDGET-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - BUDGET-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        budget_rubric@1.0
