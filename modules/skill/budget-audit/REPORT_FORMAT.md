# `budget` audit-report format

Every `budget-audit` invocation writes a sibling `budget.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "budget_rubric@1.0"
audited_file:           "./budgets/BUDGET-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "budget_rubric@1.0"
