# `internal-newsletter-audit` — human summary format
...
```
INTERNAL-NEWSLETTER audit batch complete

Audited N INTERNAL-NEWSLETTER(s):
  - INTERNAL-NEWSLETTER-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - INTERNAL-NEWSLETTER-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - INTERNAL-NEWSLETTER-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        internal-newsletter_rubric@1.0
