# `internal-newsletter` audit-report format

Every `internal-newsletter-audit` invocation writes a sibling `internal-newsletter.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "internal-newsletter_rubric@1.0"
audited_file:           "./internal-newsletters/INTERNAL-NEWSLETTER-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "internal-newsletter_rubric@1.0"
