# `internal_newsletter_rubric@1.0` — machine-checkable Internal Newsletter rubric
...
| `FM-004` | `template` equals `internal-newsletter@1` | error | true |
...
Per the `contracts/internal-newsletter/template.md` H2 list — every H2 in template MUST be present + non-empty in the authored artefact.

| rule_id | Check | Severity |
| ------- | ----- | -------- |
| `SEC-001` | Every H2 declared in `contracts/internal-newsletter/template.md` is present in the authored artefact | error |
...
- `cyberos/skill/contracts/internal-newsletter/CONTRACT.md` + `template.md`
