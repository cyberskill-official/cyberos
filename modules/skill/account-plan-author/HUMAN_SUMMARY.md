# `account-plan-author` — human summary format
...
```
ACCOUNT-PLAN batch <batch_run_id> complete

Wrote N ACCOUNT-PLAN(s):
  - ACCOUNT-PLAN-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - ACCOUNT-PLAN-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - ACCOUNT-PLAN-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        account-plan-audit will run automatically on PASS items. HITL items wait for your reply.
```
