...
description: |
  Author a per-strategic-account plan (context + org chart + current spend + expansion thesis + threats + quarterly action plan + executive sponsor coverage). CRO-Revenue or CCO-Customer authored.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
