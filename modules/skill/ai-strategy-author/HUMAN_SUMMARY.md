# `ai-strategy-author` — human summary format
...
```
AI_STRATEGY batch <batch_run_id> complete

Wrote N AI_STRATEGY(s):
  - AI_STRATEGY-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - AI_STRATEGY-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - AI_STRATEGY-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        ai-strategy-audit will run automatically on PASS items. HITL items wait for your reply.
```
