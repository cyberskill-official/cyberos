...
> Sourced from `../../../modules/cuo/docs/module.md` §2(d) System architecture and high-level design; Michael Nygard's ADR format; arc42 documentation; ISO/IEC 25010:2023 portability/maintainability sub-characteristics. Rubric version `1.0` is locked.
...
| `FM-004` | `template` key present and equals `architecture-decision-record@1` | error | true |
...
- `../../../modules/cuo/docs/module.md` §2(d) — Architecture stage source
