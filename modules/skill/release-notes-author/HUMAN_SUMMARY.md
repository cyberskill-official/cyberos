# `release-notes-author` — human summary format
...
```
RELEASE-NOTES batch <batch_run_id> complete

Wrote N RELEASE-NOTES(s):
  - RELEASE-NOTES-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - RELEASE-NOTES-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - RELEASE-NOTES-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        release-notes-audit will run automatically on PASS items. HITL items wait for your reply.
```
