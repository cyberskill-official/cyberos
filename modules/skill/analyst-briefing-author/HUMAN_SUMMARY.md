# `analyst-briefing-author` — human summary format
...
```
ANALYST-BRIEFING batch <batch_run_id> complete

Wrote N ANALYST-BRIEFING(s):
  - ANALYST-BRIEFING-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - ANALYST-BRIEFING-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - ANALYST-BRIEFING-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        analyst-briefing-audit will run automatically on PASS items. HITL items wait for your reply.
```
