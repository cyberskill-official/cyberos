# `budget-author` — human summary format
...
```
BUDGET batch <batch_run_id> complete

Wrote N BUDGET(s):
  - BUDGET-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - BUDGET-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - BUDGET-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        budget-audit will run automatically on PASS items. HITL items wait for your reply.
```
