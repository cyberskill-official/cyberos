# `decommissioning-audit` — fine-tune discipline override

Default discipline at `../docs/FINE_TUNE.md`. This file documents the **decommissioning-audit-specific overrides**.

## Why decommissioning-audit is different
...
- `../decommissioning-author/` — the sibling skill.
