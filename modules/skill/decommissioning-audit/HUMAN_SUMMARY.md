# `decommissioning-audit` — human summary format
...
```
DECOMM audit batch complete

Audited N DECOMM(s):
  - DECOMM-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - DECOMM-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - DECOMM-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        decomm_rubric@1.0
