# `decomm` audit-report format

Every `decommissioning-audit` invocation writes a sibling `decomm.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "decomm_rubric@1.0"
audited_file:           "./decomms/DECOMM-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "decomm_rubric@1.0"
