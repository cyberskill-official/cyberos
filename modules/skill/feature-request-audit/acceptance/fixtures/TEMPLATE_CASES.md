# feature-request-audit - template-detection cases (FR-CUO-208 AC 3/4/5/7)

Executable case table; fixtures inline below (each case: detection -> families -> expected verdict).

| case | fixture | detected | expected |
|---|---|---|---|
| TC-01 | fr1-missing-alternatives (below) | feature_request@1 (template key) | fail SEC-004 |
...
| TC-05 | same interview authored twice (author AC 3) | n/a | engineering-spec output carries §1..§11 + end marker; feature_request output carries SEC-001..007 sections + FM fields |
