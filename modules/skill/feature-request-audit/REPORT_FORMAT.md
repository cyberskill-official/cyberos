...
Every `feature-request-audit` invocation writes a sibling `fr.audit.md` per audited artefact. The report format below is normative.
...
audited_file:           "./frs/FR-001-foo.md"
