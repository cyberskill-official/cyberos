...
- `AUTHORING_DISCIPLINE.md` — operator-side FR-authoring discipline this rubric audits (absorbed 2026-05-18 from the former `docs/feature-requests/AUTHORING.md`).
