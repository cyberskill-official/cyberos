...
description: |
  Author the monthly internal newsletter (CEO note + wins + announcements + team spotlights + upcoming dates + prior-month Q&A + one-click reply). CCO-Communications + Chief of Staff co-authored.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
