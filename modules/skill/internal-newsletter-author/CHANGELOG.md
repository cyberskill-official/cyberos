...
- NATS event emission for `internal-newsletter_written`, `batch_complete`, `hitl_pause`.
...
- Self-audit passes on its own input set at 10/10 by `internal-newsletter-audit`.
