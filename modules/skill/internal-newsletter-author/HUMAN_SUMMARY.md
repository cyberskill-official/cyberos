# `internal-newsletter-author` — human summary format
...
```
INTERNAL-NEWSLETTER batch <batch_run_id> complete

Wrote N INTERNAL-NEWSLETTER(s):
  - INTERNAL-NEWSLETTER-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - INTERNAL-NEWSLETTER-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - INTERNAL-NEWSLETTER-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        internal-newsletter-audit will run automatically on PASS items. HITL items wait for your reply.
```
