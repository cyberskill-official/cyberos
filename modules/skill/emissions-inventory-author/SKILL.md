...
description: |
  Author the quarterly Scope 1/2/3 emissions inventory (per-scope emissions + calculation methodology + data sources + verification status + year-over-year delta). GHG Protocol Corporate Standard. CSO-Sustainability authored.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
