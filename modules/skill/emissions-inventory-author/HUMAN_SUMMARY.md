# `emissions-inventory-author` — human summary format
...
```
EMISSIONS-INVENTORY batch <batch_run_id> complete

Wrote N EMISSIONS-INVENTORY(s):
  - EMISSIONS-INVENTORY-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - EMISSIONS-INVENTORY-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - EMISSIONS-INVENTORY-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        emissions-inventory-audit will run automatically on PASS items. HITL items wait for your reply.
```
