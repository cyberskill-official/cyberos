# `capital-allocation-memo-author` — human summary format
...
```
CAP-ALLOC-MEMO batch <batch_run_id> complete

Wrote N CAP-ALLOC-MEMO(s):
  - CAP-ALLOC-MEMO-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - CAP-ALLOC-MEMO-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - CAP-ALLOC-MEMO-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        capital-allocation-memo-audit will run automatically on PASS items. HITL items wait for your reply.
```
