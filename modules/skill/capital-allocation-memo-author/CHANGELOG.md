...
- NATS event emission for `cap-alloc-memo_written`, `batch_complete`, `hitl_pause`.
...
- Self-audit passes on its own input set at 10/10 by `capital-allocation-memo-audit`.
