...
description: |
  Author a capital-allocation memo for board approval (buy vs build vs partner vs M&A). Renders decision + options analysed + financial model + strategic fit + risks + recommendation. CEO + CFO co-authored.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
