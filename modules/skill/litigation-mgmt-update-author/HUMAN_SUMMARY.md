# `litigation-mgmt-update-author` — human summary format
...
Next:        litigation-mgmt-update-audit will run automatically on PASS items. HITL items wait for your reply.
```
