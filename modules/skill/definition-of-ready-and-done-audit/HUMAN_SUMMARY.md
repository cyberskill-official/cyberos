# `definition-of-ready-and-done-audit` — human summary format
...
```
DOR-DOD audit batch complete

Audited N DOR-DOD(s):
  - DOR-DOD-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - DOR-DOD-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - DOR-DOD-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        dor-dod_rubric@1.0
