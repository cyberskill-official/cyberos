---
# ── Identity ─────────────────────────────────────────────────────────
name: definition-of-ready-and-done-audit
description: >-
  Audit one or more existing definition-of-ready-and-done@1 markdowns against dor-dod_rubric@1.0. Produces a sibling .audit.md per artefact plus an AUDIT_BATCH_SUMMARY. Halts on needs_human verdicts; resumable on audited_file_sha256. Standalone trigger or chains naturally after definition-of-ready-and-done-author. Use when user asks to "audit this definition of ready and done" or "check the definition of ready and done". Do NOT use for "draft a new definition of ready and done" (use definition-of-ready-and-done-author instead).
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
  stage: b
  cyberos-template: definition-of-ready-and-done@1
  cyberos-rubric-version: dor_dod_rubric@1.0
...
depends_on_contracts:
  - id:        dor-dod
    ...
    pin_path:  cyberos/skill/contracts/definition-of-ready-and-done/
  - id:        nats-subjects
    version:   v1
...
# definition-of-ready-and-done-audit — DOR-DOD auditor

> Standalone trigger that runs `dor-dod_rubric@1.0` against one or
> more existing `definition-of-ready-and-done@1` markdowns and writes a sibling
> `dor-dod.audit.md` per item. Halts on `needs_human` verdicts via
> the standard Question primitive; resumable on `audited_file_sha256`.
> Chains naturally after [`definition-of-ready-and-done-author`](../definition-of-ready-and-done-author/SKILL.md).

`prompt_revision: dor-dod_audit@1.0.0`

## When to invoke this skill

CUO routes a request here when the user wants to:

- "Audit these existing `DOR-DOD`s."
- "Has `DOR-DOD-007` changed since the last audit?"
- "Tell me which `DOR-DOD`s would fail acceptance today."

Also invoked automatically by the supervisor when `definition-of-ready-and-done-author`'s output envelope sets `next_skill_recommendation: definition-of-ready-and-done-audit` (the default chain).
...
skill_version:                   1.0.0
prompt_revision:                 dor-dod_audit@1.0.0
template_version:                definition-of-ready-and-done@1   (loaded from cyberos/skill/contracts/definition-of-ready-and-done/template.md)
audit_rubric_version:            dor-dod_rubric@1.0
...
```json
{
  "artefact_paths": ["./dor-dods/DOR-DOD-001-foo.md", "./dor-dods/DOR-DOD-002-bar.md"],
  "caller_persona": "cuo-cpo",
  "trace_id": "<uuid>",
  "upstream_context": {
    "from_skill": "definition-of-ready-and-done-author",
    "manifest_path": "./dor-dods/manifest.json"
  }
}
```
...
```json
{
  ...
  "exit_code": 1,
  "per_artefact": [
    {"artefact_path": "./dor-dods/DOR-DOD-001-foo.md", "audit_path": "./dor-dods/DOR-DOD-001-foo.audit.md", "status": "pass", "iterations": 1, "audited_file_sha256": "<hex>"},
    {"artefact_path": "./dor-dods/DOR-DOD-002-bar.md", "audit_path": "./dor-dods/DOR-DOD-002-bar.audit.md", "status": "needs_human", "iterations": 3, "audited_file_sha256": "<hex>"}
  ],
  "hitl_required": true,
...
```
Persona: cuo-cpo
Skill:   definition-of-ready-and-done-audit
Input:
  artefact_paths:  [./team-a/DOR-DOD-001-something.md, ./team-b/DOR-DOD-018-other.md]
  caller_persona:  cuo-cpo
  trace_id:        <uuid>
