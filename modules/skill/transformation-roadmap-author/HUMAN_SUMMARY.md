# `transformation-roadmap-author` — human summary format
...
```
TRANSFORMATION-ROADMAP batch <batch_run_id> complete

Wrote N TRANSFORMATION-ROADMAP(s):
  - TRANSFORMATION-ROADMAP-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - TRANSFORMATION-ROADMAP-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - TRANSFORMATION-ROADMAP-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        transformation-roadmap-audit will run automatically on PASS items. HITL items wait for your reply.
```
