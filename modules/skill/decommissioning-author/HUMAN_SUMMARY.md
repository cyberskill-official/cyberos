# `decommissioning-author` — human summary format
...
```
DECOMM batch <batch_run_id> complete

Wrote N DECOMM(s):
  - DECOMM-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - DECOMM-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - DECOMM-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        decommissioning-audit will run automatically on PASS items. HITL items wait for your reply.
```
