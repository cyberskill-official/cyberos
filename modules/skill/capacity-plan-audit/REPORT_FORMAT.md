# `capacity-plan` audit-report format

Every `capacity-plan-audit` invocation writes a sibling `capacity-plan.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "capacity-plan_rubric@1.0"
audited_file:           "./capacity-plans/CAPACITY-PLAN-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "capacity-plan_rubric@1.0"
