# `capacity-plan-audit` — human summary format
...
```
CAPACITY-PLAN audit batch complete

Audited N CAPACITY-PLAN(s):
  - CAPACITY-PLAN-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - CAPACITY-PLAN-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - CAPACITY-PLAN-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        capacity-plan_rubric@1.0
