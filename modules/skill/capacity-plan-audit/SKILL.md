...
description: |
  Audit one or more existing capacity-plan@1 markdowns against
  capacity-plan_rubric@1.0. Produces a sibling .audit.md per artefact plus
