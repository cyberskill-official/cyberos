# `product-roadmap` audit-report format

Every `product-roadmap-audit` invocation writes a sibling `product-roadmap.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "product-roadmap_rubric@1.0"
audited_file:           "./product-roadmaps/PRODUCT-ROADMAP-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "product-roadmap_rubric@1.0"
