...
description: |
  Audit one or more existing product-roadmap@1 markdowns against
  product-roadmap_rubric@1.0. Produces a sibling .audit.md per artefact plus
