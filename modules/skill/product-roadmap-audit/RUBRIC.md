# `product_roadmap_rubric@1.0` — machine-checkable Product Roadmap rubric
...
| `FM-004` | `template` equals `product-roadmap@1` | error | true |
...
Per the `contracts/product-roadmap/template.md` H2 list — every H2 in template MUST be present + non-empty in the authored artefact.

| rule_id | Check | Severity |
| ------- | ----- | -------- |
| `SEC-001` | Every H2 declared in `contracts/product-roadmap/template.md` is present in the authored artefact | error |
...
- `cyberos/skill/contracts/product-roadmap/CONTRACT.md` + `template.md`
