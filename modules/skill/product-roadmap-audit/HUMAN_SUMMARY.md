# `product-roadmap-audit` — human summary format
...
```
PRODUCT-ROADMAP audit batch complete

Audited N PRODUCT-ROADMAP(s):
  - PRODUCT-ROADMAP-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - PRODUCT-ROADMAP-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - PRODUCT-ROADMAP-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        product-roadmap_rubric@1.0
