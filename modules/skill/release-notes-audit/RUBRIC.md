...
> Sourced from `cyberos/docs/Software Development Process.md` §2(i) release management; Keep-a-Changelog 1.1.0; SemVer 2.0.0. Rubric version `1.0` is locked.
...
- `cyberos/docs/Software Development Process.md` §2(i) — Release management source
