# `release-notes` audit-report format

Every `release-notes-audit` invocation writes a sibling `release-notes.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "release-notes_rubric@1.0"
audited_file:           "./release-notess/RELEASE-NOTES-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "release-notes_rubric@1.0"
