# `release-notes-audit` — human summary format
...
```
RELEASE-NOTES audit batch complete

Audited N RELEASE-NOTES(s):
  - RELEASE-NOTES-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - RELEASE-NOTES-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - RELEASE-NOTES-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        release-notes_rubric@1.0
