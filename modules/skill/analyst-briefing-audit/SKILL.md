...
description: |
  Audit one or more existing analyst-briefing@1 markdowns against
  analyst-briefing_rubric@1.0. Produces a sibling .audit.md per artefact plus
