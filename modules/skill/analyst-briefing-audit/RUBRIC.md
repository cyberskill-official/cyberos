# `analyst_briefing_rubric@1.0` — machine-checkable Analyst Briefing rubric
...
| `FM-004` | `template` equals `analyst-briefing@1` | error | true |
...
Per the `contracts/analyst-briefing/template.md` H2 list — every H2 in template MUST be present + non-empty in the authored artefact.

| rule_id | Check | Severity |
| ------- | ----- | -------- |
| `SEC-001` | Every H2 declared in `contracts/analyst-briefing/template.md` is present in the authored artefact | error |
...
- `cyberos/skill/contracts/analyst-briefing/CONTRACT.md` + `template.md`
