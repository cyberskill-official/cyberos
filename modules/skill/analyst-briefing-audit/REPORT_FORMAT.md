# `analyst-briefing` audit-report format

Every `analyst-briefing-audit` invocation writes a sibling `analyst-briefing.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "analyst-briefing_rubric@1.0"
audited_file:           "./analyst-briefings/ANALYST-BRIEFING-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "analyst-briefing_rubric@1.0"
