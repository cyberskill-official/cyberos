# `analyst-briefing-audit` — human summary format
...
```
ANALYST-BRIEFING audit batch complete

Audited N ANALYST-BRIEFING(s):
  - ANALYST-BRIEFING-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - ANALYST-BRIEFING-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - ANALYST-BRIEFING-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        analyst-briefing_rubric@1.0
