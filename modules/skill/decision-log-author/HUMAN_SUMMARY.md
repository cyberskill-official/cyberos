# `decision-log-author` — human summary format
...
```
DECISION-LOG batch <batch_run_id> complete

Wrote N DECISION-LOG(s):
  - DECISION-LOG-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - DECISION-LOG-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - DECISION-LOG-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        decision-log-audit will run automatically on PASS items. HITL items wait for your reply.
```
