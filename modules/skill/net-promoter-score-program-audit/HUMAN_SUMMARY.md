# `net-promoter-score-program-audit` — human summary format
...
```
NPS-PROGRAM audit batch complete

Audited N NPS-PROGRAM(s):
  - NPS-PROGRAM-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - NPS-PROGRAM-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - NPS-PROGRAM-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        nps-program_rubric@1.0
