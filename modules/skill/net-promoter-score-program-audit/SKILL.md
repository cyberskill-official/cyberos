...
description: |
  Audit one or more existing net-promoter-score-program@1 markdowns against
  nps-program_rubric@1.0. Produces a sibling .audit.md per artefact plus
  ...
  net-promoter-score-program-author.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
