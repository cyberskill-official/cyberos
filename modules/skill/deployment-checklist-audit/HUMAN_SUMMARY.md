# `deployment-checklist-audit` — human summary format
...
```
DEPLOY-CHECKLIST audit batch complete

Audited N DEPLOY-CHECKLIST(s):
  - DEPLOY-CHECKLIST-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - DEPLOY-CHECKLIST-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - DEPLOY-CHECKLIST-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        deploy-checklist_rubric@1.0
