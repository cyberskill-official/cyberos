# `thirteen-week-cash-flow-author` — human summary format
...
```
13-WEEK-CASH-FLOW batch <batch_run_id> complete

Wrote N 13-WEEK-CASH-FLOW(s):
  - 13-WEEK-CASH-FLOW-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - 13-WEEK-CASH-FLOW-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - 13-WEEK-CASH-FLOW-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        thirteen-week-cash-flow-audit will run automatically on PASS items. HITL items wait for your reply.
```
