...
description: |
  Author the weekly 13-week cash-flow forecast during distress (opening cash + receipts by week + disbursements by week + ending cash + covenant compliance + variance + stretch-vendor actions). Industry-standard TWCF model. CRO-Restructuring (or CFO during distress) authored.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
