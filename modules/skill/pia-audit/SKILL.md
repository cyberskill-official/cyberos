...
name: pia-audit
description: |
  Audit one or more existing pia@1 markdowns against
...
Also invoked automatically by the supervisor when `pia-author`'s output envelope sets `next_skill_recommendation: pia-audit` (the default chain).
