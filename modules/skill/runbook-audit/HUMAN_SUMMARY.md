# `runbook-audit` — human summary format
...
```
RUNBOOK audit batch complete

Audited N RUNBOOK(s):
  - RUNBOOK-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - RUNBOOK-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - RUNBOOK-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        runbook_rubric@1.0
