# `runbook` audit-report format

Every `runbook-audit` invocation writes a sibling `runbook.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "runbook_rubric@1.0"
audited_file:           "./runbooks/RUNBOOK-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "runbook_rubric@1.0"
