...
description: |
  Author the annual operating model (operating principles + function design + process architecture + decision rights + RACI + SLA architecture + governance cadence). COO authored; CEO approved.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
