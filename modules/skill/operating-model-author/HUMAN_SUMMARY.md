# `operating-model-author` — human summary format
...
```
OPERATING-MODEL batch <batch_run_id> complete

Wrote N OPERATING-MODEL(s):
  - OPERATING-MODEL-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - OPERATING-MODEL-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - OPERATING-MODEL-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        operating-model-audit will run automatically on PASS items. HITL items wait for your reply.
```
