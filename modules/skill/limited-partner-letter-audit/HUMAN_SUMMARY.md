# `limited-partner-letter-audit` — human summary format
...
```
LP-LETTER audit batch complete

Audited N LP-LETTER(s):
  - LP-LETTER-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - LP-LETTER-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - LP-LETTER-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        lp-letter_rubric@1.0
