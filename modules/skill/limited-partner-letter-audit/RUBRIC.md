# `lp_letter_rubric@1.0` — machine-checkable LP Letter rubric
...
| `FM-004` | `template` equals `limited-partner-letter@1` | error | true |
...
Per the `contracts/limited-partner-letter/template.md` H2 list.
...
- `cyberos/skill/contracts/limited-partner-letter/CONTRACT.md` + `template.md`
