# `dei-program` audit-report format

Every `dei-program-audit` invocation writes a sibling `dei-program.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "dei-program_rubric@1.0"
audited_file:           "./dei-programs/DEI-PROGRAM-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "dei-program_rubric@1.0"
