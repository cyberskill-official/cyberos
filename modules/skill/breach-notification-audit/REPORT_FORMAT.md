# `breach-notification` audit-report format

Every `breach-notification-audit` invocation writes a sibling `breach-notification.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "breach-notification_rubric@1.0"
audited_file:           "./breach-notifications/BREACH-NOTIFICATION-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "breach-notification_rubric@1.0"
