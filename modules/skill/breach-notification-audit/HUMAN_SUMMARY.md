# `breach-notification-audit` — human summary format
...
```
BREACH-NOTIFICATION audit batch complete

Audited N BREACH-NOTIFICATION(s):
  - BREACH-NOTIFICATION-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - BREACH-NOTIFICATION-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - BREACH-NOTIFICATION-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        breach-notification_rubric@1.0
