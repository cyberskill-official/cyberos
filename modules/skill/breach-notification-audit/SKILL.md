...
description: |
  Audit one or more existing breach-notification@1 markdowns against
  breach-notification_rubric@1.0. Produces a sibling .audit.md per artefact plus
