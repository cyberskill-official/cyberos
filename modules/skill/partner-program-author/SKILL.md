...
description: |
  Author the annual partner-program design (program purpose + tier structure + partner economics + enablement + co-marketing + governance + cadence). Crossbeam / Reveal + TSIA partner-program maturity model. CCO-Commercial authored.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
