# `partner-program-author` — human summary format
...
```
PARTNER-PROGRAM batch <batch_run_id> complete

Wrote N PARTNER-PROGRAM(s):
  - PARTNER-PROGRAM-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - PARTNER-PROGRAM-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - PARTNER-PROGRAM-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        partner-program-audit will run automatically on PASS items. HITL items wait for your reply.
```
