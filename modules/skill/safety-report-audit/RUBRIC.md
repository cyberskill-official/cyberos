# `safety_report_rubric@1.0` — machine-checkable Safety Report rubric
...
| `FM-004` | `template` equals `safety-report@1` | error | true |
...
Per the `contracts/safety-report/template.md` H2 list.
...
- `cyberos/skill/contracts/safety-report/CONTRACT.md` + `template.md`
