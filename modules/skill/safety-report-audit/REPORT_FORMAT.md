# `safety-report` audit-report format

Every `safety-report-audit` invocation writes a sibling `safety-report.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "safety-report_rubric@1.0"
audited_file:           "./safety-reports/SAFETY-REPORT-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "safety-report_rubric@1.0"
