# `safety-report-audit` — human summary format
...
```
SAFETY-REPORT audit batch complete

Audited N SAFETY-REPORT(s):
  - SAFETY-REPORT-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - SAFETY-REPORT-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - SAFETY-REPORT-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        safety-report_rubric@1.0
