...
description: |
  Audit one or more existing safety-report@1 markdowns against
  safety-report_rubric@1.0. Produces a sibling .audit.md per artefact plus
