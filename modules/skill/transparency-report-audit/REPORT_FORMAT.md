# `transparency-report` audit-report format

Every `transparency-report-audit` invocation writes a sibling `transparency-report.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "transparency-report_rubric@1.0"
audited_file:           "./transparency-reports/TRANSPARENCY-REPORT-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "transparency-report_rubric@1.0"
