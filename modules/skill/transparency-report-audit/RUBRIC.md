# `transparency_report_rubric@1.0` — machine-checkable Transparency Report rubric
...
| `FM-004` | `template` equals `transparency-report@1` | error | true |
...
Per the `contracts/transparency-report/template.md` H2 list — every H2 in template MUST be present + non-empty in the authored artefact.

| rule_id | Check | Severity |
| ------- | ----- | -------- |
| `SEC-001` | Every H2 declared in `contracts/transparency-report/template.md` is present in the authored artefact | error |
...
- `cyberos/skill/contracts/transparency-report/CONTRACT.md` + `template.md`
