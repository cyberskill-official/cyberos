---
# ── Identity ─────────────────────────────────────────────────────────
name: transparency-report-audit
description: >-
  Audit one or more existing transparency-report@1 markdowns against transparency-report_rubric@1.0. Produces a sibling .audit.md per artefact plus an AUDIT_BATCH_SUMMARY. Halts on needs_human verdicts; resumable on audited_file_sha256. Standalone trigger or chains naturally after transparency-report-author. Use when user asks to "audit this transparency report" or "check the transparency report". Do NOT use for "draft a new transparency report" (use transparency-report-author instead).
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
  stage: cross
  cyberos-template: transparency-report@1
  cyberos-rubric-version: transparency-report_rubric@1.0
...
depends_on_contracts:
  - id:        transparency-report
    ...
    pin_path:  cyberos/skill/contracts/transparency-report/
  - id:        nats-subjects
    version:   v1
...
# transparency-report-audit — TRANSPARENCY-REPORT auditor

> Standalone trigger that runs `transparency-report_rubric@1.0` against one or
> more existing `transparency-report@1` markdowns and writes a sibling
> `transparency-report.audit.md` per item. Halts on `needs_human` verdicts via
> the standard Question primitive; resumable on `audited_file_sha256`.
> Chains naturally after [`transparency-report-author`](../transparency-report-author/SKILL.md).

`prompt_revision: transparency-report_audit@1.0.0`

## When to invoke this skill

CUO routes a request here when the user wants to:

- "Audit these existing `TRANSPARENCY-REPORT`s."
- "Has `TRANSPARENCY-REPORT-007` changed since the last audit?"
- "Tell me which `TRANSPARENCY-REPORT`s would fail acceptance today."

Also invoked automatically by the supervisor when `transparency-report-author`'s output envelope sets `next_skill_recommendation: transparency-report-audit` (the default chain).
...
```
CONTRACT_ECHO
skill_id:                        transparency-report-audit
skill_version:                   1.0.0
prompt_revision:                 transparency-report_audit@1.0.0
template_version:                transparency-report@1   (loaded from cyberos/skill/contracts/transparency-report/template.md)
audit_rubric_version:            transparency-report_rubric@1.0
...
```json
{
  "artefact_paths": ["./transparency-reports/TRANSPARENCY-REPORT-001-foo.md", "./transparency-reports/TRANSPARENCY-REPORT-002-bar.md"],
  "caller_persona": "cuo-cpo",
  "trace_id": "<uuid>",
  "upstream_context": {
    "from_skill": "transparency-report-author",
    "manifest_path": "./transparency-reports/manifest.json"
  }
}
```
...
```json
{
  ...
  "exit_code": 1,
  "per_artefact": [
    {"artefact_path": "./transparency-reports/TRANSPARENCY-REPORT-001-foo.md", "audit_path": "./transparency-reports/TRANSPARENCY-REPORT-001-foo.audit.md", "status": "pass", "iterations": 1, "audited_file_sha256": "<hex>"},
    {"artefact_path": "./transparency-reports/TRANSPARENCY-REPORT-002-bar.md", "audit_path": "./transparency-reports/TRANSPARENCY-REPORT-002-bar.audit.md", "status": "needs_human", "iterations": 3, "audited_file_sha256": "<hex>"}
  ],
  "hitl_required": true,
...
```
Persona: cuo-cpo
Skill:   transparency-report-audit
Input:
  artefact_paths:  [./team-a/TRANSPARENCY-REPORT-001-something.md, ./team-b/TRANSPARENCY-REPORT-018-other.md]
  caller_persona:  cuo-cpo
  trace_id:        <uuid>
