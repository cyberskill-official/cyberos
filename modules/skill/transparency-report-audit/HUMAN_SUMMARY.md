# `transparency-report-audit` — human summary format
...
```
TRANSPARENCY-REPORT audit batch complete

Audited N TRANSPARENCY-REPORT(s):
  - TRANSPARENCY-REPORT-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - TRANSPARENCY-REPORT-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - TRANSPARENCY-REPORT-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        transparency-report_rubric@1.0
