# churn-analysis_rubric@1.0 — compact universal rubric
...
| FM-002 | `artefact_type` matches `churn-analysis@1` |
...
| ID | Rule |
|---|---|
| SEC-001 | Every H2 in `contracts/churn-analysis/template.md` is present in the authored artefact |
