# `churn-analysis-audit` — human summary format
...
```
CHURN_ANALYSIS audit batch complete

Audited N CHURN_ANALYSIS(s):
  - CHURN_ANALYSIS-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - CHURN_ANALYSIS-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - CHURN_ANALYSIS-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        churn-analysis_rubric@1.0
