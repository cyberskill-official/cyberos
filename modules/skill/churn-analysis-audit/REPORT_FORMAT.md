# `churn-analysis` audit-report format

Every `churn-analysis-audit` invocation writes a sibling `churn-analysis.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "churn-analysis_rubric@1.0"
audited_file:           "./churn-analysiss/CHURN_ANALYSIS-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "churn-analysis_rubric@1.0"
