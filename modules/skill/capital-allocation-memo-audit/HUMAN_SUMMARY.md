# `capital-allocation-memo-audit` — human summary format
...
```
CAP-ALLOC-MEMO audit batch complete

Audited N CAP-ALLOC-MEMO(s):
  - CAP-ALLOC-MEMO-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - CAP-ALLOC-MEMO-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - CAP-ALLOC-MEMO-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        cap-alloc-memo_rubric@1.0
