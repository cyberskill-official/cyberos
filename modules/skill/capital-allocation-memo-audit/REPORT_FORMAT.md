# `cap-alloc-memo` audit-report format

Every `capital-allocation-memo-audit` invocation writes a sibling `cap-alloc-memo.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "cap-alloc-memo_rubric@1.0"
audited_file:           "./cap-alloc-memos/CAP-ALLOC-MEMO-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "cap-alloc-memo_rubric@1.0"
