...
description: |
  Audit one or more existing capital-allocation-memo@1 markdowns against
  cap-alloc-memo_rubric@1.0. Produces a sibling .audit.md per artefact plus
  ...
  capital-allocation-memo-author.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
