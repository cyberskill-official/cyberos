...
families: ECM-GATE | ECM-STRUCT | ECM-TRACE
...
| `ECM-GATE-003` | total_rows >= 8 when the FR priority is MUST (TOTAL_ROWS_MIN) | SKILL.md MUST-priority clause |
...
- edge_case_matrix_rubric@1.0: initial file-form of the gates already normative in SKILL.md prose (FR-SKILL-118; no bar raised, no bar lowered).
