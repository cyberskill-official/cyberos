# `deploy-checklist` audit-report format

Every `deploy-checklist-audit` invocation writes a sibling `deploy-checklist.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "deploy-checklist_rubric@1.0"
audited_file:           "./deploy-checklists/DEPLOY-CHECKLIST-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "deploy-checklist_rubric@1.0"
