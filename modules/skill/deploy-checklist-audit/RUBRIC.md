...
> Sourced from `cyberos/docs/Software Development Process.md` §2(i) Deployment and release management + Template §4.7 Deployment Readiness Checklist; DORA four key metrics. Rubric version `1.0` is locked.
...
| `FM-004` | `template` equals `deploy-checklist@1` | error | true |
...
- `cyberos/docs/Software Development Process.md` §2(i) + Template §4.7 — Deployment source
