...
description: |
  Author a per-program change-mgmt plan (program context + stakeholder analysis + comms plan + training plan + adoption tracking + resistance mitigation). Prosci ADKAR + Kotter 8-step aligned. Chief Transformation Officer authored.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
