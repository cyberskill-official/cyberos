...
- NATS event emission for `change-mgmt-plan_written`, `batch_complete`, `hitl_pause`.
...
- Self-audit passes on its own input set at 10/10 by `change-management-plan-audit`.
