# `change-management-plan-author` — human summary format
...
```
CHANGE-MGMT-PLAN batch <batch_run_id> complete

Wrote N CHANGE-MGMT-PLAN(s):
  - CHANGE-MGMT-PLAN-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - CHANGE-MGMT-PLAN-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - CHANGE-MGMT-PLAN-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        change-management-plan-audit will run automatically on PASS items. HITL items wait for your reply.
```
