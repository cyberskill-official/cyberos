# `investor-update-author` — human summary format
...
```
INVESTOR-UPDATE batch <batch_run_id> complete

Wrote N INVESTOR-UPDATE(s):
  - INVESTOR-UPDATE-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - INVESTOR-UPDATE-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - INVESTOR-UPDATE-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        investor-update-audit will run automatically on PASS items. HITL items wait for your reply.
```
