...
description: |
  Audit one or more existing onboarding-pack@1 markdowns against
  onboarding-pack_rubric@1.0. Produces a sibling .audit.md per artefact plus
