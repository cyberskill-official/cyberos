# `onboarding-pack-audit` — human summary format
...
```
ONBOARDING-PACK audit batch complete

Audited N ONBOARDING-PACK(s):
  - ONBOARDING-PACK-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - ONBOARDING-PACK-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - ONBOARDING-PACK-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        onboarding-pack_rubric@1.0
