# `onboarding-pack` audit-report format

Every `onboarding-pack-audit` invocation writes a sibling `onboarding-pack.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "onboarding-pack_rubric@1.0"
audited_file:           "./onboarding-packs/ONBOARDING-PACK-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "onboarding-pack_rubric@1.0"
