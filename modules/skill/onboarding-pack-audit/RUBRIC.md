# `onboarding_pack_rubric@1.0` — machine-checkable Onboarding Pack rubric
...
| `FM-004` | `template` equals `onboarding-pack@1` | error | true |
...
Per the `contracts/onboarding-pack/template.md` H2 list. Each H2 in the template MUST be present + non-empty in the authored artefact. See template for the canonical headings.

| rule_id | Check | Severity |
| ------- | ----- | -------- |
| `SEC-001` | Every H2 declared in `contracts/onboarding-pack/template.md` is present in the authored artefact | error |
...
- `cyberos/skill/contracts/onboarding-pack/CONTRACT.md` + `template.md`
