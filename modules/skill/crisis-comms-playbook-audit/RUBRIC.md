...
| `FM-004` | `template` equals `crisis-comms-playbook@1` | error | true |
...
Per the `contracts/crisis-comms-playbook/template.md` H2 list — every H2 in template MUST be present + non-empty in the authored artefact.

| rule_id | Check | Severity |
| ------- | ----- | -------- |
| `SEC-001` | Every H2 declared in `contracts/crisis-comms-playbook/template.md` is present in the authored artefact | error |
...
- `cyberos/skill/contracts/crisis-comms-playbook/CONTRACT.md` + `template.md`
