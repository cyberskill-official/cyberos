---
# ── Identity ─────────────────────────────────────────────────────────
name: crisis-comms-playbook-audit
description: |
  Audit one or more existing crisis-comms-playbook@1 markdowns against
  ...
  crisis-comms-playbook-author.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
  stage: <SDP §2 stage letter or "cross">
  cyberos-template: crisis-comms-playbook@1
...
depends_on_contracts:
  - id:        crisis-comms-playbook
    ...
    pin_path:  cyberos/skill/contracts/crisis-comms-playbook/
  - id:        nats-subjects
    version:   v1
...
# crisis-comms-playbook-audit — CRISIS-COMMS-PLAYBOOK auditor

> Standalone trigger that runs `crisis-comms-playbook_rubric@1.0` against one or
> more existing `crisis-comms-playbook@1` markdowns and writes a sibling
...
> Chains naturally after [`crisis-comms-playbook-author`](../crisis-comms-playbook-author/SKILL.md).
...
Also invoked automatically by the supervisor when `crisis-comms-playbook-author`'s output envelope sets `next_skill_recommendation: crisis-comms-playbook-audit` (the default chain).
...
```
CONTRACT_ECHO
skill_id:                        crisis-comms-playbook-audit
skill_version:                   1.0.0
prompt_revision:                 crisis-comms-playbook_audit@1.0.0
template_version:                crisis-comms-playbook@1   (loaded from cyberos/skill/contracts/crisis-comms-playbook/template.md)
...
```json
{
  ...
  "trace_id": "<uuid>",
  "upstream_context": {
    "from_skill": "crisis-comms-playbook-author",
...
```
Persona: cuo-cpo
Skill:   crisis-comms-playbook-audit
Input:
