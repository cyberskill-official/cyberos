# `crisis-comms-playbook` audit-report format

Every `crisis-comms-playbook-audit` invocation writes a sibling `crisis-comms-playbook.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "crisis-comms-playbook_rubric@1.0"
audited_file:           "./crisis-comms-playbooks/CRISIS-COMMS-PLAYBOOK-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "crisis-comms-playbook_rubric@1.0"
