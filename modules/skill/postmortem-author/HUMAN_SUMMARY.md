# `postmortem-author` — human summary format
...
```
POSTMORTEM batch <batch_run_id> complete

Wrote N POSTMORTEM(s):
  - POSTMORTEM-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - POSTMORTEM-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - POSTMORTEM-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        postmortem-audit will run automatically on PASS items. HITL items wait for your reply.
```
