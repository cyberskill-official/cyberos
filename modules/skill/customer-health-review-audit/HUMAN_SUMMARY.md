# `customer-health-review-audit` — human summary format
...
```
CUSTOMER_HEALTH_REVIEW audit batch complete

Audited N CUSTOMER_HEALTH_REVIEW(s):
  - CUSTOMER_HEALTH_REVIEW-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - CUSTOMER_HEALTH_REVIEW-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - CUSTOMER_HEALTH_REVIEW-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        customer-health-review_rubric@1.0
