# `customer-health-review` audit-report format

Every `customer-health-review-audit` invocation writes a sibling `customer-health-review.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "customer-health-review_rubric@1.0"
audited_file:           "./customer-health-reviews/CUSTOMER_HEALTH_REVIEW-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "customer-health-review_rubric@1.0"
