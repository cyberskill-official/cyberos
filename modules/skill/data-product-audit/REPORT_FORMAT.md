# `data-product` audit-report format

Every `data-product-audit` invocation writes a sibling `data-product.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "data-product_rubric@1.0"
audited_file:           "./data-products/DATA-PRODUCT-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "data-product_rubric@1.0"
