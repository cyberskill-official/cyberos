# `data-product-audit` — human summary format
...
```
DATA-PRODUCT audit batch complete

Audited N DATA-PRODUCT(s):
  - DATA-PRODUCT-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - DATA-PRODUCT-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - DATA-PRODUCT-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        data-product_rubric@1.0
