# `data_product_rubric@1.0` — machine-checkable Data Product Spec rubric
...
| `FM-004` | `template` equals `data-product@1` | error | true |
...
Per the `contracts/data-product/template.md` H2 list — every H2 in template MUST be present + non-empty in the authored artefact.

| rule_id | Check | Severity |
| ------- | ----- | -------- |
| `SEC-001` | Every H2 declared in `contracts/data-product/template.md` is present in the authored artefact | error |
...
- `cyberos/skill/contracts/data-product/CONTRACT.md` + `template.md`
