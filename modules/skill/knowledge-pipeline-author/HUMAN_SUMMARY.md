# `knowledge-pipeline-author` — human summary format
...
```
KNOWLEDGE_PIPELINE batch <batch_run_id> complete

Wrote N KNOWLEDGE_PIPELINE(s):
  - KNOWLEDGE_PIPELINE-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - KNOWLEDGE_PIPELINE-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - KNOWLEDGE_PIPELINE-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        knowledge-pipeline-audit will run automatically on PASS items. HITL items wait for your reply.
```
