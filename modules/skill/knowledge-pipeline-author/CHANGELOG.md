...
- NATS event emission for `knowledge-pipeline_written`, `batch_complete`, `hitl_pause`.
...
- Self-audit passes on its own input set at 10/10 by `knowledge-pipeline-audit`.
