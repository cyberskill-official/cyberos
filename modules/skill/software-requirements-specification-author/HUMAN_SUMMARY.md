# `software-requirements-specification-author` — human summary format
...
```
SRS batch <batch_run_id> complete

Wrote N SRS(s):
  - SRS-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - SRS-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - SRS-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        software-requirements-specification-audit will run automatically on PASS items. HITL items wait for your reply.
```
