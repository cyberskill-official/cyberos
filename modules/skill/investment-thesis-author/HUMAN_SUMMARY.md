# `investment-thesis-author` — human summary format
...
```
INVESTMENT-THESIS batch <batch_run_id> complete

Wrote N INVESTMENT-THESIS(s):
  - INVESTMENT-THESIS-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - INVESTMENT-THESIS-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - INVESTMENT-THESIS-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        investment-thesis-audit will run automatically on PASS items. HITL items wait for your reply.
```
