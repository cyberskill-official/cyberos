# `objectives-and-key-results-set-author` — human summary format
...
```
OKR-SET batch <batch_run_id> complete

Wrote N OKR-SET(s):
  - OKR-SET-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - OKR-SET-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - OKR-SET-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        objectives-and-key-results-set-audit will run automatically on PASS items. HITL items wait for your reply.
```
