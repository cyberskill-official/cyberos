...
- NATS event emission for `okr-set_written`, `batch_complete`, `hitl_pause`.
...
- Self-audit passes on its own input set at 10/10 by `objectives-and-key-results-set-audit`.
