# `vendor-scorecard-author` — human summary format
...
```
VENDOR-SCORECARD batch <batch_run_id> complete

Wrote N VENDOR-SCORECARD(s):
  - VENDOR-SCORECARD-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - VENDOR-SCORECARD-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - VENDOR-SCORECARD-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        vendor-scorecard-audit will run automatically on PASS items. HITL items wait for your reply.
```
