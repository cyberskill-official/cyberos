...
description: |
  Author the monthly / quarterly vendor scorecard (vendor list + spend by category + SLA attainment + sustainability score + consolidation opportunities). COO or CPO-Procurement authored.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
