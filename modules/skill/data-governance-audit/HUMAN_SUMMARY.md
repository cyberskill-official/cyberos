# `data-governance-audit` — human summary format
...
```
DATA-GOVERNANCE audit batch complete

Audited N DATA-GOVERNANCE(s):
  - DATA-GOVERNANCE-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - DATA-GOVERNANCE-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - DATA-GOVERNANCE-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        data-governance_rubric@1.0
