# `data-governance` audit-report format

Every `data-governance-audit` invocation writes a sibling `data-governance.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "data-governance_rubric@1.0"
audited_file:           "./data-governances/DATA-GOVERNANCE-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "data-governance_rubric@1.0"
