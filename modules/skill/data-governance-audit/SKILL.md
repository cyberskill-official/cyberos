...
description: |
  Audit one or more existing data-governance@1 markdowns against
  data-governance_rubric@1.0. Produces a sibling .audit.md per artefact plus
