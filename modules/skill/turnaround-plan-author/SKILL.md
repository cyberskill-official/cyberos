...
description: |
  Author the post-distress turnaround plan (diagnostic + cash conservation + cost-out + non-core divestiture + creditor renegotiation + new-financing path + KERP/KEIP + milestone sign-off). AlixPartners / FTI / A&M / Alvarez turnaround playbooks. CRO-Restructuring authored.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
