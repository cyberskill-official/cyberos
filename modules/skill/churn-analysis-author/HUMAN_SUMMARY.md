# `churn-analysis-author` — human summary format
...
```
CHURN_ANALYSIS batch <batch_run_id> complete

Wrote N CHURN_ANALYSIS(s):
  - CHURN_ANALYSIS-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - CHURN_ANALYSIS-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - CHURN_ANALYSIS-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        churn-analysis-audit will run automatically on PASS items. HITL items wait for your reply.
```
