# `requirements-traceability-matrix-author` — standalone interview
...
| `chain_to` | "Should I chain to the audit skill afterwards? (default yes)" | `['requirements-traceability-matrix-audit']` |
