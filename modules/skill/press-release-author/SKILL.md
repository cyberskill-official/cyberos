...
description: |
  Author a per-announcement press release (headline + dateline + lede + supporting paragraphs + spokesperson quotes + boilerplate + media contact + embargo terms). AP Stylebook conventions. CCO-Communications authored.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
