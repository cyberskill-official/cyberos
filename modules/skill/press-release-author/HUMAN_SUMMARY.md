# `press-release-author` — human summary format
...
```
PRESS-RELEASE batch <batch_run_id> complete

Wrote N PRESS-RELEASE(s):
  - PRESS-RELEASE-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - PRESS-RELEASE-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - PRESS-RELEASE-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        press-release-audit will run automatically on PASS items. HITL items wait for your reply.
```
