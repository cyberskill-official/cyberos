...
description: |
  Author the monthly trust-portal content update (certifications + audit results + sub-processor list + incident-status timeline + FAQ updates + customer-trust briefing log). Vanta / Drata / SafeBase trust-portal patterns. Chief Trust Officer + CPO-Privacy co-authored.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
