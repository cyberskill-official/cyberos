# `trust-portal-update-author` — human summary format
...
```
TRUST-PORTAL-UPDATE batch <batch_run_id> complete

Wrote N TRUST-PORTAL-UPDATE(s):
  - TRUST-PORTAL-UPDATE-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - TRUST-PORTAL-UPDATE-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - TRUST-PORTAL-UPDATE-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        trust-portal-update-audit will run automatically on PASS items. HITL items wait for your reply.
```
