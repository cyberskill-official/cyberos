...
- NATS event emission for `trust-portal-update_written`, `batch_complete`, `hitl_pause`.
...
- Self-audit passes on its own input set at 10/10 by `trust-portal-update-audit`.
