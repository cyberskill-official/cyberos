# `partner_program_rubric@1.0` — machine-checkable Partner Program rubric
...
| `FM-004` | `template` equals `partner-program@1` | error | true |
...
Per the `contracts/partner-program/template.md` H2 list — every H2 in template MUST be present + non-empty in the authored artefact.

| rule_id | Check | Severity |
| ------- | ----- | -------- |
| `SEC-001` | Every H2 declared in `contracts/partner-program/template.md` is present in the authored artefact | error |
...
- `cyberos/skill/contracts/partner-program/CONTRACT.md` + `template.md`
