# `partner-program-audit` — human summary format
...
```
PARTNER-PROGRAM audit batch complete

Audited N PARTNER-PROGRAM(s):
  - PARTNER-PROGRAM-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - PARTNER-PROGRAM-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - PARTNER-PROGRAM-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        partner-program_rubric@1.0
