# `partner-program` audit-report format

Every `partner-program-audit` invocation writes a sibling `partner-program.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "partner-program_rubric@1.0"
audited_file:           "./partner-programs/PARTNER-PROGRAM-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "partner-program_rubric@1.0"
