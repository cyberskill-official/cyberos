...
description: |
  Audit one or more existing partner-program@1 markdowns against
  partner-program_rubric@1.0. Produces a sibling .audit.md per artefact plus
