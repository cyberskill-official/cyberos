# `<artifact>` audit-report format

Every `<artifact>-audit` invocation writes a sibling `<artefact>.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "<artifact>_rubric@1.0"
audited_file:           "./<artifact>s/<ARTIFACT>-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "<artifact>_rubric@1.0"
