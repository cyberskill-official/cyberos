# `<artifact>-audit` — human summary format
...
```
<ARTIFACT> audit batch complete

Audited N <ARTIFACT>(s):
  - <ARTIFACT>-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - <ARTIFACT>-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - <ARTIFACT>-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        <artifact>_rubric@1.0
