# `<artifact>-author` — human summary format
...
```
<ARTIFACT> batch <batch_run_id> complete

Wrote N <ARTIFACT>(s):
  - <ARTIFACT>-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - <ARTIFACT>-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - <ARTIFACT>-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        <artifact>-audit will run automatically on PASS items. HITL items wait for your reply.
```
