...
description: |
  Author a per-feature ethics review (feature summary + intended uses + anti-uses + harm vectors per stakeholder + mitigations + residual-harm acceptance + decision + sign-off). IEEE Ethically Aligned Design + Markkula Center applied-ethics framework. Chief Ethics Officer authored.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
