# `ethics-review-author` — human summary format
...
```
ETHICS-REVIEW batch <batch_run_id> complete

Wrote N ETHICS-REVIEW(s):
  - ETHICS-REVIEW-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - ETHICS-REVIEW-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - ETHICS-REVIEW-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        ethics-review-audit will run automatically on PASS items. HITL items wait for your reply.
```
