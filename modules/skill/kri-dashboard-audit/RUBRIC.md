...
| `FM-004` | `template` equals `kri-dashboard@1` | error | true |
...
Per the `contracts/kri-dashboard/template.md` H2 list — every H2 in template MUST be present + non-empty in the authored artefact.

| rule_id | Check | Severity |
| ------- | ----- | -------- |
| `SEC-001` | Every H2 declared in `contracts/kri-dashboard/template.md` is present in the authored artefact | error |
...
- `cyberos/skill/contracts/kri-dashboard/CONTRACT.md` + `template.md`
