# `software-design-document-author` — human summary format
...
```
SDD batch <batch_run_id> complete

Wrote N SDD(s):
  - SDD-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - SDD-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - SDD-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        software-design-document-audit will run automatically on PASS items. HITL items wait for your reply.
```
