...
description: |
  Author the weekly pipeline report (summary + pipeline by stage + coverage vs quota + win-rate + deal velocity + at-risk deals + forecast roll-up). CRO-Revenue authored. Target coverage 3-4×.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
