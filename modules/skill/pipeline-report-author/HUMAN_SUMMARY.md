# `pipeline-report-author` — human summary format
...
```
PIPELINE-REPORT batch <batch_run_id> complete

Wrote N PIPELINE-REPORT(s):
  - PIPELINE-REPORT-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - PIPELINE-REPORT-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - PIPELINE-REPORT-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        pipeline-report-audit will run automatically on PASS items. HITL items wait for your reply.
```
