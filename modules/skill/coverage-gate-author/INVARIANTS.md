...
1. The gate certifies testing -> done; spec correctness stays feature-request-audit's job at draft -> ready_to_implement (deliberate phase split, RUBRIC.md §9).
2. Coverage is measured on the FR's touched files, never repo-wide averages.
