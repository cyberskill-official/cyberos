...
| `RCM-GATE-001` | database schemas + type interfaces present when the FR declares migrations | SKILL.md schemas clause |
...
- repo_context_map_rubric@1.0: initial file-form of the gates already normative in SKILL.md prose (FR-SKILL-118; no bar raised, no bar lowered).
