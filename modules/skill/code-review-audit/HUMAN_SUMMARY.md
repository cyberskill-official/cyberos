# `code-review-audit` — human summary format
...
```
CODE-REVIEW audit batch complete

Audited N CODE-REVIEW(s):
  - CODE-REVIEW-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - CODE-REVIEW-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - CODE-REVIEW-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        code-review_rubric@1.0
