# `code-review` audit-report format

Every `code-review-audit` invocation writes a sibling `code-review.audit.md` per audited artefact. The report format below is normative.
...
audited_file:           "./code-reviews/CODE-REVIEW-001-foo.md"
