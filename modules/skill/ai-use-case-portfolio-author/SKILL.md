...
description: |
  Author the quarterly AI use-case portfolio review (executive summary + use-case inventory by stage + EU AI Act risk-class distribution + production-deployment count + ROI tracking + kill-list candidates + pipeline coverage). CAIO authored.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
