# `ai-use-case-portfolio-author` — human summary format
...
```
AI-USE-CASE-PORTFOLIO batch <batch_run_id> complete

Wrote N AI-USE-CASE-PORTFOLIO(s):
  - AI-USE-CASE-PORTFOLIO-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - AI-USE-CASE-PORTFOLIO-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - AI-USE-CASE-PORTFOLIO-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        ai-use-case-portfolio-audit will run automatically on PASS items. HITL items wait for your reply.
```
