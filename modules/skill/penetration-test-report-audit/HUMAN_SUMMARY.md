# `penetration-test-report-audit` — human summary format
...
```
PEN_TEST_REPORT audit batch complete

Audited N PEN_TEST_REPORT(s):
  - PEN_TEST_REPORT-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - PEN_TEST_REPORT-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - PEN_TEST_REPORT-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        pen-test-report_rubric@1.0
