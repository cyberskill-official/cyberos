# pen-test-report_rubric@1.0 — compact universal rubric
...
| FM-002 | `artefact_type` matches `penetration-test-report@1` |
...
| ID | Rule |
|---|---|
| SEC-001 | Every H2 in `contracts/penetration-test-report/template.md` is present in the authored artefact |
