# `forecast-author` — human summary format
...
```
FORECAST batch <batch_run_id> complete

Wrote N FORECAST(s):
  - FORECAST-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - FORECAST-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - FORECAST-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        forecast-audit will run automatically on PASS items. HITL items wait for your reply.
```
