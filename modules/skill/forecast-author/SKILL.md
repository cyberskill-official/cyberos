...
description: |
  Author a monthly / quarterly financial forecast (revenue + cost + cash). Renders forecast vs prior + assumption log + forecast-accuracy reflection. CFO authored. Target accuracy ±5%.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
