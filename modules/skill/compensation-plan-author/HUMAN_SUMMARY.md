# `compensation-plan-author` — human summary format
...
```
COMP-PLAN batch <batch_run_id> complete

Wrote N COMP-PLAN(s):
  - COMP-PLAN-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - COMP-PLAN-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - COMP-PLAN-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        compensation-plan-audit will run automatically on PASS items. HITL items wait for your reply.
```
