...
description: |
  Author an annual or refresh comp plan (philosophy + band structure + quota mechanics for sales + accelerators + SPIFFs + approval matrix). CHRO authored; CRO-Revenue for sales-specific. CEO + CFO sign-off.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
