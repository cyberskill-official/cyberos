# `monthly-close` audit-report format

Every `monthly-close-audit` invocation writes a sibling `monthly-close.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "monthly-close_rubric@1.0"
audited_file:           "./monthly-closes/MONTHLY-CLOSE-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "monthly-close_rubric@1.0"
