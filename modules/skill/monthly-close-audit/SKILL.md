...
description: |
  Audit one or more existing monthly-close@1 markdowns against
  monthly-close_rubric@1.0. Produces a sibling .audit.md per artefact plus
