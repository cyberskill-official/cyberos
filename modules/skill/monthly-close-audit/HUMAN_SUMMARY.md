# `monthly-close-audit` — human summary format
...
```
MONTHLY-CLOSE audit batch complete

Audited N MONTHLY-CLOSE(s):
  - MONTHLY-CLOSE-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - MONTHLY-CLOSE-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - MONTHLY-CLOSE-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        monthly-close_rubric@1.0
