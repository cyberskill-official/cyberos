# `mna_thesis_rubric@1.0` — machine-checkable M&A Thesis rubric
...
| `FM-004` | `template` equals `mergers-and-acquisitions-thesis@1` | error | true |
...
Per the `contracts/mergers-and-acquisitions-thesis/template.md` H2 list — every H2 in template MUST be present + non-empty in the authored artefact.

| rule_id | Check | Severity |
| ------- | ----- | -------- |
| `SEC-001` | Every H2 declared in `contracts/mergers-and-acquisitions-thesis/template.md` is present in the authored artefact | error |
...
- `cyberos/skill/contracts/mergers-and-acquisitions-thesis/CONTRACT.md` + `template.md`
