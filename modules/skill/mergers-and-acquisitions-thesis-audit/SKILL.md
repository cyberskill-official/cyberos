...
description: |
  Audit one or more existing mergers-and-acquisitions-thesis@1 markdowns against
  mna-thesis_rubric@1.0. Produces a sibling .audit.md per artefact plus
  ...
  mergers-and-acquisitions-thesis-author.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
