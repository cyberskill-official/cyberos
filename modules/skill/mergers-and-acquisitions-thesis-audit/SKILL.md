---
# ── Identity ─────────────────────────────────────────────────────────
name: mergers-and-acquisitions-thesis-audit
description: >-
  Audit one or more existing mergers-and-acquisitions-thesis@1 markdowns against mna-thesis_rubric@1.0. Produces a sibling .audit.md per artefact plus an AUDIT_BATCH_SUMMARY. Halts on needs_human verdicts; resumable on audited_file_sha256. Standalone trigger or chains naturally after mergers-and-acquisitions-thesis-author. Use when user asks to "audit this mergers and acquisitions thesis" or "check the mergers and acquisitions thesis". Do NOT use for "draft a new mergers and acquisitions thesis" (use mergers-and-acquisitions-thesis-author instead).
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
  stage: cross
  cyberos-template: mergers-and-acquisitions-thesis@1
  cyberos-rubric-version: mna-thesis_rubric@1.0
...
# mergers-and-acquisitions-thesis-audit — MNA-THESIS auditor

> Standalone trigger that runs `mna-thesis_rubric@1.0` against one or
> more existing `mergers-and-acquisitions-thesis@1` markdowns and writes a sibling
> `mna-thesis.audit.md` per item. Halts on `needs_human` verdicts via
> the standard Question primitive; resumable on `audited_file_sha256`.
> Chains naturally after [`mergers-and-acquisitions-thesis-author`](../mergers-and-acquisitions-thesis-author/SKILL.md).

`prompt_revision: mna-thesis_audit@1.0.0`

## When to invoke this skill

CUO routes a request here when the user wants to:

- "Audit these existing `MNA-THESIS`s."
- "Has `MNA-THESIS-007` changed since the last audit?"
- "Tell me which `MNA-THESIS`s would fail acceptance today."

Also invoked automatically by the supervisor when `mergers-and-acquisitions-thesis-author`'s output envelope sets `next_skill_recommendation: mergers-and-acquisitions-thesis-audit` (the default chain).
...
```
CONTRACT_ECHO
skill_id:                        mergers-and-acquisitions-thesis-audit
skill_version:                   1.0.0
prompt_revision:                 mna-thesis_audit@1.0.0
...
audit_rubric_version:            mna-thesis_rubric@1.0
...
```json
{
  "artefact_paths": ["./mna-thesiss/MNA-THESIS-001-foo.md", "./mna-thesiss/MNA-THESIS-002-bar.md"],
  "caller_persona": "cuo-cpo",
  "trace_id": "<uuid>",
  "upstream_context": {
    "from_skill": "mergers-and-acquisitions-thesis-author",
...
```json
{
  ...
  "exit_code": 1,
  "per_artefact": [
    {"artefact_path": "./mna-thesiss/MNA-THESIS-001-foo.md", "audit_path": "./mna-thesiss/MNA-THESIS-001-foo.audit.md", "status": "pass", "iterations": 1, "audited_file_sha256": "<hex>"},
    {"artefact_path": "./mna-thesiss/MNA-THESIS-002-bar.md", "audit_path": "./mna-thesiss/MNA-THESIS-002-bar.audit.md", "status": "needs_human", "iterations": 3, "audited_file_sha256": "<hex>"}
  ],
  "hitl_required": true,
...
```
Persona: cuo-cpo
Skill:   mergers-and-acquisitions-thesis-audit
Input:
  artefact_paths:  [./team-a/MNA-THESIS-001-something.md, ./team-b/MNA-THESIS-018-other.md]
  caller_persona:  cuo-cpo
  trace_id:        <uuid>
