# `mergers-and-acquisitions-thesis-audit` — human summary format
...
```
MNA-THESIS audit batch complete

Audited N MNA-THESIS(s):
  - MNA-THESIS-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - MNA-THESIS-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - MNA-THESIS-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        mna-thesis_rubric@1.0
