# `mna-thesis` audit-report format

Every `mergers-and-acquisitions-thesis-audit` invocation writes a sibling `mna-thesis.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "mna-thesis_rubric@1.0"
audited_file:           "./mna-thesiss/MNA-THESIS-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "mna-thesis_rubric@1.0"
