...
name: srs-audit
description: |
  Audit one or more existing srs@1 markdowns against
...
Also invoked automatically by the supervisor when `srs-author`'s output envelope sets `next_skill_recommendation: srs-audit` (the default chain).
