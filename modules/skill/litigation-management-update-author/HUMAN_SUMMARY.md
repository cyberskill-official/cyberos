# `litigation-management-update-author` — human summary format
...
```
LITIGATION_MGMT_UPDATE batch <batch_run_id> complete

Wrote N LITIGATION_MGMT_UPDATE(s):
  - LITIGATION_MGMT_UPDATE-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - LITIGATION_MGMT_UPDATE-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - LITIGATION_MGMT_UPDATE-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        litigation-management-update-audit will run automatically on PASS items. HITL items wait for your reply.
```
