...
- NATS event emission for `litigation-mgmt-update_written`, `batch_complete`, `hitl_pause`.
...
- Self-audit passes on its own input set at 10/10 by `litigation-management-update-audit`.
