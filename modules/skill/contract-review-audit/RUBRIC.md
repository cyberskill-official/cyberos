# contract-review_rubric@1.0 — compact universal rubric
...
| FM-002 | `artefact_type` matches `contract-review@1` |
...
| ID | Rule |
|---|---|
| SEC-001 | Every H2 in `contracts/contract-review/template.md` is present in the authored artefact |
