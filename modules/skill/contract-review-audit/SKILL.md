...
description: Audits a contract-review@1 artefact against contract_review_rubric@1.0. Validates FM + SEC structure, deviation log completeness vs the playbook, redline severity rationale, GREEN/YELLOW/RED risk classification consistency. Per ABA Model Contract Clauses + ACC Contract Playbook conventions.
  Audit one or more existing contract-review@1 markdowns against
  contract-review_rubric@1.0. Produces a sibling .audit.md per artefact plus
