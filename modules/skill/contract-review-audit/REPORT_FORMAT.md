# `contract-review` audit-report format

Every `contract-review-audit` invocation writes a sibling `contract-review.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "contract-review_rubric@1.0"
audited_file:           "./contract-reviews/CONTRACT_REVIEW-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "contract-review_rubric@1.0"
