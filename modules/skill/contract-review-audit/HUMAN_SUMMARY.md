# `contract-review-audit` — human summary format
...
```
CONTRACT_REVIEW audit batch complete

Audited N CONTRACT_REVIEW(s):
  - CONTRACT_REVIEW-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - CONTRACT_REVIEW-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - CONTRACT_REVIEW-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        contract-review_rubric@1.0
