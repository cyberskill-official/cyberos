# `press-release` audit-report format

Every `press-release-audit` invocation writes a sibling `press-release.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "press-release_rubric@1.0"
audited_file:           "./press-releases/PRESS-RELEASE-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "press-release_rubric@1.0"
