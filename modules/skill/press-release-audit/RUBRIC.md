# `press_release_rubric@1.0` — machine-checkable Press Release rubric
...
| `FM-004` | `template` equals `press-release@1` | error | true |
...
Per the `contracts/press-release/template.md` H2 list — every H2 in template MUST be present + non-empty in the authored artefact.

| rule_id | Check | Severity |
| ------- | ----- | -------- |
| `SEC-001` | Every H2 declared in `contracts/press-release/template.md` is present in the authored artefact | error |
...
- `cyberos/skill/contracts/press-release/CONTRACT.md` + `template.md`
