# `press-release-audit` — human summary format
...
```
PRESS-RELEASE audit batch complete

Audited N PRESS-RELEASE(s):
  - PRESS-RELEASE-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - PRESS-RELEASE-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - PRESS-RELEASE-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        press-release_rubric@1.0
