---
# ── Identity ─────────────────────────────────────────────────────────
name: innovation-portfolio-audit
description: >-
  Audit one or more existing innovation-portfolio@1 markdowns against innovation-portfolio_rubric@1.0. Produces a sibling .audit.md per artefact plus an AUDIT_BATCH_SUMMARY. Halts on needs_human verdicts; resumable on audited_file_sha256. Standalone trigger or chains naturally after innovation-portfolio-author. Use when user asks to "audit this innovation portfolio" or "check the innovation portfolio". Do NOT use for "draft a new innovation portfolio" (use innovation-portfolio-author instead).
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
  stage: cross
  cyberos-template: innovation-portfolio@1
  cyberos-rubric-version: innovation-portfolio_rubric@1.0
...
# innovation-portfolio-audit — INNOVATION-PORTFOLIO auditor

> Standalone trigger that runs `innovation-portfolio_rubric@1.0` against one or
> more existing `innovation-portfolio@1` markdowns and writes a sibling
> `innovation-portfolio.audit.md` per item. Halts on `needs_human` verdicts via
> the standard Question primitive; resumable on `audited_file_sha256`.
> Chains naturally after [`innovation-portfolio-author`](../innovation-portfolio-author/SKILL.md).

`prompt_revision: innovation-portfolio_audit@1.0.0`

## When to invoke this skill

CUO routes a request here when the user wants to:

- "Audit these existing `INNOVATION-PORTFOLIO`s."
- "Has `INNOVATION-PORTFOLIO-007` changed since the last audit?"
- "Tell me which `INNOVATION-PORTFOLIO`s would fail acceptance today."

Also invoked automatically by the supervisor when `innovation-portfolio-author`'s output envelope sets `next_skill_recommendation: innovation-portfolio-audit` (the default chain).
...
audit_rubric_version:            innovation-portfolio_rubric@1.0
...
```json
{
  "artefact_paths": ["./innovation-portfolios/INNOVATION-PORTFOLIO-001-foo.md", "./innovation-portfolios/INNOVATION-PORTFOLIO-002-bar.md"],
  "caller_persona": "cuo-cpo",
  "trace_id": "<uuid>",
  "upstream_context": {
    "from_skill": "innovation-portfolio-author",
...
```json
{
  ...
  "exit_code": 1,
  "per_artefact": [
    {"artefact_path": "./innovation-portfolios/INNOVATION-PORTFOLIO-001-foo.md", "audit_path": "./innovation-portfolios/INNOVATION-PORTFOLIO-001-foo.audit.md", "status": "pass", "iterations": 1, "audited_file_sha256": "<hex>"},
    {"artefact_path": "./innovation-portfolios/INNOVATION-PORTFOLIO-002-bar.md", "audit_path": "./innovation-portfolios/INNOVATION-PORTFOLIO-002-bar.audit.md", "status": "needs_human", "iterations": 3, "audited_file_sha256": "<hex>"}
  ],
  "hitl_required": true,
...
```
Persona: cuo-cpo
Skill:   innovation-portfolio-audit
Input:
  artefact_paths:  [./team-a/INNOVATION-PORTFOLIO-001-something.md, ./team-b/INNOVATION-PORTFOLIO-018-other.md]
  caller_persona:  cuo-cpo
  trace_id:        <uuid>
