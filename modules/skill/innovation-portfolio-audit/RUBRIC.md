# `innovation_portfolio_rubric@1.0` — machine-checkable Innovation Portfolio rubric
...
| `FM-004` | `template` equals `innovation-portfolio@1` | error | true |
...
Per the `contracts/innovation-portfolio/template.md` H2 list — every H2 in template MUST be present + non-empty in the authored artefact.

| rule_id | Check | Severity |
| ------- | ----- | -------- |
| `SEC-001` | Every H2 declared in `contracts/innovation-portfolio/template.md` is present in the authored artefact | error |
...
- `cyberos/skill/contracts/innovation-portfolio/CONTRACT.md` + `template.md`
