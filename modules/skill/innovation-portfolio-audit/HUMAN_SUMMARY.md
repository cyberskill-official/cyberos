# `innovation-portfolio-audit` — human summary format
...
```
INNOVATION-PORTFOLIO audit batch complete

Audited N INNOVATION-PORTFOLIO(s):
  - INNOVATION-PORTFOLIO-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - INNOVATION-PORTFOLIO-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - INNOVATION-PORTFOLIO-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        innovation-portfolio_rubric@1.0
