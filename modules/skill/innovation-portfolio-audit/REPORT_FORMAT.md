# `innovation-portfolio` audit-report format

Every `innovation-portfolio-audit` invocation writes a sibling `innovation-portfolio.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "innovation-portfolio_rubric@1.0"
audited_file:           "./innovation-portfolios/INNOVATION-PORTFOLIO-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "innovation-portfolio_rubric@1.0"
