# `srs` audit-report format

Every `software-requirements-specification-audit` invocation writes a sibling `srs.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "srs_rubric@1.0"
audited_file:           "./srss/SRS-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "srs_rubric@1.0"
