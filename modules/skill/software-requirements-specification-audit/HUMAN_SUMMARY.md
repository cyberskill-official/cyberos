# `software-requirements-specification-audit` — human summary format
...
```
SRS audit batch complete

Audited N SRS(s):
  - SRS-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - SRS-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - SRS-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        srs_rubric@1.0
