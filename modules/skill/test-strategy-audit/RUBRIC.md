...
> Sourced from `../../../modules/cuo/docs/module.md` §2(h) Testing + Template §4.6 Test Strategy outline; OWASP Top 10:2025 (threat-led pen-test); WCAG 2.2 (accessibility); ISO/IEC 25010:2023 (NFR coverage). Rubric version `1.0` is locked.
...
- `../../../modules/cuo/docs/module.md` §2(h) + Template §4.6 — Test Strategy source
