# `test-strategy-audit` — human summary format
...
```
TEST-STRATEGY audit batch complete

Audited N TEST-STRATEGY(s):
  - TEST-STRATEGY-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - TEST-STRATEGY-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - TEST-STRATEGY-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        test-strategy_rubric@1.0
