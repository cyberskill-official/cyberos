# `test-strategy` audit-report format

Every `test-strategy-audit` invocation writes a sibling `test-strategy.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "test-strategy_rubric@1.0"
audited_file:           "./test-strategys/TEST-STRATEGY-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "test-strategy_rubric@1.0"
