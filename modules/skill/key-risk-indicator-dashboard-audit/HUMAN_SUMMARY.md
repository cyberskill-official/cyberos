# `key-risk-indicator-dashboard-audit` — human summary format
...
```
KRI-DASHBOARD audit batch complete

Audited N KRI-DASHBOARD(s):
  - KRI-DASHBOARD-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - KRI-DASHBOARD-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - KRI-DASHBOARD-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        kri-dashboard_rubric@1.0
