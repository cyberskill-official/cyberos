# `kri-dashboard` audit-report format

Every `key-risk-indicator-dashboard-audit` invocation writes a sibling `kri-dashboard.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "kri-dashboard_rubric@1.0"
audited_file:           "./kri-dashboards/KRI-DASHBOARD-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "kri-dashboard_rubric@1.0"
