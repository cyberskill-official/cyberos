# `retrospective-author` — human summary format
...
```
RETRO batch <batch_run_id> complete

Wrote N RETRO(s):
  - RETRO-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - RETRO-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - RETRO-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        retrospective-audit will run automatically on PASS items. HITL items wait for your reply.
```
