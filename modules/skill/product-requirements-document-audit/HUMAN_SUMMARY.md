# `product-requirements-document-audit` — human summary format
...
```
PRD audit batch complete

Audited N PRD(s):
  - PRD-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - PRD-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - PRD-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        prd_rubric@1.0
