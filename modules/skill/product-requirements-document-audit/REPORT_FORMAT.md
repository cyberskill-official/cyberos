...
Every `product-requirements-document-audit` invocation writes a sibling `prd.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "prd_rubric@1.0"
audited_file:           "./prds/PRD-001-foo.md"
