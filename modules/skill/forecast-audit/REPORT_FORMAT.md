# `forecast` audit-report format

Every `forecast-audit` invocation writes a sibling `forecast.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "forecast_rubric@1.0"
audited_file:           "./forecasts/FORECAST-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "forecast_rubric@1.0"
