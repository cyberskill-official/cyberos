# `forecast_rubric@1.0` — machine-checkable Financial Forecast rubric
...
| `FM-004` | `template` equals `forecast@1` | error | true |
...
Per the `contracts/forecast/template.md` H2 list. Each H2 in the template MUST be present + non-empty in the authored artefact. See template for the canonical headings.

| rule_id | Check | Severity |
| ------- | ----- | -------- |
| `SEC-001` | Every H2 declared in `contracts/forecast/template.md` is present in the authored artefact | error |
...
- `cyberos/skill/contracts/forecast/CONTRACT.md` + `template.md`
