# `forecast-audit` — human summary format
...
```
FORECAST audit batch complete

Audited N FORECAST(s):
  - FORECAST-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - FORECAST-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - FORECAST-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        forecast_rubric@1.0
