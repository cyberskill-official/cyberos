# `customer-advisory-board-author` — human summary format
...
```
CUSTOMER-ADVISORY-BOARD batch <batch_run_id> complete

Wrote N CUSTOMER-ADVISORY-BOARD(s):
  - CUSTOMER-ADVISORY-BOARD-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - CUSTOMER-ADVISORY-BOARD-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - CUSTOMER-ADVISORY-BOARD-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        customer-advisory-board-audit will run automatically on PASS items. HITL items wait for your reply.
```
