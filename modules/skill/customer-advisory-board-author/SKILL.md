...
description: |
  Author the annual CAB program (charter + member selection + meeting agendas + insight capture + action mapping back to roadmap + member NPS). CCO-Customer + CPO-Product co-authored.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
