...
- NATS event emission for `customer-advisory-board_written`, `batch_complete`, `hitl_pause`.
...
- Self-audit passes on its own input set at 10/10 by `customer-advisory-board-audit`.
