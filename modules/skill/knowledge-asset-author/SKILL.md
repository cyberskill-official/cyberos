...
description: |
  Author a per-asset knowledge codification (summary + problem context + approach narrative + reusable artefact + adaptation guide + reuse metrics + contact author). Nonaka SECI + Wenger CoP aligned. Chief Knowledge Officer or asset author authored.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
