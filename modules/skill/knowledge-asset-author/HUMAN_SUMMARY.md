# `knowledge-asset-author` — human summary format
...
```
KNOWLEDGE-ASSET batch <batch_run_id> complete

Wrote N KNOWLEDGE-ASSET(s):
  - KNOWLEDGE-ASSET-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - KNOWLEDGE-ASSET-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - KNOWLEDGE-ASSET-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        knowledge-asset-audit will run automatically on PASS items. HITL items wait for your reply.
```
