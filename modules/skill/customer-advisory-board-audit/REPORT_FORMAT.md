# `customer-advisory-board` audit-report format

Every `customer-advisory-board-audit` invocation writes a sibling `customer-advisory-board.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "customer-advisory-board_rubric@1.0"
audited_file:           "./customer-advisory-boards/CUSTOMER-ADVISORY-BOARD-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "customer-advisory-board_rubric@1.0"
