# `customer-advisory-board-audit` — human summary format
...
```
CUSTOMER-ADVISORY-BOARD audit batch complete

Audited N CUSTOMER-ADVISORY-BOARD(s):
  - CUSTOMER-ADVISORY-BOARD-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - CUSTOMER-ADVISORY-BOARD-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - CUSTOMER-ADVISORY-BOARD-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        customer-advisory-board_rubric@1.0
