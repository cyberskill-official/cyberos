...
description: |
  Audit one or more existing customer-advisory-board@1 markdowns against
  customer-advisory-board_rubric@1.0. Produces a sibling .audit.md per artefact plus
  ...
  customer-advisory-board-author.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
