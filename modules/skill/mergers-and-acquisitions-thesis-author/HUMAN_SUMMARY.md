# `mergers-and-acquisitions-thesis-author` — human summary format
...
```
MNA-THESIS batch <batch_run_id> complete

Wrote N MNA-THESIS(s):
  - MNA-THESIS-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - MNA-THESIS-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - MNA-THESIS-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        mergers-and-acquisitions-thesis-audit will run automatically on PASS items. HITL items wait for your reply.
```
