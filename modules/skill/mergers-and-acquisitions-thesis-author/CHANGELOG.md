...
- NATS event emission for `mna-thesis_written`, `batch_complete`, `hitl_pause`.
...
- Self-audit passes on its own input set at 10/10 by `mergers-and-acquisitions-thesis-audit`.
