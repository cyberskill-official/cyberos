# `dsr-runbook` audit-report format

Every `data-subject-request-runbook-audit` invocation writes a sibling `dsr-runbook.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "dsr-runbook_rubric@1.0"
audited_file:           "./dsr-runbooks/DSR-RUNBOOK-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "dsr-runbook_rubric@1.0"
