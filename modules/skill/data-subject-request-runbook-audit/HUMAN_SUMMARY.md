# `data-subject-request-runbook-audit` — human summary format
...
```
DSR-RUNBOOK audit batch complete

Audited N DSR-RUNBOOK(s):
  - DSR-RUNBOOK-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - DSR-RUNBOOK-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - DSR-RUNBOOK-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        dsr-runbook_rubric@1.0
