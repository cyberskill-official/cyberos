...
description: |
  Audit one or more existing data-subject-request-runbook@1 markdowns against
  dsr-runbook_rubric@1.0. Produces a sibling .audit.md per artefact plus
  ...
  data-subject-request-runbook-author.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
