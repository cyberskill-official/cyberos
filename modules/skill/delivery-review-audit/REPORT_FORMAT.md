# `delivery-review` audit-report format

Every `delivery-review-audit` invocation writes a sibling `delivery-review.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "delivery-review_rubric@1.0"
audited_file:           "./delivery-reviews/DELIVERY_REVIEW-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "delivery-review_rubric@1.0"
