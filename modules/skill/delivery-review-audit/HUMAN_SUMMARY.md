# `delivery-review-audit` — human summary format
...
```
DELIVERY_REVIEW audit batch complete

Audited N DELIVERY_REVIEW(s):
  - DELIVERY_REVIEW-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - DELIVERY_REVIEW-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - DELIVERY_REVIEW-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        delivery-review_rubric@1.0
