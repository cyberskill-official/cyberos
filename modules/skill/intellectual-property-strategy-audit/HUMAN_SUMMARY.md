# `intellectual-property-strategy-audit` — human summary format
...
```
IP_STRATEGY audit batch complete

Audited N IP_STRATEGY(s):
  - IP_STRATEGY-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - IP_STRATEGY-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - IP_STRATEGY-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        ip-strategy_rubric@1.0
