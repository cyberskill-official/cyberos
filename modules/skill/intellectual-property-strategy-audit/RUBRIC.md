# ip-strategy_rubric@1.0 — compact universal rubric
...
| FM-002 | `artefact_type` matches `intellectual-property-strategy@1` |
...
| ID | Rule |
|---|---|
| SEC-001 | Every H2 in `contracts/intellectual-property-strategy/template.md` is present in the authored artefact |
