# `security-strategy` audit-report format

Every `security-strategy-audit` invocation writes a sibling `security-strategy.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "security-strategy_rubric@1.0"
audited_file:           "./security-strategys/SECURITY_STRATEGY-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "security-strategy_rubric@1.0"
