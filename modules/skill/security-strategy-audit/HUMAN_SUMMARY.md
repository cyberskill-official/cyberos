# `security-strategy-audit` — human summary format
...
```
SECURITY_STRATEGY audit batch complete

Audited N SECURITY_STRATEGY(s):
  - SECURITY_STRATEGY-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - SECURITY_STRATEGY-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - SECURITY_STRATEGY-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        security-strategy_rubric@1.0
