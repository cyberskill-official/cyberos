# `stage-gate-author` — human summary format
...
```
STAGE-GATE batch <batch_run_id> complete

Wrote N STAGE-GATE(s):
  - STAGE-GATE-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - STAGE-GATE-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - STAGE-GATE-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        stage-gate-audit will run automatically on PASS items. HITL items wait for your reply.
```
