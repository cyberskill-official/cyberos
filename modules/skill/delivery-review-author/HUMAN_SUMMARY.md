# `delivery-review-author` — human summary format
...
```
DELIVERY_REVIEW batch <batch_run_id> complete

Wrote N DELIVERY_REVIEW(s):
  - DELIVERY_REVIEW-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - DELIVERY_REVIEW-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - DELIVERY_REVIEW-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        delivery-review-audit will run automatically on PASS items. HITL items wait for your reply.
```
