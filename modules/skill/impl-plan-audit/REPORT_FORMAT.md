# `impl-plan` audit-report format

Every `impl-plan-audit` invocation writes a sibling `impl-plan.audit.md` per audited artefact. The report format below is normative.
...
audited_file:           "./impl-plans/IMPL-PLAN-001-foo.md"
