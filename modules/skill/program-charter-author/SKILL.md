...
description: |
  Author a per-program charter (purpose + scope-in + scope-out + governance + success criteria + funding envelope + risks + timeline + executive sponsor). PMI Program Management Standard. Chief Transformation Officer or Chief Innovation Officer authored.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
