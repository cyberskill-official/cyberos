# `program-charter-author` — human summary format
...
```
PROGRAM-CHARTER batch <batch_run_id> complete

Wrote N PROGRAM-CHARTER(s):
  - PROGRAM-CHARTER-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - PROGRAM-CHARTER-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - PROGRAM-CHARTER-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        program-charter-audit will run automatically on PASS items. HITL items wait for your reply.
```
