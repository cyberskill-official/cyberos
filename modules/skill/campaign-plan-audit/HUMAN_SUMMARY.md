# `campaign-plan-audit` — human summary format
...
```
CAMPAIGN-PLAN audit batch complete

Audited N CAMPAIGN-PLAN(s):
  - CAMPAIGN-PLAN-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - CAMPAIGN-PLAN-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - CAMPAIGN-PLAN-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        campaign-plan_rubric@1.0
