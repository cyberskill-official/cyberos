# `campaign-plan` audit-report format

Every `campaign-plan-audit` invocation writes a sibling `campaign-plan.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "campaign-plan_rubric@1.0"
audited_file:           "./campaign-plans/CAMPAIGN-PLAN-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "campaign-plan_rubric@1.0"
