...
description: |
  Audit one or more existing campaign-plan@1 markdowns against
  campaign-plan_rubric@1.0. Produces a sibling .audit.md per artefact plus
