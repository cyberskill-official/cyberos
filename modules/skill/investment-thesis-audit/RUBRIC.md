# `investment_thesis_rubric@1.0` — machine-checkable Investment Thesis rubric
...
| `FM-004` | `template` equals `investment-thesis@1` | error | true |
...
Per the `contracts/investment-thesis/template.md` H2 list.
