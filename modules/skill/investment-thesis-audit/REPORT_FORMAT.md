# `investment-thesis` audit-report format

Every `investment-thesis-audit` invocation writes a sibling `investment-thesis.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "investment-thesis_rubric@1.0"
audited_file:           "./investment-thesiss/INVESTMENT-THESIS-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "investment-thesis_rubric@1.0"
