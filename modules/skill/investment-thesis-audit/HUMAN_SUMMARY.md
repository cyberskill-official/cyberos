# `investment-thesis-audit` — human summary format
...
```
INVESTMENT-THESIS audit batch complete

Audited N INVESTMENT-THESIS(s):
  - INVESTMENT-THESIS-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - INVESTMENT-THESIS-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - INVESTMENT-THESIS-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        investment-thesis_rubric@1.0
