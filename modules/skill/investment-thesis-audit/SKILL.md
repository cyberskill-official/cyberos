---
# ── Identity ─────────────────────────────────────────────────────────
name: investment-thesis-audit
description: >-
  Audit one or more existing investment-thesis@1 markdowns against investment-thesis_rubric@1.0. Produces a sibling .audit.md per artefact plus an AUDIT_BATCH_SUMMARY. Halts on needs_human verdicts; resumable on audited_file_sha256. Standalone trigger or chains naturally after investment-thesis-author. Use when user asks to "audit this investment thesis" or "check the investment thesis". Do NOT use for "draft a new investment thesis" (use investment-thesis-author instead).
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
  stage: cross
  cyberos-template: investment-thesis@1
  cyberos-rubric-version: investment-thesis_rubric@1.0
...
depends_on_contracts:
  - id:        investment-thesis
    ...
    pin_path:  cyberos/skill/contracts/investment-thesis/
  - id:        nats-subjects
    version:   v1
...
# investment-thesis-audit — INVESTMENT-THESIS auditor

> Standalone trigger that runs `investment-thesis_rubric@1.0` against one or
> more existing `investment-thesis@1` markdowns and writes a sibling
> `investment-thesis.audit.md` per item. Halts on `needs_human` verdicts via
> the standard Question primitive; resumable on `audited_file_sha256`.
> Chains naturally after [`investment-thesis-author`](../investment-thesis-author/SKILL.md).

`prompt_revision: investment-thesis_audit@1.0.0`

## When to invoke this skill

CUO routes a request here when the user wants to:

- "Audit these existing `INVESTMENT-THESIS`s."
- "Has `INVESTMENT-THESIS-007` changed since the last audit?"
- "Tell me which `INVESTMENT-THESIS`s would fail acceptance today."

Also invoked automatically by the supervisor when `investment-thesis-author`'s output envelope sets `next_skill_recommendation: investment-thesis-audit` (the default chain).
...
```
CONTRACT_ECHO
skill_id:                        investment-thesis-audit
skill_version:                   1.0.0
prompt_revision:                 investment-thesis_audit@1.0.0
template_version:                investment-thesis@1   (loaded from cyberos/skill/contracts/investment-thesis/template.md)
audit_rubric_version:            investment-thesis_rubric@1.0
...
```json
{
  "artefact_paths": ["./investment-thesiss/INVESTMENT-THESIS-001-foo.md", "./investment-thesiss/INVESTMENT-THESIS-002-bar.md"],
  "caller_persona": "cuo-cpo",
  "trace_id": "<uuid>",
  "upstream_context": {
    "from_skill": "investment-thesis-author",
    "manifest_path": "./investment-thesiss/manifest.json"
  }
}
```
...
```json
{
  ...
  "exit_code": 1,
  "per_artefact": [
    {"artefact_path": "./investment-thesiss/INVESTMENT-THESIS-001-foo.md", "audit_path": "./investment-thesiss/INVESTMENT-THESIS-001-foo.audit.md", "status": "pass", "iterations": 1, "audited_file_sha256": "<hex>"},
    {"artefact_path": "./investment-thesiss/INVESTMENT-THESIS-002-bar.md", "audit_path": "./investment-thesiss/INVESTMENT-THESIS-002-bar.audit.md", "status": "needs_human", "iterations": 3, "audited_file_sha256": "<hex>"}
  ],
  "hitl_required": true,
...
```
Persona: cuo-cpo
Skill:   investment-thesis-audit
Input:
  artefact_paths:  [./team-a/INVESTMENT-THESIS-001-something.md, ./team-b/INVESTMENT-THESIS-018-other.md]
  caller_persona:  cuo-cpo
  trace_id:        <uuid>
