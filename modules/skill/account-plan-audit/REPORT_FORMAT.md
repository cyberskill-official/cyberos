# `account-plan` audit-report format

Every `account-plan-audit` invocation writes a sibling `account-plan.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "account-plan_rubric@1.0"
audited_file:           "./account-plans/ACCOUNT-PLAN-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "account-plan_rubric@1.0"
