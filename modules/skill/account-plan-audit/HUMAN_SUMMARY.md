# `account-plan-audit` — human summary format
...
```
ACCOUNT-PLAN audit batch complete

Audited N ACCOUNT-PLAN(s):
  - ACCOUNT-PLAN-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - ACCOUNT-PLAN-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - ACCOUNT-PLAN-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        account-plan_rubric@1.0
