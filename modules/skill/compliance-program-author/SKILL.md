...
description: |
  Author the compliance management system (applicable regulations + regulatory-mapping matrix + control catalog with owner + training plan + incident-response procedure + audit cadence). CCO-Compliance authored.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
