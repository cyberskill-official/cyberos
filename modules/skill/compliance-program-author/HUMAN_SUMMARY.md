# `compliance-program-author` — human summary format
...
```
COMPLIANCE-PROGRAM batch <batch_run_id> complete

Wrote N COMPLIANCE-PROGRAM(s):
  - COMPLIANCE-PROGRAM-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - COMPLIANCE-PROGRAM-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - COMPLIANCE-PROGRAM-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        compliance-program-audit will run automatically on PASS items. HITL items wait for your reply.
```
