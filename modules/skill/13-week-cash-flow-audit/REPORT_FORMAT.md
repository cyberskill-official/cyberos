# `13-week-cash-flow` audit-report format

Every `13-week-cash-flow-audit` invocation writes a sibling `13-week-cash-flow.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "13-week-cash-flow_rubric@1.0"
audited_file:           "./13-week-cash-flows/13-WEEK-CASH-FLOW-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "13-week-cash-flow_rubric@1.0"
