...
| `FM-004` | `template` equals `13-week-cash-flow@1` | error | true |
...
Per the `contracts/13-week-cash-flow/template.md` H2 list.
...
- `cyberos/skill/contracts/13-week-cash-flow/CONTRACT.md` + `template.md`
