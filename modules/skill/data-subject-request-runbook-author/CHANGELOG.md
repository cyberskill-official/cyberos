...
- NATS event emission for `dsr-runbook_written`, `batch_complete`, `hitl_pause`.
...
- Self-audit passes on its own input set at 10/10 by `data-subject-request-runbook-audit`.
