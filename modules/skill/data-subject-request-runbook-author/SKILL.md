...
description: |
  Author the DSR runbook (intake workflow + identity verification + data-search procedure + response-template library + regulatory-deadline tracking + DPO escalation). CPO-Privacy authored. Covers GDPR Articles 15-22 + Vietnam Decree 13/2023 DSR rights.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
