# `data-subject-request-runbook-author` — human summary format
...
```
DSR-RUNBOOK batch <batch_run_id> complete

Wrote N DSR-RUNBOOK(s):
  - DSR-RUNBOOK-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - DSR-RUNBOOK-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - DSR-RUNBOOK-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        data-subject-request-runbook-audit will run automatically on PASS items. HITL items wait for your reply.
```
