...
description: |
  Author the quarterly NPS program (survey instrument + cohort coverage + response-rate target + detractor outreach + promoter activation + action plan). CCO-Customer or CPO-Product authored.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
