...
contract_version: v1
template_literal: change-mgmt-plan@1
description: Canonical change-mgmt-plan@1 — per-program change-mgmt plan authored by chief-transformation-officer; stakeholder analysis + comms plan + training plan + adoption tracking.
...
# `change-mgmt-plan@1` — canonical Change Management Plan contract

> Frontmatter: `change-mgmt-plan-audit/RUBRIC.md` §2.
...
- Consumers: `change-mgmt-plan-author`, `change-mgmt-plan-audit`.
