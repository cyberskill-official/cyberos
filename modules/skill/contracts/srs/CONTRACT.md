...
# `srs@1` — canonical SRS contract

> Loaded by `cuo/chief-technology-officer/srs-author` (generation skeleton); will be loaded by `cuo/chief-technology-officer/srs-audit` v0.1.0 (registry v0.2.6) as validation target. Sits downstream of `prd@1`: every SRS references a PRD by `prd_ref` field. SRS is the engineering-side detailing of what the product spec promises.
...
| `prd_ref` | path or memory_id of the source `prd@1` (required — every SRS is downstream of a PRD) | yes | FM-111 |
...
- Future consumers: `cuo/chief-technology-officer/srs-author` v0.1.0, `cuo/chief-technology-officer/srs-audit` v0.1.0, `cuo/chief-technology-officer/fr-to-tech-spec` v0.2.0+.
