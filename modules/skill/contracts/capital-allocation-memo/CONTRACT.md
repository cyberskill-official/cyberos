...
contract_version: v1
template_literal: capital-allocation-memo@1
description: Canonical capital-allocation-memo@1 — capital-allocation decision memo authored by ceo or cfo for board approval — buy vs build vs partner vs M&A.
...
# `capital-allocation-memo@1` — canonical Capital-Allocation Memo contract

> Frontmatter: `capital-allocation-memo-audit/RUBRIC.md` §2.
...
- Consumers: `capital-allocation-memo-author`, `capital-allocation-memo-audit`.
