...
contract_version: v1
template_literal: key-risk-indicator-dashboard@1
description: Canonical key-risk-indicator-dashboard@1 — quarterly KRI dashboard authored by cro-risk; key risk indicators with breach thresholds + trend analysis.
...
# `key-risk-indicator-dashboard@1` — canonical KRI Dashboard contract

> Frontmatter: `key-risk-indicator-dashboard-audit/RUBRIC.md` §2.
...
- Consumers: `key-risk-indicator-dashboard-author`, `key-risk-indicator-dashboard-audit`.
