...
description: Canonical stage-gate@1 — one-page Go / Go-with-conditions / No-Go sign-off for a SDLC stage boundary. Authored by stage-gate-author; validated by stage-gate-audit via stage_gate_rubric@1.0. Implements modules/cuo/docs/appendices.md (§13 Software Development Process) Template §4.3.
