...
- `../../../../modules/cuo/docs/module.md` §4.9 — SOW skeleton source.
- `../../../../modules/cuo/docs/module.md` §6 — Engagement models + IP + AI-tool usage policy.
