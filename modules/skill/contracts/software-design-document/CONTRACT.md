...
description: Canonical software-design-document@1 — Software Design Description per IEEE 1016-2009. Authored by software-design-document-author; validated by software-design-document-audit via sdd_rubric@1.0. Implements modules/cuo/docs/appendices.md (§13 Software Development Process) §2(e).
...
# `software-design-document@1` — canonical Software Design Description contract

> Frontmatter: `software-design-document-audit/RUBRIC.md` §2.
...
- Consumers: `software-design-document-author`, `software-design-document-audit`, downstream `implementation-plan-author` (links to SDD via `linked_sdd`).
