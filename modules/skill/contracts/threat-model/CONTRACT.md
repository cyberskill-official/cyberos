...
description: Canonical threat-model@1 — STRIDE threat model with OWASP Top 10:2025 + ASVS mapping. Authored by threat-model-author; validated by threat-model-audit via threat_model_rubric@1.0. Implements modules/cuo/docs/appendices.md (§13 Software Development Process) §2(d) security review.
