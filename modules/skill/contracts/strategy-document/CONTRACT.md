...
contract_version: v1
template_literal: strategy-document@1
description: Canonical strategy-document@1 — annual 3-5yr strategy document authored by cso-strategy or ceo; vision + diagnosis + guiding policy + coherent actions (per Rumelt good-strategy structure).
...
# `strategy-document@1` — canonical Strategy Document contract

> Frontmatter: `strategy-document-audit/RUBRIC.md` §2.
...
- Consumers: `strategy-document-author`, `strategy-document-audit`.
