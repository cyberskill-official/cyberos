...
<!-- Pick the subsection that matches engagement_model — see sow-audit/RUBRIC.md §4 COND-001..005 -->

## 6. Team and Roles

RACI per Software Development Process.md §2.
...
<!-- ── Conditionally-required sections (uncomment + fill as needed; see sow-audit/RUBRIC.md §4) ── -->
<!--
