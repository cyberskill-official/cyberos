...
description: Canonical project-plan@1 — feasibility memo + project plan + RAID log + communication plan emitted by project-plan-author. Validated by project-plan-audit via project_plan_rubric@1.0. Implements Software Development Process.md §2(c).
