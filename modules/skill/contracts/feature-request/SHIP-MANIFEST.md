# ship-manifest@1 - per-FR run state for chief-technology-officer/ship-feature-requests (FR-CUO-206)
...
Location: `docs/feature-requests/.workflow/<FR-ID>.ship.json` (gitignored via the scaffolded
...
| fr_id | string | the FR being shipped |
