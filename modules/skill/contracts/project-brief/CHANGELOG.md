...
First contract authored under the v0.2.4 simplified flat-folder layout (no `v<n>/` sub-tree per REF-018 in memory). The `contract_version: v1` lives in CONTRACT.md frontmatter; future major versions will append to this single CHANGELOG.
