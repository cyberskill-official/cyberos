...
description: Canonical code-review@1 — structured PR review write-up per IEEE 1028. Authored by code-review-author; validated by code-review-audit via code_review_rubric@1.0. Implements modules/cuo/docs/appendices.md (§13 Software Development Process) §2(g) + Template §4.5.
