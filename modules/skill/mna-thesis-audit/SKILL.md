---
# ── Identity ─────────────────────────────────────────────────────────
name: mna-thesis-audit
description: |
  Audit one or more existing mna-thesis@1 markdowns against
...
# mna-thesis-audit — MNA-THESIS auditor

> Standalone trigger that runs `mna-thesis_rubric@1.0` against one or
> more existing `mna-thesis@1` markdowns and writes a sibling
...
> Chains naturally after [`mna-thesis-author`](../mna-thesis-author/SKILL.md).
...
Also invoked automatically by the supervisor when `mna-thesis-author`'s output envelope sets `next_skill_recommendation: mna-thesis-audit` (the default chain).
