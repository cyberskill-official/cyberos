...
| `FM-004` | `template` equals `mna-thesis@1` | error | true |
...
Per the `contracts/mna-thesis/template.md` H2 list — every H2 in template MUST be present + non-empty in the authored artefact.

| rule_id | Check | Severity |
| ------- | ----- | -------- |
| `SEC-001` | Every H2 declared in `contracts/mna-thesis/template.md` is present in the authored artefact | error |
...
- `cyberos/skill/contracts/mna-thesis/CONTRACT.md` + `template.md`
