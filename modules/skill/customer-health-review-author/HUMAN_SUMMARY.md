# `customer-health-review-author` — human summary format
...
```
CUSTOMER_HEALTH_REVIEW batch <batch_run_id> complete

Wrote N CUSTOMER_HEALTH_REVIEW(s):
  - CUSTOMER_HEALTH_REVIEW-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - CUSTOMER_HEALTH_REVIEW-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - CUSTOMER_HEALTH_REVIEW-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        customer-health-review-audit will run automatically on PASS items. HITL items wait for your reply.
```
