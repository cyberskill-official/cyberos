...
- NATS event emission for `customer-health-review_written`, `batch_complete`, `hitl_pause`.
...
- Self-audit passes on its own input set at 10/10 by `customer-health-review-audit`.
