# `nda-triage` audit-report format

Every `nda-triage-audit` invocation writes a sibling `nda-triage.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "nda-triage_rubric@1.0"
audited_file:           "./nda-triages/NDA_TRIAGE-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "nda-triage_rubric@1.0"
