# `onboarding-pack-author` — human summary format
...
```
ONBOARDING-PACK batch <batch_run_id> complete

Wrote N ONBOARDING-PACK(s):
  - ONBOARDING-PACK-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - ONBOARDING-PACK-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - ONBOARDING-PACK-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        onboarding-pack-audit will run automatically on PASS items. HITL items wait for your reply.
```
