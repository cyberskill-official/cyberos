...
description: |
  Author a per-new-hire (or per-executive) onboarding pack (pre-start checklist + day-1 + week-1 milestones + 30/60/90 + buddy + first-quarter review template). CHRO authored; Chief of Staff for exec onboarding.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
