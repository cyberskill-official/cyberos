# `customer-success-engagement-audit` — human summary format
...
```
CS-ENGAGEMENT audit batch complete

Audited N CS-ENGAGEMENT(s):
  - CS-ENGAGEMENT-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - CS-ENGAGEMENT-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - CS-ENGAGEMENT-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        cs-engagement_rubric@1.0
