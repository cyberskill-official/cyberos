...
description: |
  Audit one or more existing customer-success-engagement@1 markdowns against
  cs-engagement_rubric@1.0. Produces a sibling .audit.md per artefact plus
  ...
  customer-success-engagement-author.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
