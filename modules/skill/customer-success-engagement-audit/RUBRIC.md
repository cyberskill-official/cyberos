# `cs_engagement_rubric@1.0` — machine-checkable CS Engagement rubric
...
| `FM-004` | `template` equals `customer-success-engagement@1` | error | true |
...
Per the `contracts/customer-success-engagement/template.md` H2 list. Each H2 in the template MUST be present + non-empty in the authored artefact. See template for the canonical headings.

| rule_id | Check | Severity |
| ------- | ----- | -------- |
| `SEC-001` | Every H2 declared in `contracts/customer-success-engagement/template.md` is present in the authored artefact | error |
...
- `cyberos/skill/contracts/customer-success-engagement/CONTRACT.md` + `template.md`
