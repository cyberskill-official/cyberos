...
description: |
  Author a quarterly workforce plan (current headcount + hiring ramp + attrition forecast + internal mobility + skills coverage + AI-fluency target + cost projection). CHRO authored.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
