...
description: |
  Author the annual data-governance framework (classification + stewardship + access control + retention + lineage + privacy controls + compliance mapping). CDO-Data + CCO-Compliance + CPO-Privacy co-authored.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
