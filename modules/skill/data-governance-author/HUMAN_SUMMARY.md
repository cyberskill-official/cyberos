# `data-governance-author` — human summary format
...
```
DATA-GOVERNANCE batch <batch_run_id> complete

Wrote N DATA-GOVERNANCE(s):
  - DATA-GOVERNANCE-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - DATA-GOVERNANCE-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - DATA-GOVERNANCE-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        data-governance-audit will run automatically on PASS items. HITL items wait for your reply.
```
