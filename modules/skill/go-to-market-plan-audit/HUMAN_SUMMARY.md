# `go-to-market-plan-audit` — human summary format
...
```
GTM_PLAN audit batch complete

Audited N GTM_PLAN(s):
  - GTM_PLAN-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - GTM_PLAN-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - GTM_PLAN-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        gtm-plan_rubric@1.0
