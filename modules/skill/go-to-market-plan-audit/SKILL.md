...
description: >-
  ...
  go-to-market-plan-author.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
  stage: cross
  cyberos-template: go-to-market-plan@1
...
depends_on_contracts:
  - id:        gtm-plan
    ...
    pin_path:  cyberos/skill/contracts/go-to-market-plan/
  - id:        nats-subjects
    version:   v1
...
# go-to-market-plan-audit — GTM_PLAN auditor

> Standalone trigger that runs `gtm-plan_rubric@1.0` against one or
> more existing `go-to-market-plan@1` markdowns and writes a sibling
...
> Chains naturally after [`go-to-market-plan-author`](../go-to-market-plan-author/SKILL.md).
...
Also invoked automatically by the supervisor when `go-to-market-plan-author`'s output envelope sets `next_skill_recommendation: go-to-market-plan-audit` (the default chain).
...
```
CONTRACT_ECHO
skill_id:                        go-to-market-plan-audit
skill_version:                   1.0.0
prompt_revision:                 gtm-plan_audit@1.0.0
...
```json
{
  ...
  "trace_id": "<uuid>",
  "upstream_context": {
    "from_skill": "go-to-market-plan-author",
