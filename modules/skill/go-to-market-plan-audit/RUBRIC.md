# gtm-plan_rubric@1.0 — compact universal rubric
...
| FM-002 | `artefact_type` matches `go-to-market-plan@1` |
...
| ID | Rule |
|---|---|
| SEC-001 | Every H2 in `contracts/go-to-market-plan/template.md` is present in the authored artefact |
