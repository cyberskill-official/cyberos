# `gtm-plan` audit-report format

Every `go-to-market-plan-audit` invocation writes a sibling `gtm-plan.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "gtm-plan_rubric@1.0"
audited_file:           "./gtm-plans/GTM_PLAN-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "gtm-plan_rubric@1.0"
