# `soc2-evidence-author` — human summary format
...
```
SOC2_EVIDENCE batch <batch_run_id> complete

Wrote N SOC2_EVIDENCE(s):
  - SOC2_EVIDENCE-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - SOC2_EVIDENCE-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - SOC2_EVIDENCE-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        soc2-evidence-audit will run automatically on PASS items. HITL items wait for your reply.
```
