...
- NATS event emission for `kri-dashboard_written`, `batch_complete`, `hitl_pause`.
...
- Self-audit passes on its own input set at 10/10 by `key-risk-indicator-dashboard-audit`.
