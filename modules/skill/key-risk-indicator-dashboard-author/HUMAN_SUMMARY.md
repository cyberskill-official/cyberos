# `key-risk-indicator-dashboard-author` — human summary format
...
```
KRI-DASHBOARD batch <batch_run_id> complete

Wrote N KRI-DASHBOARD(s):
  - KRI-DASHBOARD-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - KRI-DASHBOARD-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - KRI-DASHBOARD-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        key-risk-indicator-dashboard-audit will run automatically on PASS items. HITL items wait for your reply.
```
