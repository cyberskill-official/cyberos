...
description: |
  Audit one or more existing hire-decision@1 markdowns against
  hire-decision_rubric@1.0. Produces a sibling .audit.md per artefact plus
