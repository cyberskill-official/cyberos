# `hire-decision-audit` — human summary format
...
```
HIRE-DECISION audit batch complete

Audited N HIRE-DECISION(s):
  - HIRE-DECISION-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - HIRE-DECISION-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - HIRE-DECISION-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        hire-decision_rubric@1.0
