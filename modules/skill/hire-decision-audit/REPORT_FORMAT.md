# `hire-decision` audit-report format

Every `hire-decision-audit` invocation writes a sibling `hire-decision.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "hire-decision_rubric@1.0"
audited_file:           "./hire-decisions/HIRE-DECISION-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "hire-decision_rubric@1.0"
