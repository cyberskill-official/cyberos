# `hire_decision_rubric@1.0` — machine-checkable Hire Decision rubric
...
| `FM-004` | `template` equals `hire-decision@1` | error | true |
...
Per the `contracts/hire-decision/template.md` H2 list. Each H2 in the template MUST be present + non-empty in the authored artefact. See template for the canonical headings.

| rule_id | Check | Severity |
| ------- | ----- | -------- |
| `SEC-001` | Every H2 declared in `contracts/hire-decision/template.md` is present in the authored artefact | error |
...
- `cyberos/skill/contracts/hire-decision/CONTRACT.md` + `template.md`
