...
name: rtm-audit
description: |
  Audit one or more existing rtm@1 markdowns against
...
Also invoked automatically by the supervisor when `rtm-author`'s output envelope sets `next_skill_recommendation: rtm-audit` (the default chain).
