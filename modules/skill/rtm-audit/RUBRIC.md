...
> Sourced from `cyberos/docs/Software Development Process.md` §3 Traceability matrix + Template §4.4. Rubric version `1.0` is locked.
...
| `FM-004` | `template` equals `rtm@1` | error | true |
...
- `cyberos/docs/Software Development Process.md` §3 + Template §4.4 — RTM source
