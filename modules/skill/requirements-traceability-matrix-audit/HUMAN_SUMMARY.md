# `requirements-traceability-matrix-audit` — human summary format
...
```
RTM audit batch complete

Audited N RTM(s):
  - RTM-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - RTM-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - RTM-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        rtm_rubric@1.0
