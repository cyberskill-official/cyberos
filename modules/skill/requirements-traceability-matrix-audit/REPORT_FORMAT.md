# `rtm` audit-report format

Every `requirements-traceability-matrix-audit` invocation writes a sibling `rtm.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "rtm_rubric@1.0"
audited_file:           "./rtms/RTM-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "rtm_rubric@1.0"
