# `rhythm-of-business-author` — human summary format
...
```
RHYTHM-OF-BUSINESS batch <batch_run_id> complete

Wrote N RHYTHM-OF-BUSINESS(s):
  - RHYTHM-OF-BUSINESS-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - RHYTHM-OF-BUSINESS-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - RHYTHM-OF-BUSINESS-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        rhythm-of-business-audit will run automatically on PASS items. HITL items wait for your reply.
```
