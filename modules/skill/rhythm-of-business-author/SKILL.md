...
description: |
  Author the annual + quarterly rhythm-of-business calendar (annual cadence map + quarterly drumbeat + weekly rhythm + per-function review + blackout windows). Chief of Staff authored.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
