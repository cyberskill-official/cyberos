...
- NATS event emission for `rhythm-of-business_written`, `batch_complete`, `hitl_pause`.
...
- Self-audit passes on its own input set at 10/10 by `rhythm-of-business-audit`.
