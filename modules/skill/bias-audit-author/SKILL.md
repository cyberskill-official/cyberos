...
description: |
  Author a quarterly bias audit for each AI feature in production (feature inventory + fairness metrics per feature + pass/fail per metric + remediation plan + next-audit date). Chief Ethics Officer + CAIO co-authored.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
