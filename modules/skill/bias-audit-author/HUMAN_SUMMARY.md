# `bias-audit-author` — human summary format
...
```
BIAS-AUDIT batch <batch_run_id> complete

Wrote N BIAS-AUDIT(s):
  - BIAS-AUDIT-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - BIAS-AUDIT-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - BIAS-AUDIT-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        bias-audit-audit will run automatically on PASS items. HITL items wait for your reply.
```
