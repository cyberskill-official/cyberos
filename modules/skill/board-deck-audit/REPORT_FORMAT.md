# `board-deck` audit-report format

Every `board-deck-audit` invocation writes a sibling `board-deck.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "board-deck_rubric@1.0"
audited_file:           "./board-decks/BOARD-DECK-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "board-deck_rubric@1.0"
