# `board-deck-audit` — human summary format
...
```
BOARD-DECK audit batch complete

Audited N BOARD-DECK(s):
  - BOARD-DECK-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - BOARD-DECK-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - BOARD-DECK-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        board-deck_rubric@1.0
