# `board_deck_rubric@1.0` — machine-checkable Board Deck rubric
...
| `FM-004` | `template` equals `board-deck@1` | error | true |
...
Per the `contracts/board-deck/template.md` H2 list. Each H2 in the template MUST be present + non-empty in the authored artefact. See template for the canonical headings.

| rule_id | Check | Severity |
| ------- | ----- | -------- |
| `SEC-001` | Every H2 declared in `contracts/board-deck/template.md` is present in the authored artefact | error |
...
- `cyberos/skill/contracts/board-deck/CONTRACT.md` + `template.md`
