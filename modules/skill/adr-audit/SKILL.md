...
name: adr-audit
description: |
  Audit one or more existing adr@1 markdowns against
...
Also invoked automatically by the supervisor when `adr-author`'s output envelope sets `next_skill_recommendation: adr-audit` (the default chain).
