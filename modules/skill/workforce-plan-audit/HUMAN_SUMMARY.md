# `workforce-plan-audit` — human summary format
...
```
WORKFORCE-PLAN audit batch complete

Audited N WORKFORCE-PLAN(s):
  - WORKFORCE-PLAN-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - WORKFORCE-PLAN-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - WORKFORCE-PLAN-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        workforce-plan_rubric@1.0
