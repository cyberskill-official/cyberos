# `workforce-plan` audit-report format

Every `workforce-plan-audit` invocation writes a sibling `workforce-plan.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "workforce-plan_rubric@1.0"
audited_file:           "./workforce-plans/WORKFORCE-PLAN-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "workforce-plan_rubric@1.0"
