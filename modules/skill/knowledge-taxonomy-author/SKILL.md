...
description: |
  Author the quarterly knowledge-taxonomy refresh (tag hierarchy + categorisation rules + metadata schema + search-evolution roadmap + freshness audit policy + coverage gap analysis). ANSI Z39.19 thesaurus standard. Chief Knowledge Officer authored.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
