# `knowledge-taxonomy-author` — human summary format
...
```
KNOWLEDGE-TAXONOMY batch <batch_run_id> complete

Wrote N KNOWLEDGE-TAXONOMY(s):
  - KNOWLEDGE-TAXONOMY-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - KNOWLEDGE-TAXONOMY-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - KNOWLEDGE-TAXONOMY-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        knowledge-taxonomy-audit will run automatically on PASS items. HITL items wait for your reply.
```
