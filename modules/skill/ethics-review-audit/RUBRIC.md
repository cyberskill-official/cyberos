# `ethics_review_rubric@1.0` — machine-checkable Ethics Review rubric
...
| `FM-004` | `template` equals `ethics-review@1` | error | true |
...
Per the `contracts/ethics-review/template.md` H2 list — every H2 in template MUST be present + non-empty in the authored artefact.

| rule_id | Check | Severity |
| ------- | ----- | -------- |
| `SEC-001` | Every H2 declared in `contracts/ethics-review/template.md` is present in the authored artefact | error |
...
- `cyberos/skill/contracts/ethics-review/CONTRACT.md` + `template.md`
