# `ethics-review` audit-report format

Every `ethics-review-audit` invocation writes a sibling `ethics-review.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "ethics-review_rubric@1.0"
audited_file:           "./ethics-reviews/ETHICS-REVIEW-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "ethics-review_rubric@1.0"
