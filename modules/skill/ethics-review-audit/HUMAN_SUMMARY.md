# `ethics-review-audit` — human summary format
...
```
ETHICS-REVIEW audit batch complete

Audited N ETHICS-REVIEW(s):
  - ETHICS-REVIEW-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - ETHICS-REVIEW-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - ETHICS-REVIEW-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        ethics-review_rubric@1.0
