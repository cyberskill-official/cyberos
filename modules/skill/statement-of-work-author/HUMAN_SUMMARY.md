# `statement-of-work-author` — human summary format
...
```
SOW batch <batch_run_id> complete

Wrote N SOW(s):
  - SOW-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - SOW-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - SOW-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        statement-of-work-audit will run automatically on PASS items. HITL items wait for your reply.
```
