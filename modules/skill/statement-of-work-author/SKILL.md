...
> Authors a Statement of Work (SOW) / Project Charter from a discovery brief, lead form, or kick-off interview. Implements the 12-section skeleton from modules/cuo/docs/appendices.md (§13 Software Development Process) §4.9. Chains naturally into [`statement-of-work-audit`](../statement-of-work-audit/SKILL.md).
