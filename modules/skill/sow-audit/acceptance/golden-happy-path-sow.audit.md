...
audited_file:           "../sow-author/acceptance/golden-happy-path-sow.md"
...
Sibling artefact: `../sow-author/acceptance/golden-happy-path-sow.md` (sow@1).

This is the **golden happy-path fixture** for the sow-author + sow-audit pair.
...
1. `sow-author` correctly emits all 12 SOW skeleton sections per Software Development Process.md §4.9.
