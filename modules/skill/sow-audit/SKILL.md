...
name: sow-audit
description: |
  Audit one or more existing sow@1 markdowns against
...
depends_on_contracts:
  - id:        sow
    ...
    pin_path:  cyberos/skill/contracts/sow/
  - id:        nats-subjects
    version:   v1
...
Also invoked automatically by the supervisor when `sow-author`'s output envelope sets `next_skill_recommendation: sow-audit` (the default chain).
...
skill_version:                   1.0.0
prompt_revision:                 sow_audit@1.0.0
template_version:                sow@1   (loaded from cyberos/skill/contracts/sow/template.md)
