# `comp-plan` audit-report format

Every `comp-plan-audit` invocation writes a sibling `comp-plan.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "comp-plan_rubric@1.0"
audited_file:           "./comp-plans/COMP-PLAN-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "comp-plan_rubric@1.0"
