...
description: |
  Audit one or more existing transformation-roadmap@1 markdowns against
  transformation-roadmap_rubric@1.0. Produces a sibling .audit.md per artefact plus
