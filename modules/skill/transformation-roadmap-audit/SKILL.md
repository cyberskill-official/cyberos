---
# ── Identity ─────────────────────────────────────────────────────────
name: transformation-roadmap-audit
description: >-
  Audit one or more existing transformation-roadmap@1 markdowns against transformation-roadmap_rubric@1.0. Produces a sibling .audit.md per artefact plus an AUDIT_BATCH_SUMMARY. Halts on needs_human verdicts; resumable on audited_file_sha256. Standalone trigger or chains naturally after transformation-roadmap-author. Use when user asks to "audit this transformation roadmap" or "check the transformation roadmap". Do NOT use for "draft a new transformation roadmap" (use transformation-roadmap-author instead).
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
  stage: cross
  cyberos-template: transformation-roadmap@1
  cyberos-rubric-version: transformation-roadmap_rubric@1.0
...
depends_on_contracts:
  - id:        transformation-roadmap
    ...
    pin_path:  cyberos/skill/contracts/transformation-roadmap/
  - id:        nats-subjects
    version:   v1
...
# transformation-roadmap-audit — TRANSFORMATION-ROADMAP auditor

> Standalone trigger that runs `transformation-roadmap_rubric@1.0` against one or
> more existing `transformation-roadmap@1` markdowns and writes a sibling
> `transformation-roadmap.audit.md` per item. Halts on `needs_human` verdicts via
> the standard Question primitive; resumable on `audited_file_sha256`.
> Chains naturally after [`transformation-roadmap-author`](../transformation-roadmap-author/SKILL.md).

`prompt_revision: transformation-roadmap_audit@1.0.0`

## When to invoke this skill

CUO routes a request here when the user wants to:

- "Audit these existing `TRANSFORMATION-ROADMAP`s."
- "Has `TRANSFORMATION-ROADMAP-007` changed since the last audit?"
- "Tell me which `TRANSFORMATION-ROADMAP`s would fail acceptance today."

Also invoked automatically by the supervisor when `transformation-roadmap-author`'s output envelope sets `next_skill_recommendation: transformation-roadmap-audit` (the default chain).
...
skill_version:                   1.0.0
prompt_revision:                 transformation-roadmap_audit@1.0.0
template_version:                transformation-roadmap@1   (loaded from cyberos/skill/contracts/transformation-roadmap/template.md)
audit_rubric_version:            transformation-roadmap_rubric@1.0
...
```json
{
  "artefact_paths": ["./transformation-roadmaps/TRANSFORMATION-ROADMAP-001-foo.md", "./transformation-roadmaps/TRANSFORMATION-ROADMAP-002-bar.md"],
  "caller_persona": "cuo-cpo",
  "trace_id": "<uuid>",
  "upstream_context": {
    "from_skill": "transformation-roadmap-author",
    "manifest_path": "./transformation-roadmaps/manifest.json"
  }
}
```
...
```json
{
  ...
  "exit_code": 1,
  "per_artefact": [
    {"artefact_path": "./transformation-roadmaps/TRANSFORMATION-ROADMAP-001-foo.md", "audit_path": "./transformation-roadmaps/TRANSFORMATION-ROADMAP-001-foo.audit.md", "status": "pass", "iterations": 1, "audited_file_sha256": "<hex>"},
    {"artefact_path": "./transformation-roadmaps/TRANSFORMATION-ROADMAP-002-bar.md", "audit_path": "./transformation-roadmaps/TRANSFORMATION-ROADMAP-002-bar.audit.md", "status": "needs_human", "iterations": 3, "audited_file_sha256": "<hex>"}
  ],
  "hitl_required": true,
...
```
Persona: cuo-cpo
Skill:   transformation-roadmap-audit
Input:
  artefact_paths:  [./team-a/TRANSFORMATION-ROADMAP-001-something.md, ./team-b/TRANSFORMATION-ROADMAP-018-other.md]
  caller_persona:  cuo-cpo
  trace_id:        <uuid>
