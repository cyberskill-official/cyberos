# `transformation-roadmap-audit` — human summary format
...
```
TRANSFORMATION-ROADMAP audit batch complete

Audited N TRANSFORMATION-ROADMAP(s):
  - TRANSFORMATION-ROADMAP-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - TRANSFORMATION-ROADMAP-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - TRANSFORMATION-ROADMAP-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        transformation-roadmap_rubric@1.0
