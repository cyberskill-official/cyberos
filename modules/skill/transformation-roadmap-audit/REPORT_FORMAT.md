# `transformation-roadmap` audit-report format

Every `transformation-roadmap-audit` invocation writes a sibling `transformation-roadmap.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "transformation-roadmap_rubric@1.0"
audited_file:           "./transformation-roadmaps/TRANSFORMATION-ROADMAP-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "transformation-roadmap_rubric@1.0"
