# `statement-of-work-audit` — human summary format
...
```
SOW audit batch complete

Audited N SOW(s):
  - SOW-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - SOW-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - SOW-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        sow_rubric@1.0
