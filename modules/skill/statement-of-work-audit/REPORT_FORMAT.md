# `sow` audit-report format

Every `statement-of-work-audit` invocation writes a sibling `sow.audit.md` per audited artefact. The report format below is normative.
...
audited_file:           "./sows/SOW-001-foo.md"
