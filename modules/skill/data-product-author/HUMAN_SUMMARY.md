# `data-product-author` — human summary format
...
```
DATA-PRODUCT batch <batch_run_id> complete

Wrote N DATA-PRODUCT(s):
  - DATA-PRODUCT-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - DATA-PRODUCT-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - DATA-PRODUCT-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        data-product-audit will run automatically on PASS items. HITL items wait for your reply.
```
