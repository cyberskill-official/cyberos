# `postmortem` audit-report format

Every `postmortem-audit` invocation writes a sibling `postmortem.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "postmortem_rubric@1.0"
audited_file:           "./postmortems/POSTMORTEM-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "postmortem_rubric@1.0"
