# `postmortem-audit` — human summary format
...
```
POSTMORTEM audit batch complete

Audited N POSTMORTEM(s):
  - POSTMORTEM-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - POSTMORTEM-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - POSTMORTEM-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        postmortem_rubric@1.0
