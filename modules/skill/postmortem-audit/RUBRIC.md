...
> Sourced from `../../../modules/cuo/docs/module.md` §2(j) Operations incidents; Google SRE Book (blameless post-mortem culture). Rubric version `1.0` is locked.
...
- `../../../modules/cuo/docs/module.md` §2(j) — Operations source
