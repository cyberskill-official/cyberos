# `knowledge-taxonomy` audit-report format

Every `knowledge-taxonomy-audit` invocation writes a sibling `knowledge-taxonomy.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "knowledge-taxonomy_rubric@1.0"
audited_file:           "./knowledge-taxonomys/KNOWLEDGE-TAXONOMY-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "knowledge-taxonomy_rubric@1.0"
