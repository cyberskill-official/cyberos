# `knowledge-taxonomy-audit` — human summary format
...
```
KNOWLEDGE-TAXONOMY audit batch complete

Audited N KNOWLEDGE-TAXONOMY(s):
  - KNOWLEDGE-TAXONOMY-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - KNOWLEDGE-TAXONOMY-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - KNOWLEDGE-TAXONOMY-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        knowledge-taxonomy_rubric@1.0
