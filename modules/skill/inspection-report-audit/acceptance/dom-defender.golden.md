# /inspect report: zintaen/dom-defender
...
Findings: 12 total, 0 Critical, 3 High, 6 Medium, 3 Low. Five strengths are recorded, more than any other repository in this batch.
...
All 69 disciplines, in stable id order. 57 applicable, 12 not applicable with a recorded reason.
...
G3: pass - every VERIFIED finding carries a verbatim quote; the platform-dependent half of INS-F-0001 is recorded as an open question rather than asserted, and section 6 records four validations that were not run.
