# `employee-net-promoter-score-program-audit` — human summary format
...
```
ENPS-PROGRAM audit batch complete

Audited N ENPS-PROGRAM(s):
  - ENPS-PROGRAM-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - ENPS-PROGRAM-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - ENPS-PROGRAM-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        enps-program_rubric@1.0
