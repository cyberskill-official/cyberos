# `enps-program` audit-report format

Every `employee-net-promoter-score-program-audit` invocation writes a sibling `enps-program.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "enps-program_rubric@1.0"
audited_file:           "./enps-programs/ENPS-PROGRAM-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "enps-program_rubric@1.0"
