# `product-metrics-review-audit` — human summary format
...
```
PRODUCT_METRICS_REVIEW audit batch complete

Audited N PRODUCT_METRICS_REVIEW(s):
  - PRODUCT_METRICS_REVIEW-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - PRODUCT_METRICS_REVIEW-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - PRODUCT_METRICS_REVIEW-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        product-metrics-review_rubric@1.0
