# `product-metrics-review` audit-report format

Every `product-metrics-review-audit` invocation writes a sibling `product-metrics-review.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "product-metrics-review_rubric@1.0"
audited_file:           "./product-metrics-reviews/PRODUCT_METRICS_REVIEW-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "product-metrics-review_rubric@1.0"
