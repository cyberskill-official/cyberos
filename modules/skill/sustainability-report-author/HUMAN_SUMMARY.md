# `sustainability-report-author` — human summary format
...
```
SUSTAINABILITY-REPORT batch <batch_run_id> complete

Wrote N SUSTAINABILITY-REPORT(s):
  - SUSTAINABILITY-REPORT-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - SUSTAINABILITY-REPORT-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - SUSTAINABILITY-REPORT-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        sustainability-report-audit will run automatically on PASS items. HITL items wait for your reply.
```
