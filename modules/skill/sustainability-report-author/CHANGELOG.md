...
- NATS event emission for `sustainability-report_written`, `batch_complete`, `hitl_pause`.
...
- Self-audit passes on its own input set at 10/10 by `sustainability-report-audit`.
