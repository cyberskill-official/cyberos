...
description: |
  Author the annual sustainability report (executive summary + governance + strategy + risk-opportunity + Scope 1/2/3 metrics + targets + progress + assurance statement). CSRD/ESRS or ISSB IFRS S1/S2 framework. CSO-Sustainability or Chief ESG Officer authored.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
