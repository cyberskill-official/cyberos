# `data-strategy-author` — human summary format
...
```
DATA-STRATEGY batch <batch_run_id> complete

Wrote N DATA-STRATEGY(s):
  - DATA-STRATEGY-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - DATA-STRATEGY-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - DATA-STRATEGY-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        data-strategy-audit will run automatically on PASS items. HITL items wait for your reply.
```
