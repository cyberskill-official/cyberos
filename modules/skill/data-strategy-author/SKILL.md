...
description: |
  Author the annual data strategy (vision + data-as-product principles + governance framework + data quality charter + ML platform roadmap + investment portfolio + measurable goals). DAMA-DMBOK + Data Mesh aligned. CDO-Data authored.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
