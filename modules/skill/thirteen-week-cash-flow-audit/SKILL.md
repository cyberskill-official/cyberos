---
# ── Identity ─────────────────────────────────────────────────────────
name: thirteen-week-cash-flow-audit
description: >-
  Audit one or more existing thirteen-week-cash-flow@1 markdowns against 13-week-cash-flow_rubric@1.0. Produces a sibling .audit.md per artefact plus an AUDIT_BATCH_SUMMARY. Halts on needs_human verdicts; resumable on audited_file_sha256. Standalone trigger or chains naturally after thirteen-week-cash-flow-author. Use when user asks to "audit this thirteen week cash flow" or "check the thirteen week cash flow". Do NOT use for "draft a new thirteen week cash flow" (use thirteen-week-cash-flow-author instead).
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
  stage: cross
  cyberos-template: thirteen-week-cash-flow@1
  cyberos-rubric-version: 13-week-cash-flow_rubric@1.0
...
# thirteen-week-cash-flow-audit — 13-WEEK-CASH-FLOW auditor

> Standalone trigger that runs `13-week-cash-flow_rubric@1.0` against one or
> more existing `thirteen-week-cash-flow@1` markdowns and writes a sibling
> `13-week-cash-flow.audit.md` per item. Halts on `needs_human` verdicts via
> the standard Question primitive; resumable on `audited_file_sha256`.
> Chains naturally after [`thirteen-week-cash-flow-author`](../thirteen-week-cash-flow-author/SKILL.md).

`prompt_revision: 13-week-cash-flow_audit@1.0.0`

## When to invoke this skill

CUO routes a request here when the user wants to:

- "Audit these existing `13-WEEK-CASH-FLOW`s."
- "Has `13-WEEK-CASH-FLOW-007` changed since the last audit?"
- "Tell me which `13-WEEK-CASH-FLOW`s would fail acceptance today."

Also invoked automatically by the supervisor when `thirteen-week-cash-flow-author`'s output envelope sets `next_skill_recommendation: thirteen-week-cash-flow-audit` (the default chain).
...
audit_rubric_version:            13-week-cash-flow_rubric@1.0
...
```json
{
  "artefact_paths": ["./13-week-cash-flows/13-WEEK-CASH-FLOW-001-foo.md", "./13-week-cash-flows/13-WEEK-CASH-FLOW-002-bar.md"],
  "caller_persona": "cuo-cpo",
  "trace_id": "<uuid>",
  "upstream_context": {
    "from_skill": "thirteen-week-cash-flow-author",
...
```json
{
  ...
  "exit_code": 1,
  "per_artefact": [
    {"artefact_path": "./13-week-cash-flows/13-WEEK-CASH-FLOW-001-foo.md", "audit_path": "./13-week-cash-flows/13-WEEK-CASH-FLOW-001-foo.audit.md", "status": "pass", "iterations": 1, "audited_file_sha256": "<hex>"},
    {"artefact_path": "./13-week-cash-flows/13-WEEK-CASH-FLOW-002-bar.md", "audit_path": "./13-week-cash-flows/13-WEEK-CASH-FLOW-002-bar.audit.md", "status": "needs_human", "iterations": 3, "audited_file_sha256": "<hex>"}
  ],
  "hitl_required": true,
...
```
Persona: cuo-cpo
Skill:   thirteen-week-cash-flow-audit
Input:
  artefact_paths:  [./team-a/13-WEEK-CASH-FLOW-001-something.md, ./team-b/13-WEEK-CASH-FLOW-018-other.md]
  caller_persona:  cuo-cpo
  trace_id:        <uuid>
