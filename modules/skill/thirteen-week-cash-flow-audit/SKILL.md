...
description: |
  Audit one or more existing thirteen-week-cash-flow@1 markdowns against
  13-week-cash-flow_rubric@1.0. Produces a sibling .audit.md per artefact plus
  ...
  thirteen-week-cash-flow-author.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
