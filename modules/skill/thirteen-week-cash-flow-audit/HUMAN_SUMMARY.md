# `thirteen-week-cash-flow-audit` — human summary format
...
```
13-WEEK-CASH-FLOW audit batch complete

Audited N 13-WEEK-CASH-FLOW(s):
  - 13-WEEK-CASH-FLOW-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - 13-WEEK-CASH-FLOW-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - 13-WEEK-CASH-FLOW-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        13-week-cash-flow_rubric@1.0
