# `13_week_cash_flow_rubric@1.0` — machine-checkable 13-Week Cash Flow rubric
...
| `FM-004` | `template` equals `thirteen-week-cash-flow@1` | error | true |
...
Per the `contracts/thirteen-week-cash-flow/template.md` H2 list.
...
- `cyberos/skill/contracts/thirteen-week-cash-flow/CONTRACT.md` + `template.md`
