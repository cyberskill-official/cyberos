# `privacy-impact-assessment-author` — human summary format
...
```
PIA batch <batch_run_id> complete

Wrote N PIA(s):
  - PIA-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - PIA-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - PIA-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        privacy-impact-assessment-audit will run automatically on PASS items. HITL items wait for your reply.
```
