# `employee-net-promoter-score-program-author` — human summary format
...
```
ENPS-PROGRAM batch <batch_run_id> complete

Wrote N ENPS-PROGRAM(s):
  - ENPS-PROGRAM-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - ENPS-PROGRAM-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - ENPS-PROGRAM-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        employee-net-promoter-score-program-audit will run automatically on PASS items. HITL items wait for your reply.
```
