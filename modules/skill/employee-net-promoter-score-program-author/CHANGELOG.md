...
- NATS event emission for `enps-program_written`, `batch_complete`, `hitl_pause`.
...
- Self-audit passes on its own input set at 10/10 by `employee-net-promoter-score-program-audit`.
