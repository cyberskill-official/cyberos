...
| `FM-004` | `template` equals `nps-program@1` | error | true |
...
Per the `contracts/nps-program/template.md` H2 list. Each H2 in the template MUST be present + non-empty in the authored artefact. See template for the canonical headings.

| rule_id | Check | Severity |
| ------- | ----- | -------- |
| `SEC-001` | Every H2 declared in `contracts/nps-program/template.md` is present in the authored artefact | error |
...
- `cyberos/skill/contracts/nps-program/CONTRACT.md` + `template.md`
