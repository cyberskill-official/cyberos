# `nps-program` audit-report format

Every `nps-program-audit` invocation writes a sibling `nps-program.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "nps-program_rubric@1.0"
audited_file:           "./nps-programs/NPS-PROGRAM-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "nps-program_rubric@1.0"
