# `soc2-evidence-audit` — human summary format
...
```
SOC2_EVIDENCE audit batch complete

Audited N SOC2_EVIDENCE(s):
  - SOC2_EVIDENCE-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - SOC2_EVIDENCE-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - SOC2_EVIDENCE-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        soc2-evidence_rubric@1.0
