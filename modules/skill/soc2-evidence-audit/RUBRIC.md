# soc2-evidence_rubric@1.0 — compact universal rubric
...
| FM-002 | `artefact_type` matches `soc2-evidence@1` |
...
| ID | Rule |
|---|---|
| SEC-001 | Every H2 in `contracts/soc2-evidence/template.md` is present in the authored artefact |
