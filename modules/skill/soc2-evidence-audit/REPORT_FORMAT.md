# `soc2-evidence` audit-report format

Every `soc2-evidence-audit` invocation writes a sibling `soc2-evidence.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "soc2-evidence_rubric@1.0"
audited_file:           "./soc2-evidences/SOC2_EVIDENCE-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "soc2-evidence_rubric@1.0"
