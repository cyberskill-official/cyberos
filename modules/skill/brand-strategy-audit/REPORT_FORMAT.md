# `brand-strategy` audit-report format

Every `brand-strategy-audit` invocation writes a sibling `brand-strategy.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "brand-strategy_rubric@1.0"
audited_file:           "./brand-strategys/BRAND-STRATEGY-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "brand-strategy_rubric@1.0"
