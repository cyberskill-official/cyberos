# `brand-strategy-audit` — human summary format
...
```
BRAND-STRATEGY audit batch complete

Audited N BRAND-STRATEGY(s):
  - BRAND-STRATEGY-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - BRAND-STRATEGY-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - BRAND-STRATEGY-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        brand-strategy_rubric@1.0
