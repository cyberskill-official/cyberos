...
description: |
  Audit one or more existing brand-strategy@1 markdowns against
  brand-strategy_rubric@1.0. Produces a sibling .audit.md per artefact plus
