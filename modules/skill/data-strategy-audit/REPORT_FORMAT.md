# `data-strategy` audit-report format

Every `data-strategy-audit` invocation writes a sibling `data-strategy.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "data-strategy_rubric@1.0"
audited_file:           "./data-strategys/DATA-STRATEGY-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "data-strategy_rubric@1.0"
