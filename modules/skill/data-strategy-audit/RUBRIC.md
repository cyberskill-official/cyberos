# `data_strategy_rubric@1.0` — machine-checkable Data Strategy rubric
...
| `FM-004` | `template` equals `data-strategy@1` | error | true |
...
Per the `contracts/data-strategy/template.md` H2 list — every H2 in template MUST be present + non-empty in the authored artefact.

| rule_id | Check | Severity |
| ------- | ----- | -------- |
| `SEC-001` | Every H2 declared in `contracts/data-strategy/template.md` is present in the authored artefact | error |
...
- `cyberos/skill/contracts/data-strategy/CONTRACT.md` + `template.md`
