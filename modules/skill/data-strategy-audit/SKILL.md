...
description: |
  Audit one or more existing data-strategy@1 markdowns against
  data-strategy_rubric@1.0. Produces a sibling .audit.md per artefact plus
