# `data-strategy-audit` — human summary format
...
```
DATA-STRATEGY audit batch complete

Audited N DATA-STRATEGY(s):
  - DATA-STRATEGY-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - DATA-STRATEGY-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - DATA-STRATEGY-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        data-strategy_rubric@1.0
