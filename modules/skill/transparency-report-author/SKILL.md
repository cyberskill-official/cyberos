...
description: |
  Author the quarterly transparency report (data requests received + AI-system disclosures + content-moderation actions + government info-requests + methodology + contact). Google + Microsoft + Meta transparency-report exemplars. Chief Trust Officer authored.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
