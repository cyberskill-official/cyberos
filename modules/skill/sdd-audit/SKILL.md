...
name: sdd-audit
description: |
  Audit one or more existing sdd@1 markdowns against
...
Also invoked automatically by the supervisor when `sdd-author`'s output envelope sets `next_skill_recommendation: sdd-audit` (the default chain).
