...
description: |
  Author the annual brand strategy (positioning + brand architecture + brand voice + visual system + messaging pillars + awareness goals). Aaker brand-equity + BAV BrandAsset Valuator aligned. CMO or Chief Brand Officer authored.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
