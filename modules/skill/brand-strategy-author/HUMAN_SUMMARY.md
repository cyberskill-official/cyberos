# `brand-strategy-author` — human summary format
...
```
BRAND-STRATEGY batch <batch_run_id> complete

Wrote N BRAND-STRATEGY(s):
  - BRAND-STRATEGY-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - BRAND-STRATEGY-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - BRAND-STRATEGY-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        brand-strategy-audit will run automatically on PASS items. HITL items wait for your reply.
```
