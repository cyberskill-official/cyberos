# `knowledge-asset` audit-report format

Every `knowledge-asset-audit` invocation writes a sibling `knowledge-asset.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "knowledge-asset_rubric@1.0"
audited_file:           "./knowledge-assets/KNOWLEDGE-ASSET-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "knowledge-asset_rubric@1.0"
