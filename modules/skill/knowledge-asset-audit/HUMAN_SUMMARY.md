# `knowledge-asset-audit` — human summary format
...
```
KNOWLEDGE-ASSET audit batch complete

Audited N KNOWLEDGE-ASSET(s):
  - KNOWLEDGE-ASSET-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - KNOWLEDGE-ASSET-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - KNOWLEDGE-ASSET-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        knowledge-asset_rubric@1.0
