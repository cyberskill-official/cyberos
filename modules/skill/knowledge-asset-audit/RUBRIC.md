# `knowledge_asset_rubric@1.0` — machine-checkable Knowledge Asset rubric
...
| `FM-004` | `template` equals `knowledge-asset@1` | error | true |
...
Per the `contracts/knowledge-asset/template.md` H2 list — every H2 in template MUST be present + non-empty in the authored artefact.

| rule_id | Check | Severity |
| ------- | ----- | -------- |
| `SEC-001` | Every H2 declared in `contracts/knowledge-asset/template.md` is present in the authored artefact | error |
...
- `cyberos/skill/contracts/knowledge-asset/CONTRACT.md` + `template.md`
