...
description: |
  Audit one or more existing knowledge-asset@1 markdowns against
  knowledge-asset_rubric@1.0. Produces a sibling .audit.md per artefact plus
