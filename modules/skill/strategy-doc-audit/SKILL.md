...
description: |
  Audit one or more existing strategy-doc@1 markdowns against
...
metadata:
  ...
  cyberos-template: strategy-doc@1
...
# strategy-doc-audit — STRATEGY-DOC auditor

> Standalone trigger that runs `strategy-doc_rubric@1.0` against one or
> more existing `strategy-doc@1` markdowns and writes a sibling
...
> Chains naturally after [`strategy-doc-author`](../strategy-doc-author/SKILL.md).
...
Also invoked automatically by the supervisor when `strategy-doc-author`'s output envelope sets `next_skill_recommendation: strategy-doc-audit` (the default chain).
...
```json
{
  ...
  "trace_id": "<uuid>",
  "upstream_context": {
    "from_skill": "strategy-doc-author",
