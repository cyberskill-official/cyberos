# `strategy-doc` audit-report format

Every `strategy-doc-audit` invocation writes a sibling `strategy-doc.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "strategy-doc_rubric@1.0"
audited_file:           "./strategy-docs/STRATEGY-DOC-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "strategy-doc_rubric@1.0"
