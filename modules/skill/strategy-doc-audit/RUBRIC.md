...
| `FM-004` | `template` equals `strategy-doc@1` | error | true |
...
Per the `contracts/strategy-doc/template.md` H2 list — every H2 in template MUST be present + non-empty in the authored artefact.

| rule_id | Check | Severity |
| ------- | ----- | -------- |
| `SEC-001` | Every H2 declared in `contracts/strategy-doc/template.md` is present in the authored artefact | error |
...
- `cyberos/skill/contracts/strategy-doc/CONTRACT.md` + `template.md`
