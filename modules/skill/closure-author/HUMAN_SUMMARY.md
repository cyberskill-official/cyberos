# `closure-author` — human summary format
...
```
CLOSURE batch <batch_run_id> complete

Wrote N CLOSURE(s):
  - CLOSURE-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - CLOSURE-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - CLOSURE-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        closure-audit will run automatically on PASS items. HITL items wait for your reply.
```
