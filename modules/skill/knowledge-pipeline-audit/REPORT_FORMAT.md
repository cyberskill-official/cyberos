# `knowledge-pipeline` audit-report format

Every `knowledge-pipeline-audit` invocation writes a sibling `knowledge-pipeline.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "knowledge-pipeline_rubric@1.0"
audited_file:           "./knowledge-pipelines/KNOWLEDGE_PIPELINE-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "knowledge-pipeline_rubric@1.0"
