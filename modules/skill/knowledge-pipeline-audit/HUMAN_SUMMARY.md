# `knowledge-pipeline-audit` — human summary format
...
```
KNOWLEDGE_PIPELINE audit batch complete

Audited N KNOWLEDGE_PIPELINE(s):
  - KNOWLEDGE_PIPELINE-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - KNOWLEDGE_PIPELINE-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - KNOWLEDGE_PIPELINE-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        knowledge-pipeline_rubric@1.0
