# `investor-update-audit` — human summary format
...
```
INVESTOR-UPDATE audit batch complete

Audited N INVESTOR-UPDATE(s):
  - INVESTOR-UPDATE-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - INVESTOR-UPDATE-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - INVESTOR-UPDATE-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        investor-update_rubric@1.0
