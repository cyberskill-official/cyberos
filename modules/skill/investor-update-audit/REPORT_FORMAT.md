# `investor-update` audit-report format

Every `investor-update-audit` invocation writes a sibling `investor-update.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "investor-update_rubric@1.0"
audited_file:           "./investor-updates/INVESTOR-UPDATE-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "investor-update_rubric@1.0"
