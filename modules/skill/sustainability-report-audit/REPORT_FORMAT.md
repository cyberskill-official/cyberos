# `sustainability-report` audit-report format

Every `sustainability-report-audit` invocation writes a sibling `sustainability-report.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "sustainability-report_rubric@1.0"
audited_file:           "./sustainability-reports/SUSTAINABILITY-REPORT-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "sustainability-report_rubric@1.0"
