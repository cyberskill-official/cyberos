# `sustainability_report_rubric@1.0` — machine-checkable Sustainability Report rubric
...
| `FM-004` | `template` equals `sustainability-report@1` | error | true |
...
Per the `contracts/sustainability-report/template.md` H2 list — every H2 in template MUST be present + non-empty in the authored artefact.

| rule_id | Check | Severity |
| ------- | ----- | -------- |
| `SEC-001` | Every H2 declared in `contracts/sustainability-report/template.md` is present in the authored artefact | error |
...
- `cyberos/skill/contracts/sustainability-report/CONTRACT.md` + `template.md`
