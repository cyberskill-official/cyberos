# `sustainability-report-audit` — human summary format
...
```
SUSTAINABILITY-REPORT audit batch complete

Audited N SUSTAINABILITY-REPORT(s):
  - SUSTAINABILITY-REPORT-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - SUSTAINABILITY-REPORT-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - SUSTAINABILITY-REPORT-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        sustainability-report_rubric@1.0
