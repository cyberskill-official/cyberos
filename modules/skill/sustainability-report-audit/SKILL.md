---
# ── Identity ─────────────────────────────────────────────────────────
name: sustainability-report-audit
description: >-
  Audit one or more existing sustainability-report@1 markdowns against sustainability-report_rubric@1.0. Produces a sibling .audit.md per artefact plus an AUDIT_BATCH_SUMMARY. Halts on needs_human verdicts; resumable on audited_file_sha256. Standalone trigger or chains naturally after sustainability-report-author. Use when user asks to "audit this sustainability report" or "check the sustainability report". Do NOT use for "draft a new sustainability report" (use sustainability-report-author instead).
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
  stage: cross
  cyberos-template: sustainability-report@1
  cyberos-rubric-version: sustainability-report_rubric@1.0
...
depends_on_contracts:
  - id:        sustainability-report
    ...
    pin_path:  cyberos/skill/contracts/sustainability-report/
  - id:        nats-subjects
    version:   v1
...
# sustainability-report-audit — SUSTAINABILITY-REPORT auditor

> Standalone trigger that runs `sustainability-report_rubric@1.0` against one or
> more existing `sustainability-report@1` markdowns and writes a sibling
> `sustainability-report.audit.md` per item. Halts on `needs_human` verdicts via
> the standard Question primitive; resumable on `audited_file_sha256`.
> Chains naturally after [`sustainability-report-author`](../sustainability-report-author/SKILL.md).

`prompt_revision: sustainability-report_audit@1.0.0`

## When to invoke this skill

CUO routes a request here when the user wants to:

- "Audit these existing `SUSTAINABILITY-REPORT`s."
- "Has `SUSTAINABILITY-REPORT-007` changed since the last audit?"
- "Tell me which `SUSTAINABILITY-REPORT`s would fail acceptance today."

Also invoked automatically by the supervisor when `sustainability-report-author`'s output envelope sets `next_skill_recommendation: sustainability-report-audit` (the default chain).
...
```
CONTRACT_ECHO
skill_id:                        sustainability-report-audit
skill_version:                   1.0.0
prompt_revision:                 sustainability-report_audit@1.0.0
template_version:                sustainability-report@1   (loaded from cyberos/skill/contracts/sustainability-report/template.md)
audit_rubric_version:            sustainability-report_rubric@1.0
...
```json
{
  "artefact_paths": ["./sustainability-reports/SUSTAINABILITY-REPORT-001-foo.md", "./sustainability-reports/SUSTAINABILITY-REPORT-002-bar.md"],
  "caller_persona": "cuo-cpo",
  "trace_id": "<uuid>",
  "upstream_context": {
    "from_skill": "sustainability-report-author",
    "manifest_path": "./sustainability-reports/manifest.json"
  }
}
```
...
```json
{
  ...
  "exit_code": 1,
  "per_artefact": [
    {"artefact_path": "./sustainability-reports/SUSTAINABILITY-REPORT-001-foo.md", "audit_path": "./sustainability-reports/SUSTAINABILITY-REPORT-001-foo.audit.md", "status": "pass", "iterations": 1, "audited_file_sha256": "<hex>"},
    {"artefact_path": "./sustainability-reports/SUSTAINABILITY-REPORT-002-bar.md", "audit_path": "./sustainability-reports/SUSTAINABILITY-REPORT-002-bar.audit.md", "status": "needs_human", "iterations": 3, "audited_file_sha256": "<hex>"}
  ],
  "hitl_required": true,
...
```
Persona: cuo-cpo
Skill:   sustainability-report-audit
Input:
  artefact_paths:  [./team-a/SUSTAINABILITY-REPORT-001-something.md, ./team-b/SUSTAINABILITY-REPORT-018-other.md]
  caller_persona:  cuo-cpo
  trace_id:        <uuid>
