# `safety-report-author` — human summary format
...
```
SAFETY-REPORT batch <batch_run_id> complete

Wrote N SAFETY-REPORT(s):
  - SAFETY-REPORT-001: <slug> — PASS (audit verdict: pass, 0 open issues)
  - SAFETY-REPORT-002: <slug> — HITL_PAUSE (2 blocking issues — see HITL_BATCH_REQUEST below)
  - SAFETY-REPORT-003: <slug> — PASS (audit verdict: pass, 1 warning)

Manifest:    <output_dir>/manifest.json
Total time:  <seconds>s
Next:        safety-report-audit will run automatically on PASS items. HITL items wait for your reply.
```
