...
description: |
  Author the quarterly clinical-safety report (executive summary + AE aggregation + signal detection + SAE inventory + risk-benefit assessment + regulatory submissions). ICH E2D PSUR + FDA MedWatch + EMA EudraVigilance compliant. Chief Medical Officer authored.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
