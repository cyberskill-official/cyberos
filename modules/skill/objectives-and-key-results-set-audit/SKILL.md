...
description: |
  Audit one or more existing objectives-and-key-results-set@1 markdowns against
  okr-set_rubric@1.0. Produces a sibling .audit.md per artefact plus
  ...
  objectives-and-key-results-set-author.
license: Apache-2.0
metadata:
  version: 1.0.0
  module: skill
