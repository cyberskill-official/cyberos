# `objectives-and-key-results-set-audit` — human summary format
...
```
OKR-SET audit batch complete

Audited N OKR-SET(s):
  - OKR-SET-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - OKR-SET-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - OKR-SET-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        okr-set_rubric@1.0
