# `okr-set` audit-report format

Every `objectives-and-key-results-set-audit` invocation writes a sibling `okr-set.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "okr-set_rubric@1.0"
audited_file:           "./okr-sets/OKR-SET-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "okr-set_rubric@1.0"
