# `procurement_strategy_rubric@1.0` — machine-checkable Procurement Strategy rubric
...
| `FM-004` | `template` equals `procurement-strategy@1` | error | true |
...
Per the `contracts/procurement-strategy/template.md` H2 list — every H2 in template MUST be present + non-empty in the authored artefact.

| rule_id | Check | Severity |
| ------- | ----- | -------- |
| `SEC-001` | Every H2 declared in `contracts/procurement-strategy/template.md` is present in the authored artefact | error |
...
- `cyberos/skill/contracts/procurement-strategy/CONTRACT.md` + `template.md`
