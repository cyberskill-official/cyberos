# `procurement-strategy-audit` — human summary format
...
```
PROCUREMENT-STRATEGY audit batch complete

Audited N PROCUREMENT-STRATEGY(s):
  - PROCUREMENT-STRATEGY-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - PROCUREMENT-STRATEGY-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - PROCUREMENT-STRATEGY-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        procurement-strategy_rubric@1.0
