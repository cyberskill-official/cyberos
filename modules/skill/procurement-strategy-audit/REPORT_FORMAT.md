# `procurement-strategy` audit-report format

Every `procurement-strategy-audit` invocation writes a sibling `procurement-strategy.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "procurement-strategy_rubric@1.0"
audited_file:           "./procurement-strategys/PROCUREMENT-STRATEGY-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "procurement-strategy_rubric@1.0"
