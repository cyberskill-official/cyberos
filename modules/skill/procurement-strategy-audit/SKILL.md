...
description: |
  Audit one or more existing procurement-strategy@1 markdowns against
  procurement-strategy_rubric@1.0. Produces a sibling .audit.md per artefact plus
