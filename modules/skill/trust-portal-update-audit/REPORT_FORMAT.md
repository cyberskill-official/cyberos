# `trust-portal-update` audit-report format

Every `trust-portal-update-audit` invocation writes a sibling `trust-portal-update.audit.md` per audited artefact. The report format below is normative.

## Frontmatter

```yaml
---
audit_template_version: "trust-portal-update_rubric@1.0"
audited_file:           "./trust-portal-updates/TRUST-PORTAL-UPDATE-001-foo.md"
audited_file_sha256:    "<64-hex>"
rubric_version:         "trust-portal-update_rubric@1.0"
