...
description: |
  Audit one or more existing trust-portal-update@1 markdowns against
  trust-portal-update_rubric@1.0. Produces a sibling .audit.md per artefact plus
