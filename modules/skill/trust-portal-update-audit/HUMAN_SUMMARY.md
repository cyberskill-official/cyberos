# `trust-portal-update-audit` — human summary format
...
```
TRUST-PORTAL-UPDATE audit batch complete

Audited N TRUST-PORTAL-UPDATE(s):
  - TRUST-PORTAL-UPDATE-001-foo.md → audit verdict: pass (0 open, 1 warning, 3 iterations)
  - TRUST-PORTAL-UPDATE-002-bar.md → audit verdict: needs_human (2 blocking issues — see HITL_BATCH_REQUEST below)
  - TRUST-PORTAL-UPDATE-003-baz.md → audit verdict: pass (0 open, 0 warnings, 1 iteration)

Rubric:        trust-portal-update_rubric@1.0
