...
name: prd-audit
description: |
  Audit one or more existing prd@1 markdowns against
...
Also invoked automatically by the supervisor when `prd-author`'s output envelope sets `next_skill_recommendation: prd-audit` (the default chain).
