...
**Step 1 — `investor-update-author`**: produces the artefact body in the shape declared by `modules/skill/investor-update-author/SKILL.md`. Consumes the `brief` input (workflow-supplied) plus any prior-step hand-off.
