...
inputs:
  - { name: prior_strategy,        source: last year's strategy-document@1 (medical chapter), format: strategy-document@1 }
...
skill_chain:
  - { step: 1, skill: strategy-document-author, inputs_from: { prior_strategy: prior_strategy, pipeline: pipeline, ceo_priorities: ceo_priorities }, outputs_to: strategy_draft }
  - { step: 2, skill: strategy-document-audit,  inputs_from: strategy_draft, outputs_to: medical_strategy }
