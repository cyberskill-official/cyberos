...
**Step 1 — `security-strategy-author`**: produces the artefact body in the shape declared by `modules/skill/security-strategy-author/SKILL.md`. Consumes the `brief` input (workflow-supplied) plus any prior-step hand-off.
