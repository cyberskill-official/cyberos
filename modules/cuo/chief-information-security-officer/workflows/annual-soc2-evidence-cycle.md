...
inputs:
  ...
  - { name: prior_artefact, source: BRAIN search for prior `annual-soc2-evidence-cycle` outputs, format: markdown }
...
**Step 1 — `soc2-evidence-author`**: produces the artefact body in the shape declared by `modules/skill/soc2-evidence-author/CONTRACT.md`. Consumes the `brief` input (workflow-supplied) plus any prior-step hand-off.
