...
inputs:
  - { name: prior_program,         source: last year's dei-program@1, format: dei-program@1 }
...
skill_chain:
  - { step: 1, skill: dei-program-author, inputs_from: { prior_program: prior_program, hr_demographics: hr_demographics, pay_equity_audit: pay_equity_audit, ceo_priorities: ceo_priorities }, outputs_to: program_draft }
