...
inputs:
  - { name: prior_twcf,            source: last week's 13-week-cash-flow@1, format: 13-week-cash-flow@1 }
...
skill_chain:
  - { step: 1, skill: 13-week-cash-flow-author, inputs_from: { prior_twcf: prior_twcf, ar_aging: ar_aging, ap_aging: ap_aging, debt_schedule: debt_schedule }, outputs_to: twcf_draft }
  - { step: 2, skill: 13-week-cash-flow-audit,  inputs_from: twcf_draft, outputs_to: distress_cash_forecast }
