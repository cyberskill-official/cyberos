...
**Step 1 — `workforce-plan-author`**: produces the artefact body in the shape declared by `modules/skill/workforce-plan-author/SKILL.md`. Consumes the `brief` input (workflow-supplied) plus any prior-step hand-off.
