...
inputs:
  ...
  - { name: prior_artefact, source: BRAIN search for prior `annual-comp-bands-refresh` outputs, format: markdown }

outputs:
  - { name: annual_comp_bands_refresh_artefact, format: ad-hoc-md, recipient: persona owner + downstream consumers }

skill_chain:
  - { step: 1, skill: comp-plan-author, inputs_from: brief, outputs_to: comp_bands_draft }
  - { step: 2, skill: comp-plan-audit, inputs_from: comp_bands_draft, outputs_to: comp_bands_final }
