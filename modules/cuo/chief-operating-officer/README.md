...
> Per `../../../modules/cuo/docs/module.md` §5.1 + §4. **Tenure shortest at 3.2 yrs** — role ambiguity is the dominant failure mode; the COO charter MUST be sharp.
...
## Cross-references
- `../../../modules/cuo/docs/module.md` §5.1, §3, §6, §7 (consulting-firm-specific).
