...
inputs:
  ...
  - { name: prior_artefact, source: BRAIN search for prior `quarterly-tech-debt-review` outputs, format: markdown }

outputs:
  - { name: quarterly_tech_debt_review_artefact, format: ad-hoc-md, recipient: persona owner + downstream consumers }

skill_chain:
  - { step: 1, skill: strategy-doc-author, inputs_from: brief, outputs_to: debt_strategy_draft }
  - { step: 2, skill: strategy-doc-audit, inputs_from: debt_strategy_draft, outputs_to: tech_debt_plan }
