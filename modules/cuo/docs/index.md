...
`ship-tasks` (v2.3.x) picks the first eligible FR from `docs/tasks/BACKLOG.md` and drives it end to end:
...
- FRs: `docs/tasks/<module>/FR-<MOD>-NNN-slug.md`; cross-cutting hardening under `docs/tasks/improvement/`
...
- [Ship your first task](./guides/ship-your-first-fr.html) - the day-one, step-by-step walkthrough for employees: install, write an FR, trigger the agent, hold the two gates, land the change.
