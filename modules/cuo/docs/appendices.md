---
title: CUO — Appendices & Extended Reference — CyberOS
...
## Table of contents
  ...
  9. Routing algorithm
  10. Data shapes
  11. Roadmap — Phase 4 and depth additions
  12. Software Development Process (Default)
...
### 8.2 Container
  ...
  * Mount `.cyberos/memory/store/` from a persistent volume so audit chain survives container restarts
