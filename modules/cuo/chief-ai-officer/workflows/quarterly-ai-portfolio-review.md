...
**Step 1 — `ai-use-case-portfolio-author`**: produces the artefact body in the shape declared by `modules/skill/ai-use-case-portfolio-author/SKILL.md`. Consumes the `brief` input (workflow-supplied) plus any prior-step hand-off.
