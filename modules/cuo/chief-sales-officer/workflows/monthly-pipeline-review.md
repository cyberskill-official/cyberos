...
**Step 1 — `pipeline-report-author`**: produces the artefact body in the shape declared by `modules/skill/pipeline-report-author/SKILL.md`. Consumes the `brief` input (workflow-supplied) plus any prior-step hand-off.
