...
inputs:
  - { name: prior_strategy,        source: last year's strategy-document@1 (people chapter), format: strategy-document@1 }
...
skill_chain:
  ...
  - { step: 2, skill: strategy-document-audit,  inputs_from: strategy_draft, outputs_to: people_strategy }
