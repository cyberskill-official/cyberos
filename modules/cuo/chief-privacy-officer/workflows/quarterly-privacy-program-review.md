...
**Step 1 — `compliance-program-author`**: produces the artefact body in the shape declared by `modules/skill/compliance-program-author/SKILL.md`. Consumes the `brief` input (workflow-supplied) plus any prior-step hand-off.
