...
**Step 1 — `brand-strategy-author`**: produces the artefact body in the shape declared by `modules/skill/brand-strategy-author/SKILL.md`. Consumes the `brief` input (workflow-supplied) plus any prior-step hand-off.
