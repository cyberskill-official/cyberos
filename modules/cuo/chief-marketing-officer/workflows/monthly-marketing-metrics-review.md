...
**Step 1 — `product-metrics-review-author`**: produces the artefact body in the shape declared by `modules/skill/product-metrics-review-author/SKILL.md`. Consumes the `brief` input (workflow-supplied) plus any prior-step hand-off.
