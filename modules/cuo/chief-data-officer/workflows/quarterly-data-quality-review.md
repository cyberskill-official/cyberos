...
inputs:
  ...
  - { name: prior_artefact, source: BRAIN search for prior `quarterly-data-quality-review` outputs, format: markdown }
...
**Step 1 — `data-governance-author`**: produces the artefact body in the shape declared by `modules/skill/data-governance-author/CONTRACT.md`. Consumes the `brief` input (workflow-supplied) plus any prior-step hand-off.
