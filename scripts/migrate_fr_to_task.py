...
DENY_PREFIXES = (
    ...
    "dist/",                # build output, regenerated by tools/install/build.sh
...
PATH_RENAMES = [
    ...
    ("tools/install/plugin/commands/create-feature-requests.md",
    ...
    ("tools/install/lib/fr-migrate.sh",     "tools/install/lib/task-migrate.sh"),
...
def fix_symlinks(root: Path) -> None:
    ...
    print("      bash tools/install/build.sh")
...
def main() -> int:
    ...
    if args.residue or args.verify:
        ...
        #     1  tools/install/templates/FR-TEMPLATE.md — while install.sh's
