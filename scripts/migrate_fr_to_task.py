...
DENY_PREFIXES = (
    ...
    "dist/",                # build output, regenerated by tools/cyberos-install/build.sh
...
PATH_RENAMES = [
    ...
    ("tools/cyberos-install/plugin/commands/create-feature-requests.md",
    ...
    ("tools/cyberos-install/lib/fr-migrate.sh",     "tools/cyberos-install/lib/task-migrate.sh"),
...
def fix_symlinks(root: Path) -> None:
    ...
    print("      bash tools/cyberos-install/build.sh")
...
def main() -> int:
    ...
    if args.residue or args.verify:
        ...
        #     1  tools/cyberos-install/templates/FR-TEMPLATE.md — while install.sh's
