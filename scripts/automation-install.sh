...
echo "  nightly script : $REPO_ROOT/scripts/automation/cyberos-nightly.sh"
echo "  weekly script  : $REPO_ROOT/scripts/automation/cyberos-weekly.sh"
...
write_plist "$NIGHTLY_LABEL" \
    "$REPO_ROOT/scripts/automation/cyberos-nightly.sh" \
    1 9
