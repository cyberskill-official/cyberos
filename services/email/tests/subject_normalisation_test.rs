...
fn strips_re_prefix_single() {
    assert_eq!(
        normalise_subject(Some("Re: hello")).as_deref(),
        Some("hello")
    );
}
...
fn strips_re_prefix_chain() {
    assert_eq!(
        normalise_subject(Some("Re: Re: Re: hello")).as_deref(),
        Some("hello")
    );
}
...
fn strips_fwd_prefix() {
    assert_eq!(
        normalise_subject(Some("Fwd: hello")).as_deref(),
        Some("hello")
    );
    assert_eq!(
        normalise_subject(Some("FW: hello")).as_deref(),
        Some("hello")
    );
}
...
fn mixed_prefixes() {
    assert_eq!(
        normalise_subject(Some("Re: Fwd: hello")).as_deref(),
        Some("hello")
    );
    assert_eq!(
        normalise_subject(Some("FW: Re: hello")).as_deref(),
        Some("hello")
    );
}
...
fn collapses_internal_whitespace() {
    assert_eq!(
        normalise_subject(Some("hello\t  world")).as_deref(),
        Some("hello world")
    );
}
