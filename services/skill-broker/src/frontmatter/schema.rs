...
/// Description length bounds per TASK-SKILL-111 §1 #2 (raised from TASK-SKILL-103's
...
///
/// Additional fields will land when TASK-SKILL-103 ships its full broker — until
...
/// Frozen v1 marker namespace per TASK-SKILL-113 §1 #2.
///
/// Future expansion (TASK-SKILL-117): add `UntrustedContentStrict`,
