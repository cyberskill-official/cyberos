//! cyberos-obs-compliance-view - read-only compliance views over the memory audit chain (TASK-OBS-008).
//!
...
//! axum shell. See `docs/tasks/obs/TASK-OBS-008-compliance-view-scoping.md`.
