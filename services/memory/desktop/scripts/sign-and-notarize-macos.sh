...
#
# Inputs:
#   $1   path to the .dmg produced under apps/memory/src-tauri/target/release/bundle/dmg/
#
# What it does:
...
DMG="${1:?usage: sign-and-notarize-macos.sh path/to/CyberOS-memory.dmg}"
...
MOUNT_POINT="$(mktemp -d)/CyberOS-memory"
