...
CREATE TABLE tenants (
    ...
    plan_tier       TEXT NOT NULL DEFAULT 'starter', -- FR-TEN-002: starter | team | enterprise
...
-- Seed the root tenant (FR-AUTH-006 bootstrap CLI later upserts ops admin
