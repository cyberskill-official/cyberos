...
//!   * tenant create  (TASK-AUTH-001)
//!   * subject create (TASK-AUTH-002)
//!   * RLS migrations (TASK-AUTH-003)
//!
...
// TASK-AUTH-106 slice-3 drop (handlers.rs, oidc.rs, mfa.rs, saml.rs, geoip.rs,
