//! FR-OBS-002 §5 - LogQL injection acceptance tests (integration, against the public crate API).
...
fn rejects_query_that_already_supplies_tenant_id() {
    // FR-OBS-002 §1 #4 / §4 #6 - a user-supplied tenant_id is a bypass attempt and is refused.
