//! cyberos-obs-proxy - the tenant-aware Grafana proxy (TASK-OBS-002).
//!
...
//! the TraceQL injector, JWT auth against the TASK-AUTH-004 JWKS, the axum proxy router, and audit
//! emission. See `docs/tasks/obs/TASK-OBS-002-tenant-aware-grafana.md`.
