//! FR-BRAIN-102 — Rebuild Layer 2 from Layer 1.
//!
//! Two surfaces:
...
//!
//! Wired into the CLI: `cyberos-brain rebuild --tenant <UUID>` and
//! `cyberos-brain reconcile --tenant <UUID> --sample 100`. A cron / OBS
