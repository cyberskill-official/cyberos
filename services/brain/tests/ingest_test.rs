//! FR-BRAIN-101 — end-to-end Layer-2 ingest integration tests.
//!
//! Requires Postgres + the brain + auth migrations applied. CI integration
//! job boots services/dev/docker-compose.yml and runs `--ignored`.

use cyberos_brain::layer2::{binlog_tail, binlog_tail::L1Row, chain_anchor, ingest};
