...
> Sourced verbatim from `feature-request/FR_CREATE_AND_AUDIT.md` v2.0.0 §8. Used by both `fr-author` (during PLAN to populate `tentative_eu_ai_act_risk_class`) and by `fr-audit` (during the rubric run to check QA-001 / QA-002 / QA-003 violations).
