...
| --- | --- | --- | --- | --- |
| [`feature-request`](./feature-request/CONTRACT.md) | v1 (`feature_request@1`) | artefact_schema | `cuo-cpo` | `cuo/cpo/fr-author`, `cuo/cpo/fr-audit`, `cuo/cto/fr-to-tech-spec` |
| [`nats-subjects`](./nats-subjects/CONTRACT.md) | v1 (`nats_subjects@1`) | wire_protocol | `cuo-cto` | `cuo/cpo/fr-author`, `cuo/cpo/fr-audit`, `cuo/cto/fr-to-tech-spec`, the supervisor |
...
| [`prd`](./prd/CONTRACT.md) | v1 (`prd@1`) | artefact_schema | `cuo-cpo` | `cuo/cpo/prd-author` v0.1.0+, `cuo/cpo/prd-audit` v0.1.0+, `cuo/cto/srs-author` v0.1.0+ (input), `cuo/cpo/fr-author` v0.3.0+ (planned) |
| [`srs`](./srs/CONTRACT.md) | v1 (`srs@1`) | artefact_schema | `cuo-cto` | `cuo/cto/srs-author` v0.1.0+, `cuo/cto/srs-audit` v0.1.0+, `cuo/cto/fr-to-tech-spec` v0.2.0+ (input context) |
| [`impl-plan`](./impl-plan/CONTRACT.md) | v1 (`impl_plan@1`) | artefact_schema | `cuo-cto` | `cuo/cto/spec-to-impl-plan` v0.1.0+ |
