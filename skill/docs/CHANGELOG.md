# Changelog — CyberOS Skill module

All notable changes to the skill module, sorted newest-first. Tracks the Anthropic Agent Skills open standard — the protocol is the standard, not a CyberOS-specific evolution.

Entries follow [Keep a Changelog](https://keepachangelog.com/en/1.1.0/) conventions, date-stamped (not version-stamped).
...
## 2026-05-14 — Skill module Phase 0 + Phase 1 scaffold (audit-driven restructure)
