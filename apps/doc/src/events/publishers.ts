/**
 * Events published by @cyberos/doc.
 *
 * Naming: `doc.{verb}.{noun}` — see SRS §5.4. Add an entry below
...
export type DocEventName = never; // populate as you add events
