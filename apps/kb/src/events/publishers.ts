/**
 * Events published by @cyberos/kb.
 *
 * Naming: `kb.{verb}.{noun}` — see SRS §5.4. Add an entry below
...
export type KbEventName = never; // populate as you add events
