/**
 * Events published by @cyberos/mcp.
 *
 * Naming: `mcp.{verb}.{noun}` — see SRS §5.4. Add an entry below
...
export type McpEventName = never; // populate as you add events
