/**
 * Federated GraphQL schema for @cyberos/crm.
 *
 * Each module declares its types under the namespace `crm` to avoid
...
export const typeDefs = gql`
  ...
  type Query {
    """Probe the crm subgraph. Always returns ok: true."""
    crmHealth: CrmHealthStatus!
  }
`;
