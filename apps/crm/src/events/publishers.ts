/**
 * Events published by @cyberos/crm.
 *
 * Naming: `crm.{verb}.{noun}` — see SRS §5.4. Add an entry below
...
export type CrmEventName = never; // populate as you add events
