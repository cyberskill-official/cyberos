/**
 * Federated GraphQL schema for @cyberos/cp.
 *
 * Each module declares its types under the namespace `cp` to avoid
...
export const typeDefs = gql`
  ...
  type Query {
    """Probe the cp subgraph. Always returns ok: true."""
    cpHealth: CpHealthStatus!
  }
`;
