/**
 * Events published by @cyberos/cp.
 *
 * Naming: `cp.{verb}.{noun}` — see SRS §5.4. Add an entry below
...
export type CpEventName = never; // populate as you add events
