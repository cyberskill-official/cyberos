/**
 * Events published by @cyberos/res.
 *
 * Naming: `res.{verb}.{noun}` — see SRS §5.4. Add an entry below
...
export type ResEventName = never; // populate as you add events
