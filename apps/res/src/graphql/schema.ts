/**
 * Federated GraphQL schema for @cyberos/res.
 *
 * Each module declares its types under the namespace `res` to avoid
...
export const typeDefs = gql`
  ...
  type Query {
    """Probe the res subgraph. Always returns ok: true."""
    resHealth: ResHealthStatus!
  }
`;
