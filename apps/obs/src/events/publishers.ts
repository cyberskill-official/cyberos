/**
 * Events published by @cyberos/obs.
 *
 * Naming: `obs.{verb}.{noun}` — see SRS §5.4. Add an entry below
...
export type ObsEventName = never; // populate as you add events
