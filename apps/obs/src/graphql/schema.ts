/**
 * Federated GraphQL schema for @cyberos/obs.
 *
 * Each module declares its types under the namespace `obs` to avoid
...
export const typeDefs = gql`
  ...
  type Query {
    """Probe the obs subgraph. Always returns ok: true."""
    obsHealth: ObsHealthStatus!
  }
`;
