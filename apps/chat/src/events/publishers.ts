/**
 * Events published by @cyberos/chat.
 *
 * Naming: `chat.{verb}.{noun}` — see SRS §5.4. Add an entry below
...
export type ChatEventName = never; // populate as you add events
