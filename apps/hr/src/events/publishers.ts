/**
 * Events published by @cyberos/hr.
 *
 * Naming: `hr.{verb}.{noun}` — see SRS §5.4. Add an entry below
...
export type HrEventName = never; // populate as you add events
