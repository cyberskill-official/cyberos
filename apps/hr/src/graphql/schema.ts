/**
 * Federated GraphQL schema for @cyberos/hr.
 *
 * Each module declares its types under the namespace `hr` to avoid
...
export const typeDefs = gql`
  ...
  type Query {
    """Probe the hr subgraph. Always returns ok: true."""
    hrHealth: HrHealthStatus!
  }
`;
