/**
 * Events published by @cyberos/proj.
 *
 * Naming: `proj.{verb}.{noun}` — see SRS §5.4. Add an entry below
...
export type ProjEventName = never; // populate as you add events
