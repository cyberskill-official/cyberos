/**
 * Events published by @cyberos/okr.
 *
 * Naming: `okr.{verb}.{noun}` — see SRS §5.4. Add an entry below
...
export type OkrEventName = never; // populate as you add events
