/**
 * Federated GraphQL schema for @cyberos/okr.
 *
 * Each module declares its types under the namespace `okr` to avoid
...
export const typeDefs = gql`
  ...
  type Query {
    """Probe the okr subgraph. Always returns ok: true."""
    okrHealth: OkrHealthStatus!
  }
`;
