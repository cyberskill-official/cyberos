/**
 * Federated GraphQL schema for @cyberos/auth.
 *
 * Each module declares its types under the namespace `auth` to avoid
...
export const typeDefs = gql`
  ...
  type Query {
    """Probe the auth subgraph. Always returns ok: true."""
