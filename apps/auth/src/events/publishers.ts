/**
 * Events published by @cyberos/auth.
 *
 * Naming: `auth.{verb}.{noun}` — see SRS §5.4. Add an entry below
...
export type AuthEventName = never; // populate as you add events
