/**
 * Events published by @cyberos/rew.
 *
 * Naming: `rew.{verb}.{noun}` — see SRS §5.4. Add an entry below
...
export type RewEventName = never; // populate as you add events
