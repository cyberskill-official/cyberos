/**
 * Federated GraphQL schema for @cyberos/rew.
 *
 * Each module declares its types under the namespace `rew` to avoid
...
export const typeDefs = gql`
  ...
  type Query {
    """Probe the rew subgraph. Always returns ok: true."""
    rewHealth: RewHealthStatus!
  }
`;
