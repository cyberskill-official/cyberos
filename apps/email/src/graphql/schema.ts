/**
 * Federated GraphQL schema for @cyberos/email.
 *
 * Each module declares its types under the namespace `email` to avoid
...
export const typeDefs = gql`
  ...
  type Query {
    """Probe the email subgraph. Always returns ok: true."""
