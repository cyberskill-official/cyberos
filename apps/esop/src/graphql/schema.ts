/**
 * Federated GraphQL schema for @cyberos/esop.
 *
 * Each module declares its types under the namespace `esop` to avoid
...
export const typeDefs = gql`
  ...
  type Query {
    """Probe the esop subgraph. Always returns ok: true."""
    esopHealth: EsopHealthStatus!
  }
`;
