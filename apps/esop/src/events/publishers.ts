/**
 * Events published by @cyberos/esop.
 *
 * Naming: `esop.{verb}.{noun}` — see SRS §5.4. Add an entry below
...
export type EsopEventName = never; // populate as you add events
