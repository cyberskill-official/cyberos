/**
 * Federated GraphQL schema for @cyberos/genie.
 *
 * Each module declares its types under the namespace `genie` to avoid
...
export const typeDefs = gql`
  ...
  type Query {
    """Probe the genie subgraph. Always returns ok: true."""
    genieHealth: GenieHealthStatus!
  }
`;
