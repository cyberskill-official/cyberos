/**
 * Events published by @cyberos/ai.
 *
 * Naming: `ai.{verb}.{noun}` — see SRS §5.4. Add an entry below
...
export type AiEventName = never; // populate as you add events
