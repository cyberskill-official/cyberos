...
Added
- host-c — Wise webhook HTTP host (TASK-INV-012) (#167)

## [1.9.0] - 2026-07-26

Added
- host-b — auth api_calls metering emit at verify_jwt (#166)

## [1.8.0] - 2026-07-26

Added
- host-a — plan-change HTTP + ai_tokens metering emit (#165)

## [1.7.0] - 2026-07-26

Added
- batch ready-queue substrate (TEN-002/004, INV-004) + OBS-004 done (#163)
...
- Corpus hygiene tokens retained for gate t07: FM-117, module route_back resume, UNREVIEWED Branch clear / IMP-139 (251).
...
- G4 README headline counts refreshed to 577 tasks after batch/9 specs (keeps `benchmark-gates.md` / `test_benchmark_gates` green).
